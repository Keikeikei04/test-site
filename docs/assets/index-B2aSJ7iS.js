 ...
 */var e0;function dM(){if(e0)return ht;e0=1;var a=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),n=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),l=Symbol.for("react.context"),u=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),m=Symbol.iterator;function g(k){return k===null||typeof k!="object"?null:(k=m&&k[m]||k["@@iterator"],typeof k=="function"?k:null)}var v={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function y(k,Y,Ee){this.props=k,this.context=Y,this.refs=M,this.updater=Ee||v}y.prototype.isReactComponent={},y.prototype.setState=function(k,Y){if(typeof k!="object"&&typeof k!="function"&&k!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,k,Y,"setState")},y.prototype.forceUpdate=function(k){this.updater.enqueueForceUpdate(this,k,"forceUpdate")};function x(){}x.prototype=y.prototype;function b(k,Y,Ee){this.props=k,this.context=Y,this.refs=M,this.updater=Ee||v}var R=b.prototype=new x;R.constructor=b,E(R,y.prototype),R.isPureReactComponent=!0;var T=Array.isArray,D=Object.prototype.hasOwnProperty,N={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function F(k,Y,Ee){var $,ne={},xe=null,me=null;if(Y!=null)for($ in Y.ref!==void 0&&(me=Y.ref),Y.key!==void 0&&(xe=""+Y.key),Y)D.call(Y,$)&&!I.hasOwnProperty($)&&(ne[$]=Y[$]);var Te=arguments.length-2;if(Te===1)ne.children=Ee;else if(1<Te){for(var Ie=Array(Te),Ze=0;Ze<Te;Ze++)Ie[Ze]=arguments[Ze+2];ne.children=Ie}if(k&&k.defaultProps)for($ in Te=k.defaultProps,Te)ne[$]===void 0&&(ne[$]=Te[$]);return{$$typeof:a,type:k,key:xe,ref:me,props:ne,_owner:N.current}}function A(k,Y){return{$$typeof:a,type:k.type,key:Y,ref:k.ref,props:k.props,_owner:k._owner}}function C(k){return typeof k=="object"&&k!==null&&k.$$typeof===a}function B(k){var Y={"=":"=0",":":"=2"};return"$"+k.replace(/[=:]/g,function(Ee){return Y[Ee]})}var Z=/\/+/g;function K(k,Y){return typeof k=="object"&&k!==null&&k.key!=null?B(""+k.key):Y.toString(36)}function ce(k,Y,Ee,$,ne){var xe=typeof k;(xe==="undefined"||xe==="boolean")&&(k=null);var me=!1;if(k===null)me=!0;else switch(xe){case"string":case"number":me=!0;break;case"object":switch(k.$$typeof){case a:case e:me=!0}}if(me)return me=k,ne=ne(me),k=$===""?"."+K(me,0):$,T(ne)?(Ee="",k!=null&&(Ee=k.replace(Z,"$&/")+"/"),ce(ne,Y,Ee,"",function(Ze){return Ze})):ne!=null&&(C(ne)&&(ne=A(ne,Ee+(!ne.key||me&&me.key===ne.key?"":(""+ne.key).replace(Z,"$&/")+"/")+k)),Y.push(ne)),1;if(me=0,$=$===""?".":$+":",T(k))for(var Te=0;Te<k.length;Te++){xe=k[Te];var Ie=$+K(xe,Te);me+=ce(xe,Y,Ee,Ie,ne)}else if(Ie=g(k),typeof Ie=="function")for(k=Ie.call(k),Te=0;!(xe=k.next()).done;)xe=xe.value,Ie=$+K(xe,Te++),me+=ce(xe,Y,Ee,Ie,ne);else if(xe==="object")throw Y=String(k),Error("Objects are not valid as a React child (found: "+(Y==="[object Object]"?"object with keys {"+Object.keys(k).join(", ")+"}":Y)+"). If you meant to render a collection of children, use an array instead.");return me}function re(k,Y,Ee){if(k==null)return k;var $=[],ne=0;return ce(k,$,"","",function(xe){return Y.call(Ee,xe,ne++)}),$}function J(k){if(k._status===-1){var Y=k._result;Y=Y(),Y.then(function(Ee){(k._status===0||k._status===-1)&&(k._status=1,k._result=Ee)},function(Ee){(k._status===0||k._status===-1)&&(k._status=2,k._result=Ee)}),k._status===-1&&(k._status=0,k._result=Y)}if(k._status===1)return k._result.default;throw k._result}var oe={current:null},z={transition:null},ue={ReactCurrentDispatcher:oe,ReactCurrentBatchConfig:z,ReactCurrentOwner:N};function le(){throw Error("act(...) is not supported in production builds of React.")}return ht.Children={map:re,forEach:function(k,Y,Ee){re(k,function(){Y.apply(this,arguments)},Ee)},count:function(k){var Y=0;return re(k,function(){Y++}),Y},toArray:function(k){return re(k,function(Y){return Y})||[]},only:function(k){if(!C(k))throw Error("React.Children.only expected to receive a single React element child.");return k}},ht.Component=y,ht.Fragment=t,ht.Profiler=i,ht.PureComponent=b,ht.StrictMode=n,ht.Suspense=f,ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ue,ht.act=le,ht.cloneElement=function(k,Y,Ee){if(k==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+k+".");var $=E({},k.props),ne=k.key,xe=k.ref,me=k._owner;if(Y!=null){if(Y.ref!==void 0&&(xe=Y.ref,me=N.current),Y.key!==void 0&&(ne=""+Y.key),k.type&&k.type.defaultProps)var Te=k.type.defaultProps;for(Ie in Y)D.call(Y,Ie)&&!I.hasOwnProperty(Ie)&&($[Ie]=Y[Ie]===void 0&&Te!==void 0?Te[Ie]:Y[Ie])}var Ie=arguments.length-2;if(Ie===1)$.children=Ee;else if(1<Ie){Te=Array(Ie);for(var Ze=0;Ze<Ie;Ze++)Te[Ze]=arguments[Ze+2];$.children=Te}return{$$typeof:a,type:k.type,key:ne,ref:xe,props:$,_owner:me}},ht.createContext=function(k){return k={$$typeof:l,_currentValue:k,_currentValue2:k,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},k.Provider={$$typeof:o,_context:k},k.Consumer=k},ht.createElement=F,ht.createFactory=function(k){var Y=F.bind(null,k);return Y.type=k,Y},ht.createRef=function(){return{current:null}},ht.forwardRef=function(k){return{$$typeof:u,render:k}},ht.isValidElement=C,ht.lazy=function(k){return{$$typeof:p,_payload:{_status:-1,_result:k},_init:J}},ht.memo=function(k,Y){return{$$typeof:h,type:k,compare:Y===void 0?null:Y}},ht.startTransition=function(k){var Y=z.transition;z.transition={};try{k()}finally{z.transition=Y}},ht.unstable_act=le,ht.useCallback=function(k,Y){return oe.current.useCallback(k,Y)},ht.useContext=function(k){return oe.current.useContext(k)},ht.useDebugValue=function(){},ht.useDeferredValue=function(k){return oe.current.useDeferredValue(k)},ht.useEffect=function(k,Y){return oe.current.useEffect(k,Y)},ht.useId=function(){return oe.current.useId()},ht.useImperativeHandle=function(k,Y,Ee){return oe.current.useImperativeHandle(k,Y,Ee)},ht.useInsertionEffect=function(k,Y){return oe.current.useInsertionEffect(k,Y)},ht.useLayoutEffect=function(k,Y){return oe.current.useLayoutEffect(k,Y)},ht.useMemo=function(k,Y){return oe.current.useMemo(k,Y)},ht.useReducer=function(k,Y,Ee){return oe.current.useReducer(k,Y,Ee)},ht.useRef=function(k){return oe.current.useRef(k)},ht.useState=function(k){return oe.current.useState(k)},ht.useSyncExternalStore=function(k,Y,Ee){return oe.current.useSyncExternalStore(k,Y,Ee)},ht.useTransition=function(){return oe.current.useTransition()},ht.version="18.3.1",ht}var t0;function Kp(){return t0||(t0=1,Yh.exports=dM()),Yh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var r0;function gM(){return r0||(r0=1,function(a){function e(z,ue){var le=z.length;z.push(ue);e:for(;0<le;){var k=le-1>>>1,Y=z[k];if(0<i(Y,ue))z[k]=ue,z[le]=Y,le=k;else break e}}function t(z){return z.length===0?null:z[0]}function n(z){if(z.length===0)return null;var ue=z[0],le=z.pop();if(le!==ue){z[0]=le;e:for(var k=0,Y=z.length,Ee=Y>>>1;k<Ee;){var $=2*(k+1)-1,ne=z[$],xe=$+1,me=z[xe];if(0>i(ne,le))xe<Y&&0>i(me,ne)?(z[k]=me,z[xe]=le,k=xe):(z[k]=ne,z[$]=le,k=$);else if(xe<Y&&0>i(me,le))z[k]=me,z[xe]=le,k=xe;else break e}}return ue}function i(z,ue){var le=z.sortIndex-ue.sortIndex;return le!==0?le:z.id-ue.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;a.unstable_now=function(){return o.now()}}else{var l=Date,u=l.now();a.unstable_now=function(){return l.now()-u}}var f=[],h=[],p=1,m=null,g=3,v=!1,E=!1,M=!1,y=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function R(z){for(var ue=t(h);ue!==null;){if(ue.callback===null)n(h);else if(ue.startTime<=z)n(h),ue.sortIndex=ue.expirationTime,e(f,ue);else break;ue=t(h)}}function T(z){if(M=!1,R(z),!E)if(t(f)!==null)E=!0,J(D);else{var ue=t(h);ue!==null&&oe(T,ue.startTime-z)}}function D(z,ue){E=!1,M&&(M=!1,x(F),F=-1),v=!0;var le=g;try{for(R(ue),m=t(f);m!==null&&(!(m.expirationTime>ue)||z&&!B());){var k=m.callback;if(typeof k=="function"){m.callback=null,g=m.priorityLevel;var Y=k(m.expirationTime<=ue);ue=a.unstable_now(),typeof Y=="function"?m.callback=Y:m===t(f)&&n(f),R(ue)}else n(f);m=t(f)}if(m!==null)var Ee=!0;else{var $=t(h);$!==null&&oe(T,$.startTime-ue),Ee=!1}return Ee}finally{m=null,g=le,v=!1}}var N=!1,I=null,F=-1,A=5,C=-1;function B(){return!(a.unstable_now()-C<A)}function Z(){if(I!==null){var z=a.unstable_now();C=z;var ue=!0;try{ue=I(!0,z)}finally{ue?K():(N=!1,I=null)}}else N=!1}var K;if(typeof b=="function")K=function(){b(Z)};else if(typeof MessageChannel<"u"){var ce=new MessageChannel,re=ce.port2;ce.port1.onmessage=Z,K=function(){re.postMessage(null)}}else K=function(){y(Z,0)};function J(z){I=z,N||(N=!0,K())}function oe(z,ue){F=y(function(){z(a.unstable_now())},ue)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(z){z.callback=null},a.unstable_continueExecution=function(){E||v||(E=!0,J(D))},a.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<z?Math.floor(1e3/z):5},a.unstable_getCurrentPriorityLevel=function(){return g},a.unstable_getFirstCallbackNode=function(){return t(f)},a.unstable_next=function(z){switch(g){case 1:case 2:case 3:var ue=3;break;default:ue=g}var le=g;g=ue;try{return z()}finally{g=le}},a.unstable_pauseExecution=function(){},a.unstable_requestPaint=function(){},a.unstable_runWithPriority=function(z,ue){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var le=g;g=z;try{return ue()}finally{g=le}},a.unstable_scheduleCallback=function(z,ue,le){var k=a.unstable_now();switch(typeof le=="object"&&le!==null?(le=le.delay,le=typeof le=="number"&&0<le?k+le:k):le=k,z){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=le+Y,z={id:p++,callback:ue,priorityLevel:z,startTime:le,expirationTime:Y,sortIndex:-1},le>k?(z.sortIndex=le,e(h,z),t(f)===null&&z===t(h)&&(M?(x(F),F=-1):M=!0,oe(T,le-k))):(z.sortIndex=Y,e(f,z),E||v||(E=!0,J(D))),z},a.unstable_shouldYield=B,a.unstable_wrapCallback=function(z){var ue=g;return function(){var le=g;g=ue;try{return z.apply(this,arguments)}finally{g=le}}}}($h)),$h}var s0;function _M(){return s0||(s0=1,Kh.exports=gM()),Kh.exports}/**
 * @license React
...
`].filter(Pl).join(`
`)),l=Lp(l),l=xv(l,t),l=yv(l,t),u=Lp(u),u=xv(u,t),u=yv(u,t),l=Sv(l),u=Sv(u),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+x);const R=b+y+l,T=b+x+u,D=gv(i,i.VERTEX_SHADER,R),N=gv(i,i.FRAGMENT_SHADER,T);i.attachShader(M,D),i.attachShader(M,N),t.index0AttributeName!==void 0?i.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(M,0,"position"),i.linkProgram(M);function I(B){if(a.debug.checkShaderErrors){const Z=i.getProgramInfoLog(M).trim(),K=i.getShaderInfoLog(D).trim(),ce=i.getShaderInfoLog(N).trim();let re=!0,J=!0;if(i.getProgramParameter(M,i.LINK_STATUS)===!1)if(re=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(i,M,D,N);else{const oe=vv(i,D,"vertex"),z=vv(i,N,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(M,i.VALIDATE_STATUS)+`
...
}`;function mC(a,e,t){let n=new lm;const i=new Mt,o=new Mt,l=new wt,u=new dT({depthPacking:rE}),f=new pT,h={},p=t.maxTextureSize,m={[or]:jn,[jn]:or,[tr]:tr},g=new lr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Mt},radius:{value:4}},vertexShader:dC,fragmentShader:pC}),v=g.clone();v.defines.HORIZONTAL_PASS=1;const E=new fr;E.setAttribute("position",new qn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new vn(E,g),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Yv;let x=this.type;this.render=function(N,I,F){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||N.length===0)return;const A=a.getRenderTarget(),C=a.getActiveCubeFace(),B=a.getActiveMipmapLevel(),Z=a.state;Z.setBlending(Ts),Z.buffers.color.setClear(1,1,1,1),Z.buffers.depth.setTest(!0),Z.setScissorTest(!1);const K=x!==Pr&&this.type===Pr,ce=x===Pr&&this.type!==Pr;for(let re=0,J=N.length;re<J;re++){const oe=N[re],z=oe.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",oe,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const ue=z.getFrameExtents();if(i.multiply(ue),o.copy(z.mapSize),(i.x>p||i.y>p)&&(i.x>p&&(o.x=Math.floor(p/ue.x),i.x=o.x*ue.x,z.mapSize.x=o.x),i.y>p&&(o.y=Math.floor(p/ue.y),i.y=o.y*ue.y,z.mapSize.y=o.y)),z.map===null||K===!0||ce===!0){const k=this.type!==Pr?{minFilter:Yn,magFilter:Yn}:{};z.map!==null&&z.map.dispose(),z.map=new Cs(i.x,i.y,k),z.map.texture.name=oe.name+".shadowMap",z.camera.updateProjectionMatrix()}a.setRenderTarget(z.map),a.clear();const le=z.getViewportCount();for(let k=0;k<le;k++){const Y=z.getViewport(k);l.set(o.x*Y.x,o.y*Y.y,o.x*Y.z,o.y*Y.w),Z.viewport(l),z.updateMatrices(oe,k),n=z.getFrustum(),T(I,F,z.camera,oe,this.type)}z.isPointLightShadow!==!0&&this.type===Pr&&b(z,F),z.needsUpdate=!1}x=this.type,y.needsUpdate=!1,a.setRenderTarget(A,C,B)};function b(N,I){const F=e.update(M);g.defines.VSM_SAMPLES!==N.blurSamples&&(g.defines.VSM_SAMPLES=N.blurSamples,v.defines.VSM_SAMPLES=N.blurSamples,g.needsUpdate=!0,v.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new Cs(i.x,i.y)),g.uniforms.shadow_pass.value=N.map.texture,g.uniforms.resolution.value=N.mapSize,g.uniforms.radius.value=N.radius,a.setRenderTarget(N.mapPass),a.clear(),a.renderBufferDirect(I,null,F,g,M,null),v.uniforms.shadow_pass.value=N.mapPass.texture,v.uniforms.resolution.value=N.mapSize,v.uniforms.radius.value=N.radius,a.setRenderTarget(N.map),a.clear(),a.renderBufferDirect(I,null,F,v,M,null)}function R(N,I,F,A){let C=null;const B=F.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(B!==void 0)C=B;else if(C=F.isPointLight===!0?f:u,a.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0){const Z=C.uuid,K=I.uuid;let ce=h[Z];ce===void 0&&(ce={},h[Z]=ce);let re=ce[K];re===void 0&&(re=C.clone(),ce[K]=re,I.addEventListener("dispose",D)),C=re}if(C.visible=I.visible,C.wireframe=I.wireframe,A===Pr?C.side=I.shadowSide!==null?I.shadowSide:I.side:C.side=I.shadowSide!==null?I.shadowSide:m[I.side],C.alphaMap=I.alphaMap,C.alphaTest=I.alphaTest,C.map=I.map,C.clipShadows=I.clipShadows,C.clippingPlanes=I.clippingPlanes,C.clipIntersection=I.clipIntersection,C.displacementMap=I.displacementMap,C.displacementScale=I.displacementScale,C.displacementBias=I.displacementBias,C.wireframeLinewidth=I.wireframeLinewidth,C.linewidth=I.linewidth,F.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const Z=a.properties.get(C);Z.light=F}return C}function T(N,I,F,A,C){if(N.visible===!1)return;if(N.layers.test(I.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&C===Pr)&&(!N.frustumCulled||n.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,N.matrixWorld);const K=e.update(N),ce=N.material;if(Array.isArray(ce)){const re=K.groups;for(let J=0,oe=re.length;J<oe;J++){const z=re[J],ue=ce[z.materialIndex];if(ue&&ue.visible){const le=R(N,ue,A,C);N.onBeforeShadow(a,N,I,F,K,le,z),a.renderBufferDirect(F,null,K,le,N,z),N.onAfterShadow(a,N,I,F,K,le,z)}}}else if(ce.visible){const re=R(N,ce,A,C);N.onBeforeShadow(a,N,I,F,K,re,null),a.renderBufferDirect(F,null,K,re,N,null),N.onAfterShadow(a,N,I,F,K,re,null)}}const Z=N.children;for(let K=0,ce=Z.length;K<ce;K++)T(Z[K],I,F,A,C)}function D(N){N.target.removeEventListener("dispose",D);for(const F in h){const A=h[F],C=N.target.uuid;C in A&&(A[C].dispose(),delete A[C])}}}const gC={[Wd]:Xd,[jd]:Kd,[Yd]:$d,[ya]:qd,[Xd]:Wd,[Kd]:jd,[$d]:Yd,[qd]:ya};function _C(a,e){function t(){let X=!1;const Ce=new wt;let fe=null;const de=new wt(0,0,0,0);return{setMask:function(Le){fe!==Le&&!X&&(a.colorMask(Le,Le,Le,Le),fe=Le)},setLocked:function(Le){X=Le},setClear:function(Le,Pe,rt,zt,ln){ln===!0&&(Le*=zt,Pe*=zt,rt*=zt),Ce.set(Le,Pe,rt,zt),de.equals(Ce)===!1&&(a.clearColor(Le,Pe,rt,zt),de.copy(Ce))},reset:function(){X=!1,fe=null,de.set(-1,0,0,0)}}}function n(){let X=!1,Ce=!1,fe=null,de=null,Le=null;return{setReversed:function(Pe){if(Ce!==Pe){const rt=e.get("EXT_clip_control");Ce?rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.ZERO_TO_ONE_EXT):rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.NEGATIVE_ONE_TO_ONE_EXT);const zt=Le;Le=null,this.setClear(zt)}Ce=Pe},getReversed:function(){return Ce},setTest:function(Pe){Pe?me(a.DEPTH_TEST):Te(a.DEPTH_TEST)},setMask:function(Pe){fe!==Pe&&!X&&(a.depthMask(Pe),fe=Pe)},setFunc:function(Pe){if(Ce&&(Pe=gC[Pe]),de!==Pe){switch(Pe){case Wd:a.depthFunc(a.NEVER);break;case Xd:a.depthFunc(a.ALWAYS);break;case jd:a.depthFunc(a.LESS);break;case ya:a.depthFunc(a.LEQUAL);break;case Yd:a.depthFunc(a.EQUAL);break;case qd:a.depthFunc(a.GEQUAL);break;case Kd:a.depthFunc(a.GREATER);break;case $d:a.depthFunc(a.NOTEQUAL);break;default:a.depthFunc(a.LEQUAL)}de=Pe}},setLocked:function(Pe){X=Pe},setClear:function(Pe){Le!==Pe&&(Ce&&(Pe=1-Pe),a.clearDepth(Pe),Le=Pe)},reset:function(){X=!1,fe=null,de=null,Le=null,Ce=!1}}}function i(){let X=!1,Ce=null,fe=null,de=null,Le=null,Pe=null,rt=null,zt=null,ln=null;return{setTest:function(Et){X||(Et?me(a.STENCIL_TEST):Te(a.STENCIL_TEST))},setMask:function(Et){Ce!==Et&&!X&&(a.stencilMask(Et),Ce=Et)},setFunc:function(Et,$n,kn){(fe!==Et||de!==$n||Le!==kn)&&(a.stencilFunc(Et,$n,kn),fe=Et,de=$n,Le=kn)},setOp:function(Et,$n,kn){(Pe!==Et||rt!==$n||zt!==kn)&&(a.stencilOp(Et,$n,kn),Pe=Et,rt=$n,zt=kn)},setLocked:function(Et){X=Et},setClear:function(Et){ln!==Et&&(a.clearStencil(Et),ln=Et)},reset:function(){X=!1,Ce=null,fe=null,de=null,Le=null,Pe=null,rt=null,zt=null,ln=null}}}const o=new t,l=new n,u=new i,f=new WeakMap,h=new WeakMap;let p={},m={},g=new WeakMap,v=[],E=null,M=!1,y=null,x=null,b=null,R=null,T=null,D=null,N=null,I=new nt(0,0,0),F=0,A=!1,C=null,B=null,Z=null,K=null,ce=null;const re=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let J=!1,oe=0;const z=a.getParameter(a.VERSION);z.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(z)[1]),J=oe>=1):z.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),J=oe>=2);let ue=null,le={};const k=a.getParameter(a.SCISSOR_BOX),Y=a.getParameter(a.VIEWPORT),Ee=new wt().fromArray(k),$=new wt().fromArray(Y);function ne(X,Ce,fe,de){const Le=new Uint8Array(4),Pe=a.createTexture();a.bindTexture(X,Pe),a.texParameteri(X,a.TEXTURE_MIN_FILTER,a.NEAREST),a.texParameteri(X,a.TEXTURE_MAG_FILTER,a.NEAREST);for(let rt=0;rt<fe;rt++)X===a.TEXTURE_3D||X===a.TEXTURE_2D_ARRAY?a.texImage3D(Ce,0,a.RGBA,1,1,de,0,a.RGBA,a.UNSIGNED_BYTE,Le):a.texImage2D(Ce+rt,0,a.RGBA,1,1,0,a.RGBA,a.UNSIGNED_BYTE,Le);return Pe}const xe={};xe[a.TEXTURE_2D]=ne(a.TEXTURE_2D,a.TEXTURE_2D,1),xe[a.TEXTURE_CUBE_MAP]=ne(a.TEXTURE_CUBE_MAP,a.TEXTURE_CUBE_MAP_POSITIVE_X,6),xe[a.TEXTURE_2D_ARRAY]=ne(a.TEXTURE_2D_ARRAY,a.TEXTURE_2D_ARRAY,1,1),xe[a.TEXTURE_3D]=ne(a.TEXTURE_3D,a.TEXTURE_3D,1,1),o.setClear(0,0,0,1),l.setClear(1),u.setClear(0),me(a.DEPTH_TEST),l.setFunc(ya),dt(!1),ct(u0),me(a.CULL_FACE),H(Ts);function me(X){p[X]!==!0&&(a.enable(X),p[X]=!0)}function Te(X){p[X]!==!1&&(a.disable(X),p[X]=!1)}function Ie(X,Ce){return m[X]!==Ce?(a.bindFramebuffer(X,Ce),m[X]=Ce,X===a.DRAW_FRAMEBUFFER&&(m[a.FRAMEBUFFER]=Ce),X===a.FRAMEBUFFER&&(m[a.DRAW_FRAMEBUFFER]=Ce),!0):!1}function Ze(X,Ce){let fe=v,de=!1;if(X){fe=g.get(Ce),fe===void 0&&(fe=[],g.set(Ce,fe));const Le=X.textures;if(fe.length!==Le.length||fe[0]!==a.COLOR_ATTACHMENT0){for(let Pe=0,rt=Le.length;Pe<rt;Pe++)fe[Pe]=a.COLOR_ATTACHMENT0+Pe;fe.length=Le.length,de=!0}}else fe[0]!==a.BACK&&(fe[0]=a.BACK,de=!0);de&&a.drawBuffers(fe)}function Dt(X){return E!==X?(a.useProgram(X),E=X,!0):!1}const _t={[so]:a.FUNC_ADD,[wM]:a.FUNC_SUBTRACT,[AM]:a.FUNC_REVERSE_SUBTRACT};_t[RM]=a.MIN,_t[CM]=a.MAX;const Ot={[bM]:a.ZERO,[PM]:a.ONE,[LM]:a.SRC_COLOR,[Hd]:a.SRC_ALPHA,[OM]:a.SRC_ALPHA_SATURATE,[UM]:a.DST_COLOR,[DM]:a.DST_ALPHA,[IM]:a.ONE_MINUS_SRC_COLOR,[Gd]:a.ONE_MINUS_SRC_ALPHA,[FM]:a.ONE_MINUS_DST_COLOR,[NM]:a.ONE_MINUS_DST_ALPHA,[kM]:a.CONSTANT_COLOR,[BM]:a.ONE_MINUS_CONSTANT_COLOR,[zM]:a.CONSTANT_ALPHA,[VM]:a.ONE_MINUS_CONSTANT_ALPHA};function H(X,Ce,fe,de,Le,Pe,rt,zt,ln,Et){if(X===Ts){M===!0&&(Te(a.BLEND),M=!1);return}if(M===!1&&(me(a.BLEND),M=!0),X!==TM){if(X!==y||Et!==A){if((x!==so||T!==so)&&(a.blendEquation(a.FUNC_ADD),x=so,T=so),Et)switch(X){case da:a.blendFuncSeparate(a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case c0:a.blendFunc(a.ONE,a.ONE);break;case f0:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case h0:a.blendFuncSeparate(a.ZERO,a.SRC_COLOR,a.ZERO,a.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}else switch(X){case da:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case c0:a.blendFunc(a.SRC_ALPHA,a.ONE);break;case f0:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case h0:a.blendFunc(a.ZERO,a.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}b=null,R=null,D=null,N=null,I.set(0,0,0),F=0,y=X,A=Et}return}Le=Le||Ce,Pe=Pe||fe,rt=rt||de,(Ce!==x||Le!==T)&&(a.blendEquationSeparate(_t[Ce],_t[Le]),x=Ce,T=Le),(fe!==b||de!==R||Pe!==D||rt!==N)&&(a.blendFuncSeparate(Ot[fe],Ot[de],Ot[Pe],Ot[rt]),b=fe,R=de,D=Pe,N=rt),(zt.equals(I)===!1||ln!==F)&&(a.blendColor(zt.r,zt.g,zt.b,ln),I.copy(zt),F=ln),y=X,A=!1}function On(X,Ce){X.side===tr?Te(a.CULL_FACE):me(a.CULL_FACE);let fe=X.side===jn;Ce&&(fe=!fe),dt(fe),X.blending===da&&X.transparent===!1?H(Ts):H(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),l.setFunc(X.depthFunc),l.setTest(X.depthTest),l.setMask(X.depthWrite),o.setMask(X.colorWrite);const de=X.stencilWrite;u.setTest(de),de&&(u.setMask(X.stencilWriteMask),u.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),u.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),Lt(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?me(a.SAMPLE_ALPHA_TO_COVERAGE):Te(a.SAMPLE_ALPHA_TO_COVERAGE)}function dt(X){C!==X&&(X?a.frontFace(a.CW):a.frontFace(a.CCW),C=X)}function ct(X){X!==MM?(me(a.CULL_FACE),X!==B&&(X===u0?a.cullFace(a.BACK):X===EM?a.cullFace(a.FRONT):a.cullFace(a.FRONT_AND_BACK))):Te(a.CULL_FACE),B=X}function je(X){X!==Z&&(J&&a.lineWidth(X),Z=X)}function Lt(X,Ce,fe){X?(me(a.POLYGON_OFFSET_FILL),(K!==Ce||ce!==fe)&&(a.polygonOffset(Ce,fe),K=Ce,ce=fe)):Te(a.POLYGON_OFFSET_FILL)}function We(X){X?me(a.SCISSOR_TEST):Te(a.SCISSOR_TEST)}function U(X){X===void 0&&(X=a.TEXTURE0+re-1),ue!==X&&(a.activeTexture(X),ue=X)}function P(X,Ce,fe){fe===void 0&&(ue===null?fe=a.TEXTURE0+re-1:fe=ue);let de=le[fe];de===void 0&&(de={type:void 0,texture:void 0},le[fe]=de),(de.type!==X||de.texture!==Ce)&&(ue!==fe&&(a.activeTexture(fe),ue=fe),a.bindTexture(X,Ce||xe[X]),de.type=X,de.texture=Ce)}function te(){const X=le[ue];X!==void 0&&X.type!==void 0&&(a.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function pe(){try{a.compressedTexImage2D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function _e(){try{a.compressedTexImage3D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function he(){try{a.texSubImage2D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function He(){try{a.texSubImage3D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Re(){try{a.compressedTexSubImage2D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Ue(){try{a.compressedTexSubImage3D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function ut(){try{a.texStorage2D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Me(){try{a.texStorage3D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function ke(){try{a.texImage2D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function qe(){try{a.texImage3D.apply(a,arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Qe(X){Ee.equals(X)===!1&&(a.scissor(X.x,X.y,X.z,X.w),Ee.copy(X))}function Be(X){$.equals(X)===!1&&(a.viewport(X.x,X.y,X.z,X.w),$.copy(X))}function ft(X,Ce){let fe=h.get(Ce);fe===void 0&&(fe=new WeakMap,h.set(Ce,fe));let de=fe.get(X);de===void 0&&(de=a.getUniformBlockIndex(Ce,X.name),fe.set(X,de))}function it(X,Ce){const de=h.get(Ce).get(X);f.get(Ce)!==de&&(a.uniformBlockBinding(Ce,de,X.__bindingPointIndex),f.set(Ce,de))}function bt(){a.disable(a.BLEND),a.disable(a.CULL_FACE),a.disable(a.DEPTH_TEST),a.disable(a.POLYGON_OFFSET_FILL),a.disable(a.SCISSOR_TEST),a.disable(a.STENCIL_TEST),a.disable(a.SAMPLE_ALPHA_TO_COVERAGE),a.blendEquation(a.FUNC_ADD),a.blendFunc(a.ONE,a.ZERO),a.blendFuncSeparate(a.ONE,a.ZERO,a.ONE,a.ZERO),a.blendColor(0,0,0,0),a.colorMask(!0,!0,!0,!0),a.clearColor(0,0,0,0),a.depthMask(!0),a.depthFunc(a.LESS),l.setReversed(!1),a.clearDepth(1),a.stencilMask(4294967295),a.stencilFunc(a.ALWAYS,0,4294967295),a.stencilOp(a.KEEP,a.KEEP,a.KEEP),a.clearStencil(0),a.cullFace(a.BACK),a.frontFace(a.CCW),a.polygonOffset(0,0),a.activeTexture(a.TEXTURE0),a.bindFramebuffer(a.FRAMEBUFFER,null),a.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),a.bindFramebuffer(a.READ_FRAMEBUFFER,null),a.useProgram(null),a.lineWidth(1),a.scissor(0,0,a.canvas.width,a.canvas.height),a.viewport(0,0,a.canvas.width,a.canvas.height),p={},ue=null,le={},m={},g=new WeakMap,v=[],E=null,M=!1,y=null,x=null,b=null,R=null,T=null,D=null,N=null,I=new nt(0,0,0),F=0,A=!1,C=null,B=null,Z=null,K=null,ce=null,Ee.set(0,0,a.canvas.width,a.canvas.height),$.set(0,0,a.canvas.width,a.canvas.height),o.reset(),l.reset(),u.reset()}return{buffers:{color:o,depth:l,stencil:u},enable:me,disable:Te,bindFramebuffer:Ie,drawBuffers:Ze,useProgram:Dt,setBlending:H,setMaterial:On,setFlipSided:dt,setCullFace:ct,setLineWidth:je,setPolygonOffset:Lt,setScissorTest:We,activeTexture:U,bindTexture:P,unbindTexture:te,compressedTexImage2D:pe,compressedTexImage3D:_e,texImage2D:ke,texImage3D:qe,updateUBOMapping:ft,uniformBlockBinding:it,texStorage2D:ut,texStorage3D:Me,texSubImage2D:he,texSubImage3D:He,compressedTexSubImage2D:Re,compressedTexSubImage3D:Ue,scissor:Qe,viewport:Be,reset:bt}}function vC(a,e,t,n,i,o,l){const u=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,f=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Mt,p=new WeakMap;let m;const g=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(U,P){return v?new OffscreenCanvas(U,P):Hl("canvas")}function M(U,P,te){let pe=1;const _e=We(U);if((_e.width>te||_e.height>te)&&(pe=te/Math.max(_e.width,_e.height)),pe<1)if(typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&U instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&U instanceof ImageBitmap||typeof VideoFrame<"u"&&U instanceof VideoFrame){const he=Math.floor(pe*_e.width),He=Math.floor(pe*_e.height);m===void 0&&(m=E(he,He));const Re=P?E(he,He):m;return Re.width=he,Re.height=He,Re.getContext("2d").drawImage(U,0,0,he,He),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+_e.width+"x"+_e.height+") to ("+he+"x"+He+")."),Re}else return"data"in U&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+_e.width+"x"+_e.height+")."),U;return U}function y(U){return U.generateMipmaps}function x(U){a.generateMipmap(U)}function b(U){return U.isWebGLCubeRenderTarget?a.TEXTURE_CUBE_MAP:U.isWebGL3DRenderTarget?a.TEXTURE_3D:U.isWebGLArrayRenderTarget||U.isCompressedArrayTexture?a.TEXTURE_2D_ARRAY:a.TEXTURE_2D}function R(U,P,te,pe,_e=!1){if(U!==null){if(a[U]!==void 0)return a[U];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+U+"'")}let he=P;if(P===a.RED&&(te===a.FLOAT&&(he=a.R32F),te===a.HALF_FLOAT&&(he=a.R16F),te===a.UNSIGNED_BYTE&&(he=a.R8)),P===a.RED_INTEGER&&(te===a.UNSIGNED_BYTE&&(he=a.R8UI),te===a.UNSIGNED_SHORT&&(he=a.R16UI),te===a.UNSIGNED_INT&&(he=a.R32UI),te===a.BYTE&&(he=a.R8I),te===a.SHORT&&(he=a.R16I),te===a.INT&&(he=a.R32I)),P===a.RG&&(te===a.FLOAT&&(he=a.RG32F),te===a.HALF_FLOAT&&(he=a.RG16F),te===a.UNSIGNED_BYTE&&(he=a.RG8)),P===a.RG_INTEGER&&(te===a.UNSIGNED_BYTE&&(he=a.RG8UI),te===a.UNSIGNED_SHORT&&(he=a.RG16UI),te===a.UNSIGNED_INT&&(he=a.RG32UI),te===a.BYTE&&(he=a.RG8I),te===a.SHORT&&(he=a.RG16I),te===a.INT&&(he=a.RG32I)),P===a.RGB_INTEGER&&(te===a.UNSIGNED_BYTE&&(he=a.RGB8UI),te===a.UNSIGNED_SHORT&&(he=a.RGB16UI),te===a.UNSIGNED_INT&&(he=a.RGB32UI),te===a.BYTE&&(he=a.RGB8I),te===a.SHORT&&(he=a.RGB16I),te===a.INT&&(he=a.RGB32I)),P===a.RGBA_INTEGER&&(te===a.UNSIGNED_BYTE&&(he=a.RGBA8UI),te===a.UNSIGNED_SHORT&&(he=a.RGBA16UI),te===a.UNSIGNED_INT&&(he=a.RGBA32UI),te===a.BYTE&&(he=a.RGBA8I),te===a.SHORT&&(he=a.RGBA16I),te===a.INT&&(he=a.RGBA32I)),P===a.RGB&&te===a.UNSIGNED_INT_5_9_9_9_REV&&(he=a.RGB9_E5),P===a.RGBA){const He=_e?Yc:St.getTransfer(pe);te===a.FLOAT&&(he=a.RGBA32F),te===a.HALF_FLOAT&&(he=a.RGBA16F),te===a.UNSIGNED_BYTE&&(he=He===Ut?a.SRGB8_ALPHA8:a.RGBA8),te===a.UNSIGNED_SHORT_4_4_4_4&&(he=a.RGBA4),te===a.UNSIGNED_SHORT_5_5_5_1&&(he=a.RGB5_A1)}return(he===a.R16F||he===a.R32F||he===a.RG16F||he===a.RG32F||he===a.RGBA16F||he===a.RGBA32F)&&e.get("EXT_color_buffer_float"),he}function T(U,P){let te;return U?P===null||P===go||P===Ea?te=a.DEPTH24_STENCIL8:P===Xi?te=a.DEPTH32F_STENCIL8:P===Bl&&(te=a.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):P===null||P===go||P===Ea?te=a.DEPTH_COMPONENT24:P===Xi?te=a.DEPTH_COMPONENT32F:P===Bl&&(te=a.DEPTH_COMPONENT16),te}function D(U,P){return y(U)===!0||U.isFramebufferTexture&&U.minFilter!==Yn&&U.minFilter!==gi?Math.log2(Math.max(P.width,P.height))+1:U.mipmaps!==void 0&&U.mipmaps.length>0?U.mipmaps.length:U.isCompressedTexture&&Array.isArray(U.image)?P.mipmaps.length:1}function N(U){const P=U.target;P.removeEventListener("dispose",N),F(P),P.isVideoTexture&&p.delete(P)}function I(U){const P=U.target;P.removeEventListener("dispose",I),C(P)}function F(U){const P=n.get(U);if(P.__webglInit===void 0)return;const te=U.source,pe=g.get(te);if(pe){const _e=pe[P.__cacheKey];_e.usedTimes--,_e.usedTimes===0&&A(U),Object.keys(pe).length===0&&g.delete(te)}n.remove(U)}function A(U){const P=n.get(U);a.deleteTexture(P.__webglTexture);const te=U.source,pe=g.get(te);delete pe[P.__cacheKey],l.memory.textures--}function C(U){const P=n.get(U);if(U.depthTexture&&(U.depthTexture.dispose(),n.remove(U.depthTexture)),U.isWebGLCubeRenderTarget)for(let pe=0;pe<6;pe++){if(Array.isArray(P.__webglFramebuffer[pe]))for(let _e=0;_e<P.__webglFramebuffer[pe].length;_e++)a.deleteFramebuffer(P.__webglFramebuffer[pe][_e]);else a.deleteFramebuffer(P.__webglFramebuffer[pe]);P.__webglDepthbuffer&&a.deleteRenderbuffer(P.__webglDepthbuffer[pe])}else{if(Array.isArray(P.__webglFramebuffer))for(let pe=0;pe<P.__webglFramebuffer.length;pe++)a.deleteFramebuffer(P.__webglFramebuffer[pe]);else a.deleteFramebuffer(P.__webglFramebuffer);if(P.__webglDepthbuffer&&a.deleteRenderbuffer(P.__webglDepthbuffer),P.__webglMultisampledFramebuffer&&a.deleteFramebuffer(P.__webglMultisampledFramebuffer),P.__webglColorRenderbuffer)for(let pe=0;pe<P.__webglColorRenderbuffer.length;pe++)P.__webglColorRenderbuffer[pe]&&a.deleteRenderbuffer(P.__webglColorRenderbuffer[pe]);P.__webglDepthRenderbuffer&&a.deleteRenderbuffer(P.__webglDepthRenderbuffer)}const te=U.textures;for(let pe=0,_e=te.length;pe<_e;pe++){const he=n.get(te[pe]);he.__webglTexture&&(a.deleteTexture(he.__webglTexture),l.memory.textures--),n.remove(te[pe])}n.remove(U)}let B=0;function Z(){B=0}function K(){const U=B;return U>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+U+" texture units while this GPU supports only "+i.maxTextures),B+=1,U}function ce(U){const P=[];return P.push(U.wrapS),P.push(U.wrapT),P.push(U.wrapR||0),P.push(U.magFilter),P.push(U.minFilter),P.push(U.anisotropy),P.push(U.internalFormat),P.push(U.format),P.push(U.type),P.push(U.generateMipmaps),P.push(U.premultiplyAlpha),P.push(U.flipY),P.push(U.unpackAlignment),P.push(U.colorSpace),P.join()}function re(U,P){const te=n.get(U);if(U.isVideoTexture&&je(U),U.isRenderTargetTexture===!1&&U.version>0&&te.__version!==U.version){const pe=U.image;if(pe===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pe.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(te,U,P);return}}t.bindTexture(a.TEXTURE_2D,te.__webglTexture,a.TEXTURE0+P)}function J(U,P){const te=n.get(U);if(U.version>0&&te.__version!==U.version){$(te,U,P);return}t.bindTexture(a.TEXTURE_2D_ARRAY,te.__webglTexture,a.TEXTURE0+P)}function oe(U,P){const te=n.get(U);if(U.version>0&&te.__version!==U.version){$(te,U,P);return}t.bindTexture(a.TEXTURE_3D,te.__webglTexture,a.TEXTURE0+P)}function z(U,P){const te=n.get(U);if(U.version>0&&te.__version!==U.version){ne(te,U,P);return}t.bindTexture(a.TEXTURE_CUBE_MAP,te.__webglTexture,a.TEXTURE0+P)}const ue={[mo]:a.REPEAT,[xs]:a.CLAMP_TO_EDGE,[Xc]:a.MIRRORED_REPEAT},le={[Yn]:a.NEAREST,[Zv]:a.NEAREST_MIPMAP_NEAREST,[bl]:a.NEAREST_MIPMAP_LINEAR,[gi]:a.LINEAR,[Nc]:a.LINEAR_MIPMAP_NEAREST,[Nr]:a.LINEAR_MIPMAP_LINEAR},k={[oE]:a.NEVER,[hE]:a.ALWAYS,[aE]:a.LESS,[ux]:a.LEQUAL,[lE]:a.EQUAL,[fE]:a.GEQUAL,[uE]:a.GREATER,[cE]:a.NOTEQUAL};function Y(U,P){if(P.type===Xi&&e.has("OES_texture_float_linear")===!1&&(P.magFilter===gi||P.magFilter===Nc||P.magFilter===bl||P.magFilter===Nr||P.minFilter===gi||P.minFilter===Nc||P.minFilter===bl||P.minFilter===Nr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),a.texParameteri(U,a.TEXTURE_WRAP_S,ue[P.wrapS]),a.texParameteri(U,a.TEXTURE_WRAP_T,ue[P.wrapT]),(U===a.TEXTURE_3D||U===a.TEXTURE_2D_ARRAY)&&a.texParameteri(U,a.TEXTURE_WRAP_R,ue[P.wrapR]),a.texParameteri(U,a.TEXTURE_MAG_FILTER,le[P.magFilter]),a.texParameteri(U,a.TEXTURE_MIN_FILTER,le[P.minFilter]),P.compareFunction&&(a.texParameteri(U,a.TEXTURE_COMPARE_MODE,a.COMPARE_REF_TO_TEXTURE),a.texParameteri(U,a.TEXTURE_COMPARE_FUNC,k[P.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(P.magFilter===Yn||P.minFilter!==bl&&P.minFilter!==Nr||P.type===Xi&&e.has("OES_texture_float_linear")===!1)return;if(P.anisotropy>1||n.get(P).__currentAnisotropy){const te=e.get("EXT_texture_filter_anisotropic");a.texParameterf(U,te.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(P.anisotropy,i.getMaxAnisotropy())),n.get(P).__currentAnisotropy=P.anisotropy}}}function Ee(U,P){let te=!1;U.__webglInit===void 0&&(U.__webglInit=!0,P.addEventListener("dispose",N));const pe=P.source;let _e=g.get(pe);_e===void 0&&(_e={},g.set(pe,_e));const he=ce(P);if(he!==U.__cacheKey){_e[he]===void 0&&(_e[he]={texture:a.createTexture(),usedTimes:0},l.memory.textures++,te=!0),_e[he].usedTimes++;const He=_e[U.__cacheKey];He!==void 0&&(_e[U.__cacheKey].usedTimes--,He.usedTimes===0&&A(P)),U.__cacheKey=he,U.__webglTexture=_e[he].texture}return te}function $(U,P,te){let pe=a.TEXTURE_2D;(P.isDataArrayTexture||P.isCompressedArrayTexture)&&(pe=a.TEXTURE_2D_ARRAY),P.isData3DTexture&&(pe=a.TEXTURE_3D);const _e=Ee(U,P),he=P.source;t.bindTexture(pe,U.__webglTexture,a.TEXTURE0+te);const He=n.get(he);if(he.version!==He.__version||_e===!0){t.activeTexture(a.TEXTURE0+te);const Re=St.getPrimaries(St.workingColorSpace),Ue=P.colorSpace===vs?null:St.getPrimaries(P.colorSpace),ut=P.colorSpace===vs||Re===Ue?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,P.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,P.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,P.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);let Me=M(P.image,!1,i.maxTextureSize);Me=Lt(P,Me);const ke=o.convert(P.format,P.colorSpace),qe=o.convert(P.type);let Qe=R(P.internalFormat,ke,qe,P.colorSpace,P.isVideoTexture);Y(pe,P);let Be;const ft=P.mipmaps,it=P.isVideoTexture!==!0,bt=He.__version===void 0||_e===!0,X=he.dataReady,Ce=D(P,Me);if(P.isDepthTexture)Qe=T(P.format===Ta,P.type),bt&&(it?t.texStorage2D(a.TEXTURE_2D,1,Qe,Me.width,Me.height):t.texImage2D(a.TEXTURE_2D,0,Qe,Me.width,Me.height,0,ke,qe,null));else if(P.isDataTexture)if(ft.length>0){it&&bt&&t.texStorage2D(a.TEXTURE_2D,Ce,Qe,ft[0].width,ft[0].height);for(let fe=0,de=ft.length;fe<de;fe++)Be=ft[fe],it?X&&t.texSubImage2D(a.TEXTURE_2D,fe,0,0,Be.width,Be.height,ke,qe,Be.data):t.texImage2D(a.TEXTURE_2D,fe,Qe,Be.width,Be.height,0,ke,qe,Be.data);P.generateMipmaps=!1}else it?(bt&&t.texStorage2D(a.TEXTURE_2D,Ce,Qe,Me.width,Me.height),X&&t.texSubImage2D(a.TEXTURE_2D,0,0,0,Me.width,Me.height,ke,qe,Me.data)):t.texImage2D(a.TEXTURE_2D,0,Qe,Me.width,Me.height,0,ke,qe,Me.data);else if(P.isCompressedTexture)if(P.isCompressedArrayTexture){it&&bt&&t.texStorage3D(a.TEXTURE_2D_ARRAY,Ce,Qe,ft[0].width,ft[0].height,Me.depth);for(let fe=0,de=ft.length;fe<de;fe++)if(Be=ft[fe],P.format!==bi)if(ke!==null)if(it){if(X)if(P.layerUpdates.size>0){const Le=tv(Be.width,Be.height,P.format,P.type);for(const Pe of P.layerUpdates){const rt=Be.data.subarray(Pe*Le/Be.data.BYTES_PER_ELEMENT,(Pe+1)*Le/Be.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,fe,0,0,Pe,Be.width,Be.height,1,ke,rt)}P.clearLayerUpdates()}else t.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,fe,0,0,0,Be.width,Be.height,Me.depth,ke,Be.data)}else t.compressedTexImage3D(a.TEXTURE_2D_ARRAY,fe,Qe,Be.width,Be.height,Me.depth,0,Be.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else it?X&&t.texSubImage3D(a.TEXTURE_2D_ARRAY,fe,0,0,0,Be.width,Be.height,Me.depth,ke,qe,Be.data):t.texImage3D(a.TEXTURE_2D_ARRAY,fe,Qe,Be.width,Be.height,Me.depth,0,ke,qe,Be.data)}else{it&&bt&&t.texStorage2D(a.TEXTURE_2D,Ce,Qe,ft[0].width,ft[0].height);for(let fe=0,de=ft.length;fe<de;fe++)Be=ft[fe],P.format!==bi?ke!==null?it?X&&t.compressedTexSubImage2D(a.TEXTURE_2D,fe,0,0,Be.width,Be.height,ke,Be.data):t.compressedTexImage2D(a.TEXTURE_2D,fe,Qe,Be.width,Be.height,0,Be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):it?X&&t.texSubImage2D(a.TEXTURE_2D,fe,0,0,Be.width,Be.height,ke,qe,Be.data):t.texImage2D(a.TEXTURE_2D,fe,Qe,Be.width,Be.height,0,ke,qe,Be.data)}else if(P.isDataArrayTexture)if(it){if(bt&&t.texStorage3D(a.TEXTURE_2D_ARRAY,Ce,Qe,Me.width,Me.height,Me.depth),X)if(P.layerUpdates.size>0){const fe=tv(Me.width,Me.height,P.format,P.type);for(const de of P.layerUpdates){const Le=Me.data.subarray(de*fe/Me.data.BYTES_PER_ELEMENT,(de+1)*fe/Me.data.BYTES_PER_ELEMENT);t.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,de,Me.width,Me.height,1,ke,qe,Le)}P.clearLayerUpdates()}else t.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,0,Me.width,Me.height,Me.depth,ke,qe,Me.data)}else t.texImage3D(a.TEXTURE_2D_ARRAY,0,Qe,Me.width,Me.height,Me.depth,0,ke,qe,Me.data);else if(P.isData3DTexture)it?(bt&&t.texStorage3D(a.TEXTURE_3D,Ce,Qe,Me.width,Me.height,Me.depth),X&&t.texSubImage3D(a.TEXTURE_3D,0,0,0,0,Me.width,Me.height,Me.depth,ke,qe,Me.data)):t.texImage3D(a.TEXTURE_3D,0,Qe,Me.width,Me.height,Me.depth,0,ke,qe,Me.data);else if(P.isFramebufferTexture){if(bt)if(it)t.texStorage2D(a.TEXTURE_2D,Ce,Qe,Me.width,Me.height);else{let fe=Me.width,de=Me.height;for(let Le=0;Le<Ce;Le++)t.texImage2D(a.TEXTURE_2D,Le,Qe,fe,de,0,ke,qe,null),fe>>=1,de>>=1}}else if(ft.length>0){if(it&&bt){const fe=We(ft[0]);t.texStorage2D(a.TEXTURE_2D,Ce,Qe,fe.width,fe.height)}for(let fe=0,de=ft.length;fe<de;fe++)Be=ft[fe],it?X&&t.texSubImage2D(a.TEXTURE_2D,fe,0,0,ke,qe,Be):t.texImage2D(a.TEXTURE_2D,fe,Qe,ke,qe,Be);P.generateMipmaps=!1}else if(it){if(bt){const fe=We(Me);t.texStorage2D(a.TEXTURE_2D,Ce,Qe,fe.width,fe.height)}X&&t.texSubImage2D(a.TEXTURE_2D,0,0,0,ke,qe,Me)}else t.texImage2D(a.TEXTURE_2D,0,Qe,ke,qe,Me);y(P)&&x(pe),He.__version=he.version,P.onUpdate&&P.onUpdate(P)}U.__version=P.version}function ne(U,P,te){if(P.image.length!==6)return;const pe=Ee(U,P),_e=P.source;t.bindTexture(a.TEXTURE_CUBE_MAP,U.__webglTexture,a.TEXTURE0+te);const he=n.get(_e);if(_e.version!==he.__version||pe===!0){t.activeTexture(a.TEXTURE0+te);const He=St.getPrimaries(St.workingColorSpace),Re=P.colorSpace===vs?null:St.getPrimaries(P.colorSpace),Ue=P.colorSpace===vs||He===Re?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,P.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,P.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,P.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);const ut=P.isCompressedTexture||P.image[0].isCompressedTexture,Me=P.image[0]&&P.image[0].isDataTexture,ke=[];for(let de=0;de<6;de++)!ut&&!Me?ke[de]=M(P.image[de],!0,i.maxCubemapSize):ke[de]=Me?P.image[de].image:P.image[de],ke[de]=Lt(P,ke[de]);const qe=ke[0],Qe=o.convert(P.format,P.colorSpace),Be=o.convert(P.type),ft=R(P.internalFormat,Qe,Be,P.colorSpace),it=P.isVideoTexture!==!0,bt=he.__version===void 0||pe===!0,X=_e.dataReady;let Ce=D(P,qe);Y(a.TEXTURE_CUBE_MAP,P);let fe;if(ut){it&&bt&&t.texStorage2D(a.TEXTURE_CUBE_MAP,Ce,ft,qe.width,qe.height);for(let de=0;de<6;de++){fe=ke[de].mipmaps;for(let Le=0;Le<fe.length;Le++){const Pe=fe[Le];P.format!==bi?Qe!==null?it?X&&t.compressedTexSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le,0,0,Pe.width,Pe.height,Qe,Pe.data):t.compressedTexImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le,ft,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):it?X&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le,0,0,Pe.width,Pe.height,Qe,Be,Pe.data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le,ft,Pe.width,Pe.height,0,Qe,Be,Pe.data)}}}else{if(fe=P.mipmaps,it&&bt){fe.length>0&&Ce++;const de=We(ke[0]);t.texStorage2D(a.TEXTURE_CUBE_MAP,Ce,ft,de.width,de.height)}for(let de=0;de<6;de++)if(Me){it?X&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,ke[de].width,ke[de].height,Qe,Be,ke[de].data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,ft,ke[de].width,ke[de].height,0,Qe,Be,ke[de].data);for(let Le=0;Le<fe.length;Le++){const rt=fe[Le].image[de].image;it?X&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le+1,0,0,rt.width,rt.height,Qe,Be,rt.data):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le+1,ft,rt.width,rt.height,0,Qe,Be,rt.data)}}else{it?X&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Qe,Be,ke[de]):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,ft,Qe,Be,ke[de]);for(let Le=0;Le<fe.length;Le++){const Pe=fe[Le];it?X&&t.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le+1,0,0,Qe,Be,Pe.image[de]):t.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+de,Le+1,ft,Qe,Be,Pe.image[de])}}}y(P)&&x(a.TEXTURE_CUBE_MAP),he.__version=_e.version,P.onUpdate&&P.onUpdate(P)}U.__version=P.version}function xe(U,P,te,pe,_e,he){const He=o.convert(te.format,te.colorSpace),Re=o.convert(te.type),Ue=R(te.internalFormat,He,Re,te.colorSpace),ut=n.get(P),Me=n.get(te);if(Me.__renderTarget=P,!ut.__hasExternalTextures){const ke=Math.max(1,P.width>>he),qe=Math.max(1,P.height>>he);_e===a.TEXTURE_3D||_e===a.TEXTURE_2D_ARRAY?t.texImage3D(_e,he,Ue,ke,qe,P.depth,0,He,Re,null):t.texImage2D(_e,he,Ue,ke,qe,0,He,Re,null)}t.bindFramebuffer(a.FRAMEBUFFER,U),ct(P)?u.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,pe,_e,Me.__webglTexture,0,dt(P)):(_e===a.TEXTURE_2D||_e>=a.TEXTURE_CUBE_MAP_POSITIVE_X&&_e<=a.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&a.framebufferTexture2D(a.FRAMEBUFFER,pe,_e,Me.__webglTexture,he),t.bindFramebuffer(a.FRAMEBUFFER,null)}function me(U,P,te){if(a.bindRenderbuffer(a.RENDERBUFFER,U),P.depthBuffer){const pe=P.depthTexture,_e=pe&&pe.isDepthTexture?pe.type:null,he=T(P.stencilBuffer,_e),He=P.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Re=dt(P);ct(P)?u.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,Re,he,P.width,P.height):te?a.renderbufferStorageMultisample(a.RENDERBUFFER,Re,he,P.width,P.height):a.renderbufferStorage(a.RENDERBUFFER,he,P.width,P.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,He,a.RENDERBUFFER,U)}else{const pe=P.textures;for(let _e=0;_e<pe.length;_e++){const he=pe[_e],He=o.convert(he.format,he.colorSpace),Re=o.convert(he.type),Ue=R(he.internalFormat,He,Re,he.colorSpace),ut=dt(P);te&&ct(P)===!1?a.renderbufferStorageMultisample(a.RENDERBUFFER,ut,Ue,P.width,P.height):ct(P)?u.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,ut,Ue,P.width,P.height):a.renderbufferStorage(a.RENDERBUFFER,Ue,P.width,P.height)}}a.bindRenderbuffer(a.RENDERBUFFER,null)}function Te(U,P){if(P&&P.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(a.FRAMEBUFFER,U),!(P.depthTexture&&P.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pe=n.get(P.depthTexture);pe.__renderTarget=P,(!pe.__webglTexture||P.depthTexture.image.width!==P.width||P.depthTexture.image.height!==P.height)&&(P.depthTexture.image.width=P.width,P.depthTexture.image.height=P.height,P.depthTexture.needsUpdate=!0),re(P.depthTexture,0);const _e=pe.__webglTexture,he=dt(P);if(P.depthTexture.format===pa)ct(P)?u.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,_e,0,he):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,_e,0);else if(P.depthTexture.format===Ta)ct(P)?u.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,_e,0,he):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,_e,0);else throw new Error("Unknown depthTexture format")}function Ie(U){const P=n.get(U),te=U.isWebGLCubeRenderTarget===!0;if(P.__boundDepthTexture!==U.depthTexture){const pe=U.depthTexture;if(P.__depthDisposeCallback&&P.__depthDisposeCallback(),pe){const _e=()=>{delete P.__boundDepthTexture,delete P.__depthDisposeCallback,pe.removeEventListener("dispose",_e)};pe.addEventListener("dispose",_e),P.__depthDisposeCallback=_e}P.__boundDepthTexture=pe}if(U.depthTexture&&!P.__autoAllocateDepthBuffer){if(te)throw new Error("target.depthTexture not supported in Cube render targets");Te(P.__webglFramebuffer,U)}else if(te){P.__webglDepthbuffer=[];for(let pe=0;pe<6;pe++)if(t.bindFramebuffer(a.FRAMEBUFFER,P.__webglFramebuffer[pe]),P.__webglDepthbuffer[pe]===void 0)P.__webglDepthbuffer[pe]=a.createRenderbuffer(),me(P.__webglDepthbuffer[pe],U,!1);else{const _e=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,he=P.__webglDepthbuffer[pe];a.bindRenderbuffer(a.RENDERBUFFER,he),a.framebufferRenderbuffer(a.FRAMEBUFFER,_e,a.RENDERBUFFER,he)}}else if(t.bindFramebuffer(a.FRAMEBUFFER,P.__webglFramebuffer),P.__webglDepthbuffer===void 0)P.__webglDepthbuffer=a.createRenderbuffer(),me(P.__webglDepthbuffer,U,!1);else{const pe=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,_e=P.__webglDepthbuffer;a.bindRenderbuffer(a.RENDERBUFFER,_e),a.framebufferRenderbuffer(a.FRAMEBUFFER,pe,a.RENDERBUFFER,_e)}t.bindFramebuffer(a.FRAMEBUFFER,null)}function Ze(U,P,te){const pe=n.get(U);P!==void 0&&xe(pe.__webglFramebuffer,U,U.texture,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,0),te!==void 0&&Ie(U)}function Dt(U){const P=U.texture,te=n.get(U),pe=n.get(P);U.addEventListener("dispose",I);const _e=U.textures,he=U.isWebGLCubeRenderTarget===!0,He=_e.length>1;if(He||(pe.__webglTexture===void 0&&(pe.__webglTexture=a.createTexture()),pe.__version=P.version,l.memory.textures++),he){te.__webglFramebuffer=[];for(let Re=0;Re<6;Re++)if(P.mipmaps&&P.mipmaps.length>0){te.__webglFramebuffer[Re]=[];for(let Ue=0;Ue<P.mipmaps.length;Ue++)te.__webglFramebuffer[Re][Ue]=a.createFramebuffer()}else te.__webglFramebuffer[Re]=a.createFramebuffer()}else{if(P.mipmaps&&P.mipmaps.length>0){te.__webglFramebuffer=[];for(let Re=0;Re<P.mipmaps.length;Re++)te.__webglFramebuffer[Re]=a.createFramebuffer()}else te.__webglFramebuffer=a.createFramebuffer();if(He)for(let Re=0,Ue=_e.length;Re<Ue;Re++){const ut=n.get(_e[Re]);ut.__webglTexture===void 0&&(ut.__webglTexture=a.createTexture(),l.memory.textures++)}if(U.samples>0&&ct(U)===!1){te.__webglMultisampledFramebuffer=a.createFramebuffer(),te.__webglColorRenderbuffer=[],t.bindFramebuffer(a.FRAMEBUFFER,te.__webglMultisampledFramebuffer);for(let Re=0;Re<_e.length;Re++){const Ue=_e[Re];te.__webglColorRenderbuffer[Re]=a.createRenderbuffer(),a.bindRenderbuffer(a.RENDERBUFFER,te.__webglColorRenderbuffer[Re]);const ut=o.convert(Ue.format,Ue.colorSpace),Me=o.convert(Ue.type),ke=R(Ue.internalFormat,ut,Me,Ue.colorSpace,U.isXRRenderTarget===!0),qe=dt(U);a.renderbufferStorageMultisample(a.RENDERBUFFER,qe,ke,U.width,U.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Re,a.RENDERBUFFER,te.__webglColorRenderbuffer[Re])}a.bindRenderbuffer(a.RENDERBUFFER,null),U.depthBuffer&&(te.__webglDepthRenderbuffer=a.createRenderbuffer(),me(te.__webglDepthRenderbuffer,U,!0)),t.bindFramebuffer(a.FRAMEBUFFER,null)}}if(he){t.bindTexture(a.TEXTURE_CUBE_MAP,pe.__webglTexture),Y(a.TEXTURE_CUBE_MAP,P);for(let Re=0;Re<6;Re++)if(P.mipmaps&&P.mipmaps.length>0)for(let Ue=0;Ue<P.mipmaps.length;Ue++)xe(te.__webglFramebuffer[Re][Ue],U,P,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+Re,Ue);else xe(te.__webglFramebuffer[Re],U,P,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+Re,0);y(P)&&x(a.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(He){for(let Re=0,Ue=_e.length;Re<Ue;Re++){const ut=_e[Re],Me=n.get(ut);t.bindTexture(a.TEXTURE_2D,Me.__webglTexture),Y(a.TEXTURE_2D,ut),xe(te.__webglFramebuffer,U,ut,a.COLOR_ATTACHMENT0+Re,a.TEXTURE_2D,0),y(ut)&&x(a.TEXTURE_2D)}t.unbindTexture()}else{let Re=a.TEXTURE_2D;if((U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(Re=U.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),t.bindTexture(Re,pe.__webglTexture),Y(Re,P),P.mipmaps&&P.mipmaps.length>0)for(let Ue=0;Ue<P.mipmaps.length;Ue++)xe(te.__webglFramebuffer[Ue],U,P,a.COLOR_ATTACHMENT0,Re,Ue);else xe(te.__webglFramebuffer,U,P,a.COLOR_ATTACHMENT0,Re,0);y(P)&&x(Re),t.unbindTexture()}U.depthBuffer&&Ie(U)}function _t(U){const P=U.textures;for(let te=0,pe=P.length;te<pe;te++){const _e=P[te];if(y(_e)){const he=b(U),He=n.get(_e).__webglTexture;t.bindTexture(he,He),x(he),t.unbindTexture()}}}const Ot=[],H=[];function On(U){if(U.samples>0){if(ct(U)===!1){const P=U.textures,te=U.width,pe=U.height;let _e=a.COLOR_BUFFER_BIT;const he=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,He=n.get(U),Re=P.length>1;if(Re)for(let Ue=0;Ue<P.length;Ue++)t.bindFramebuffer(a.FRAMEBUFFER,He.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Ue,a.RENDERBUFFER,null),t.bindFramebuffer(a.FRAMEBUFFER,He.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Ue,a.TEXTURE_2D,null,0);t.bindFramebuffer(a.READ_FRAMEBUFFER,He.__webglMultisampledFramebuffer),t.bindFramebuffer(a.DRAW_FRAMEBUFFER,He.__webglFramebuffer);for(let Ue=0;Ue<P.length;Ue++){if(U.resolveDepthBuffer&&(U.depthBuffer&&(_e|=a.DEPTH_BUFFER_BIT),U.stencilBuffer&&U.resolveStencilBuffer&&(_e|=a.STENCIL_BUFFER_BIT)),Re){a.framebufferRenderbuffer(a.READ_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.RENDERBUFFER,He.__webglColorRenderbuffer[Ue]);const ut=n.get(P[Ue]).__webglTexture;a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,ut,0)}a.blitFramebuffer(0,0,te,pe,0,0,te,pe,_e,a.NEAREST),f===!0&&(Ot.length=0,H.length=0,Ot.push(a.COLOR_ATTACHMENT0+Ue),U.depthBuffer&&U.resolveDepthBuffer===!1&&(Ot.push(he),H.push(he),a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,H)),a.invalidateFramebuffer(a.READ_FRAMEBUFFER,Ot))}if(t.bindFramebuffer(a.READ_FRAMEBUFFER,null),t.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),Re)for(let Ue=0;Ue<P.length;Ue++){t.bindFramebuffer(a.FRAMEBUFFER,He.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Ue,a.RENDERBUFFER,He.__webglColorRenderbuffer[Ue]);const ut=n.get(P[Ue]).__webglTexture;t.bindFramebuffer(a.FRAMEBUFFER,He.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Ue,a.TEXTURE_2D,ut,0)}t.bindFramebuffer(a.DRAW_FRAMEBUFFER,He.__webglMultisampledFramebuffer)}else if(U.depthBuffer&&U.resolveDepthBuffer===!1&&f){const P=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,[P])}}}function dt(U){return Math.min(i.maxSamples,U.samples)}function ct(U){const P=n.get(U);return U.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&P.__useRenderToTexture!==!1}function je(U){const P=l.render.frame;p.get(U)!==P&&(p.set(U,P),U.update())}function Lt(U,P){const te=U.colorSpace,pe=U.format,_e=U.type;return U.isCompressedTexture===!0||U.isVideoTexture===!0||te!==Kn&&te!==vs&&(St.getTransfer(te)===Ut?(pe!==bi||_e!==kr)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",te)),P}function We(U){return typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement?(h.width=U.naturalWidth||U.width,h.height=U.naturalHeight||U.height):typeof VideoFrame<"u"&&U instanceof VideoFrame?(h.width=U.displayWidth,h.height=U.displayHeight):(h.width=U.width,h.height=U.height),h}this.allocateTextureUnit=K,this.resetTextureUnits=Z,this.setTexture2D=re,this.setTexture2DArray=J,this.setTexture3D=oe,this.setTextureCube=z,this.rebindTextures=Ze,this.setupRenderTarget=Dt,this.updateRenderTargetMipmap=_t,this.updateMultisampleRenderTarget=On,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=ct}function xC(a,e){function t(n,i=vs){let o;const l=St.getTransfer(i);if(n===kr)return a.UNSIGNED_BYTE;if(n===Qp)return a.UNSIGNED_SHORT_4_4_4_4;if(n===Jp)return a.UNSIGNED_SHORT_5_5_5_1;if(n===ex)return a.UNSIGNED_INT_5_9_9_9_REV;if(n===Qv)return a.BYTE;if(n===Jv)return a.SHORT;if(n===Bl)return a.UNSIGNED_SHORT;if(n===Zp)return a.INT;if(n===go)return a.UNSIGNED_INT;if(n===Xi)return a.FLOAT;if(n===$l)return a.HALF_FLOAT;if(n===tx)return a.ALPHA;if(n===nx)return a.RGB;if(n===bi)return a.RGBA;if(n===ix)return a.LUMINANCE;if(n===rx)return a.LUMINANCE_ALPHA;if(n===pa)return a.DEPTH_COMPONENT;if(n===Ta)return a.DEPTH_STENCIL;if(n===em)return a.RED;if(n===tm)return a.RED_INTEGER;if(n===sx)return a.RG;if(n===nm)return a.RG_INTEGER;if(n===im)return a.RGBA_INTEGER;if(n===Uc||n===Fc||n===Oc||n===kc)if(l===Ut)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(n===Uc)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Fc)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Oc)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===kc)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(n===Uc)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Fc)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Oc)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===kc)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Jd||n===ep||n===tp||n===np)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(n===Jd)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ep)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===tp)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===np)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ip||n===rp||n===sp)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(n===ip||n===rp)return l===Ut?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(n===sp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===op||n===ap||n===lp||n===up||n===cp||n===fp||n===hp||n===dp||n===pp||n===mp||n===gp||n===_p||n===vp||n===xp)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(n===op)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ap)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===lp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===up)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===cp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===hp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===dp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===pp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===mp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===gp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===_p)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===vp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===xp)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Bc||n===yp||n===Sp)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(n===Bc)return l===Ut?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===yp)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Sp)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ox||n===Mp||n===Ep||n===Tp)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(n===Bc)return o.COMPRESSED_RED_RGTC1_EXT;if(n===Mp)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ep)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Tp)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ea?a.UNSIGNED_INT_24_8:a[n]!==void 0?a[n]:null}return{convert:t}}const yC={type:"move"};class bd{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new lo,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new lo,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new j,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new j),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new lo,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new j,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new j),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,o=null,l=null;const u=this._targetRay,f=this._grip,h=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(h&&e.hand){l=!0;for(const M of e.hand.values()){const y=t.getJointPose(M,n),x=this._getHandJoint(h,M);y!==null&&(x.matrix.fromArray(y.transform.matrix),x.matrix.decompose(x.position,x.rotation,x.scale),x.matrixWorldNeedsUpdate=!0,x.jointRadius=y.radius),x.visible=y!==null}const p=h.joints["index-finger-tip"],m=h.joints["thumb-tip"],g=p.position.distanceTo(m.position),v=.02,E=.005;h.inputState.pinching&&g>v+E?(h.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!h.inputState.pinching&&g<=v-E&&(h.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else f!==null&&e.gripSpace&&(o=t.getPose(e.gripSpace,n),o!==null&&(f.matrix.fromArray(o.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,o.linearVelocity?(f.hasLinearVelocity=!0,f.linearVelocity.copy(o.linearVelocity)):f.hasLinearVelocity=!1,o.angularVelocity?(f.hasAngularVelocity=!0,f.angularVelocity.copy(o.angularVelocity)):f.hasAngularVelocity=!1));u!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&o!==null&&(i=o),i!==null&&(u.matrix.fromArray(i.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,i.linearVelocity?(u.hasLinearVelocity=!0,u.linearVelocity.copy(i.linearVelocity)):u.hasLinearVelocity=!1,i.angularVelocity?(u.hasAngularVelocity=!0,u.angularVelocity.copy(i.angularVelocity)):u.hasAngularVelocity=!1,this.dispatchEvent(yC)))}return u!==null&&(u.visible=i!==null),f!==null&&(f.visible=o!==null),h!==null&&(h.visible=l!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new lo;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const SC=`
void main() {
...
}`;class EC{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const i=new xn,o=e.properties.get(i);o.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new lr({vertexShader:SC,fragmentShader:MC,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new vn(new Ra(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class TC extends xo{constructor(e,t){super();const n=this;let i=null,o=1,l=null,u="local-floor",f=1,h=null,p=null,m=null,g=null,v=null,E=null;const M=new EC,y=t.getContextAttributes();let x=null,b=null;const R=[],T=[],D=new Mt;let N=null;const I=new Dn;I.viewport=new wt;const F=new Dn;F.viewport=new wt;const A=[I,F],C=new DT;let B=null,Z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let ne=R[$];return ne===void 0&&(ne=new bd,R[$]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function($){let ne=R[$];return ne===void 0&&(ne=new bd,R[$]=ne),ne.getGripSpace()},this.getHand=function($){let ne=R[$];return ne===void 0&&(ne=new bd,R[$]=ne),ne.getHandSpace()};function K($){const ne=T.indexOf($.inputSource);if(ne===-1)return;const xe=R[ne];xe!==void 0&&(xe.update($.inputSource,$.frame,h||l),xe.dispatchEvent({type:$.type,data:$.inputSource}))}function ce(){i.removeEventListener("select",K),i.removeEventListener("selectstart",K),i.removeEventListener("selectend",K),i.removeEventListener("squeeze",K),i.removeEventListener("squeezestart",K),i.removeEventListener("squeezeend",K),i.removeEventListener("end",ce),i.removeEventListener("inputsourceschange",re);for(let $=0;$<R.length;$++){const ne=T[$];ne!==null&&(T[$]=null,R[$].disconnect(ne))}B=null,Z=null,M.reset(),e.setRenderTarget(x),v=null,g=null,m=null,i=null,b=null,Ee.stop(),n.isPresenting=!1,e.setPixelRatio(N),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){o=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){u=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||l},this.setReferenceSpace=function($){h=$},this.getBaseLayer=function(){return g!==null?g:v},this.getBinding=function(){return m},this.getFrame=function(){return E},this.getSession=function(){return i},this.setSession=async function($){if(i=$,i!==null){if(x=e.getRenderTarget(),i.addEventListener("select",K),i.addEventListener("selectstart",K),i.addEventListener("selectend",K),i.addEventListener("squeeze",K),i.addEventListener("squeezestart",K),i.addEventListener("squeezeend",K),i.addEventListener("end",ce),i.addEventListener("inputsourceschange",re),y.xrCompatible!==!0&&await t.makeXRCompatible(),N=e.getPixelRatio(),e.getSize(D),i.renderState.layers===void 0){const ne={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:o};v=new XRWebGLLayer(i,t,ne),i.updateRenderState({baseLayer:v}),e.setPixelRatio(1),e.setSize(v.framebufferWidth,v.framebufferHeight,!1),b=new Cs(v.framebufferWidth,v.framebufferHeight,{format:bi,type:kr,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil})}else{let ne=null,xe=null,me=null;y.depth&&(me=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ne=y.stencil?Ta:pa,xe=y.stencil?Ea:go);const Te={colorFormat:t.RGBA8,depthFormat:me,scaleFactor:o};m=new XRWebGLBinding(i,t),g=m.createProjectionLayer(Te),i.updateRenderState({layers:[g]}),e.setPixelRatio(1),e.setSize(g.textureWidth,g.textureHeight,!1),b=new Cs(g.textureWidth,g.textureHeight,{format:bi,type:kr,depthTexture:new Tx(g.textureWidth,g.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,ne),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:g.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(f),h=null,l=await i.requestReferenceSpace(u),Ee.setContext(i),Ee.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function re($){for(let ne=0;ne<$.removed.length;ne++){const xe=$.removed[ne],me=T.indexOf(xe);me>=0&&(T[me]=null,R[me].disconnect(xe))}for(let ne=0;ne<$.added.length;ne++){const xe=$.added[ne];let me=T.indexOf(xe);if(me===-1){for(let Ie=0;Ie<R.length;Ie++)if(Ie>=T.length){T.push(xe),me=Ie;break}else if(T[Ie]===null){T[Ie]=xe,me=Ie;break}if(me===-1)break}const Te=R[me];Te&&Te.connect(xe)}}const J=new j,oe=new j;function z($,ne,xe){J.setFromMatrixPosition(ne.matrixWorld),oe.setFromMatrixPosition(xe.matrixWorld);const me=J.distanceTo(oe),Te=ne.projectionMatrix.elements,Ie=xe.projectionMatrix.elements,Ze=Te[14]/(Te[10]-1),Dt=Te[14]/(Te[10]+1),_t=(Te[9]+1)/Te[5],Ot=(Te[9]-1)/Te[5],H=(Te[8]-1)/Te[0],On=(Ie[8]+1)/Ie[0],dt=Ze*H,ct=Ze*On,je=me/(-H+On),Lt=je*-H;if(ne.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Lt),$.translateZ(je),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Te[10]===-1)$.projectionMatrix.copy(ne.projectionMatrix),$.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{const We=Ze+je,U=Dt+je,P=dt-Lt,te=ct+(me-Lt),pe=_t*Dt/U*We,_e=Ot*Dt/U*We;$.projectionMatrix.makePerspective(P,te,pe,_e,We,U),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function ue($,ne){ne===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(ne.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(i===null)return;let ne=$.near,xe=$.far;M.texture!==null&&(M.depthNear>0&&(ne=M.depthNear),M.depthFar>0&&(xe=M.depthFar)),C.near=F.near=I.near=ne,C.far=F.far=I.far=xe,(B!==C.near||Z!==C.far)&&(i.updateRenderState({depthNear:C.near,depthFar:C.far}),B=C.near,Z=C.far),I.layers.mask=$.layers.mask|2,F.layers.mask=$.layers.mask|4,C.layers.mask=I.layers.mask|F.layers.mask;const me=$.parent,Te=C.cameras;ue(C,me);for(let Ie=0;Ie<Te.length;Ie++)ue(Te[Ie],me);Te.length===2?z(C,I,F):C.projectionMatrix.copy(I.projectionMatrix),le($,C,me)};function le($,ne,xe){xe===null?$.matrix.copy(ne.matrixWorld):($.matrix.copy(xe.matrixWorld),$.matrix.invert(),$.matrix.multiply(ne.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(ne.projectionMatrix),$.projectionMatrixInverse.copy(ne.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=wa*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(g===null&&v===null))return f},this.setFoveation=function($){f=$,g!==null&&(g.fixedFoveation=$),v!==null&&v.fixedFoveation!==void 0&&(v.fixedFoveation=$)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(C)};let k=null;function Y($,ne){if(p=ne.getViewerPose(h||l),E=ne,p!==null){const xe=p.views;v!==null&&(e.setRenderTargetFramebuffer(b,v.framebuffer),e.setRenderTarget(b));let me=!1;xe.length!==C.cameras.length&&(C.cameras.length=0,me=!0);for(let Ie=0;Ie<xe.length;Ie++){const Ze=xe[Ie];let Dt=null;if(v!==null)Dt=v.getViewport(Ze);else{const Ot=m.getViewSubImage(g,Ze);Dt=Ot.viewport,Ie===0&&(e.setRenderTargetTextures(b,Ot.colorTexture,g.ignoreDepthValues?void 0:Ot.depthStencilTexture),e.setRenderTarget(b))}let _t=A[Ie];_t===void 0&&(_t=new Dn,_t.layers.enable(Ie),_t.viewport=new wt,A[Ie]=_t),_t.matrix.fromArray(Ze.transform.matrix),_t.matrix.decompose(_t.position,_t.quaternion,_t.scale),_t.projectionMatrix.fromArray(Ze.projectionMatrix),_t.projectionMatrixInverse.copy(_t.projectionMatrix).invert(),_t.viewport.set(Dt.x,Dt.y,Dt.width,Dt.height),Ie===0&&(C.matrix.copy(_t.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),me===!0&&C.cameras.push(_t)}const Te=i.enabledFeatures;if(Te&&Te.includes("depth-sensing")){const Ie=m.getDepthInformation(xe[0]);Ie&&Ie.isValid&&Ie.texture&&M.init(e,Ie,i.renderState)}}for(let xe=0;xe<R.length;xe++){const me=T[xe],Te=R[xe];me!==null&&Te!==void 0&&Te.update(me,ne,h||l)}k&&k($,ne),ne.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ne}),E=null}const Ee=new Px;Ee.setAnimationLoop(Y),this.setAnimationLoop=function($){k=$},this.dispose=function(){}}}const Js=new ar,wC=new ot;function AC(a,e){function t(y,x){y.matrixAutoUpdate===!0&&y.updateMatrix(),x.value.copy(y.matrix)}function n(y,x){x.color.getRGB(y.fogColor.value,_x(a)),x.isFog?(y.fogNear.value=x.near,y.fogFar.value=x.far):x.isFogExp2&&(y.fogDensity.value=x.density)}function i(y,x,b,R,T){x.isMeshBasicMaterial||x.isMeshLambertMaterial?o(y,x):x.isMeshToonMaterial?(o(y,x),m(y,x)):x.isMeshPhongMaterial?(o(y,x),p(y,x)):x.isMeshStandardMaterial?(o(y,x),g(y,x),x.isMeshPhysicalMaterial&&v(y,x,T)):x.isMeshMatcapMaterial?(o(y,x),E(y,x)):x.isMeshDepthMaterial?o(y,x):x.isMeshDistanceMaterial?(o(y,x),M(y,x)):x.isMeshNormalMaterial?o(y,x):x.isLineBasicMaterial?(l(y,x),x.isLineDashedMaterial&&u(y,x)):x.isPointsMaterial?f(y,x,b,R):x.isSpriteMaterial?h(y,x):x.isShadowMaterial?(y.color.value.copy(x.color),y.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function o(y,x){y.opacity.value=x.opacity,x.color&&y.diffuse.value.copy(x.color),x.emissive&&y.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(y.map.value=x.map,t(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,t(x.alphaMap,y.alphaMapTransform)),x.bumpMap&&(y.bumpMap.value=x.bumpMap,t(x.bumpMap,y.bumpMapTransform),y.bumpScale.value=x.bumpScale,x.side===jn&&(y.bumpScale.value*=-1)),x.normalMap&&(y.normalMap.value=x.normalMap,t(x.normalMap,y.normalMapTransform),y.normalScale.value.copy(x.normalScale),x.side===jn&&y.normalScale.value.negate()),x.displacementMap&&(y.displacementMap.value=x.displacementMap,t(x.displacementMap,y.displacementMapTransform),y.displacementScale.value=x.displacementScale,y.displacementBias.value=x.displacementBias),x.emissiveMap&&(y.emissiveMap.value=x.emissiveMap,t(x.emissiveMap,y.emissiveMapTransform)),x.specularMap&&(y.specularMap.value=x.specularMap,t(x.specularMap,y.specularMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest);const b=e.get(x),R=b.envMap,T=b.envMapRotation;R&&(y.envMap.value=R,Js.copy(T),Js.x*=-1,Js.y*=-1,Js.z*=-1,R.isCubeTexture&&R.isRenderTargetTexture===!1&&(Js.y*=-1,Js.z*=-1),y.envMapRotation.value.setFromMatrix4(wC.makeRotationFromEuler(Js)),y.flipEnvMap.value=R.isCubeTexture&&R.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=x.reflectivity,y.ior.value=x.ior,y.refractionRatio.value=x.refractionRatio),x.lightMap&&(y.lightMap.value=x.lightMap,y.lightMapIntensity.value=x.lightMapIntensity,t(x.lightMap,y.lightMapTransform)),x.aoMap&&(y.aoMap.value=x.aoMap,y.aoMapIntensity.value=x.aoMapIntensity,t(x.aoMap,y.aoMapTransform))}function l(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,x.map&&(y.map.value=x.map,t(x.map,y.mapTransform))}function u(y,x){y.dashSize.value=x.dashSize,y.totalSize.value=x.dashSize+x.gapSize,y.scale.value=x.scale}function f(y,x,b,R){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.size.value=x.size*b,y.scale.value=R*.5,x.map&&(y.map.value=x.map,t(x.map,y.uvTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,t(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function h(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.rotation.value=x.rotation,x.map&&(y.map.value=x.map,t(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,t(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function p(y,x){y.specular.value.copy(x.specular),y.shininess.value=Math.max(x.shininess,1e-4)}function m(y,x){x.gradientMap&&(y.gradientMap.value=x.gradientMap)}function g(y,x){y.metalness.value=x.metalness,x.metalnessMap&&(y.metalnessMap.value=x.metalnessMap,t(x.metalnessMap,y.metalnessMapTransform)),y.roughness.value=x.roughness,x.roughnessMap&&(y.roughnessMap.value=x.roughnessMap,t(x.roughnessMap,y.roughnessMapTransform)),x.envMap&&(y.envMapIntensity.value=x.envMapIntensity)}function v(y,x,b){y.ior.value=x.ior,x.sheen>0&&(y.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),y.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(y.sheenColorMap.value=x.sheenColorMap,t(x.sheenColorMap,y.sheenColorMapTransform)),x.sheenRoughnessMap&&(y.sheenRoughnessMap.value=x.sheenRoughnessMap,t(x.sheenRoughnessMap,y.sheenRoughnessMapTransform))),x.clearcoat>0&&(y.clearcoat.value=x.clearcoat,y.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(y.clearcoatMap.value=x.clearcoatMap,t(x.clearcoatMap,y.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,t(x.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(y.clearcoatNormalMap.value=x.clearcoatNormalMap,t(x.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===jn&&y.clearcoatNormalScale.value.negate())),x.dispersion>0&&(y.dispersion.value=x.dispersion),x.iridescence>0&&(y.iridescence.value=x.iridescence,y.iridescenceIOR.value=x.iridescenceIOR,y.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(y.iridescenceMap.value=x.iridescenceMap,t(x.iridescenceMap,y.iridescenceMapTransform)),x.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=x.iridescenceThicknessMap,t(x.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),x.transmission>0&&(y.transmission.value=x.transmission,y.transmissionSamplerMap.value=b.texture,y.transmissionSamplerSize.value.set(b.width,b.height),x.transmissionMap&&(y.transmissionMap.value=x.transmissionMap,t(x.transmissionMap,y.transmissionMapTransform)),y.thickness.value=x.thickness,x.thicknessMap&&(y.thicknessMap.value=x.thicknessMap,t(x.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=x.attenuationDistance,y.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(y.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(y.anisotropyMap.value=x.anisotropyMap,t(x.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=x.specularIntensity,y.specularColor.value.copy(x.specularColor),x.specularColorMap&&(y.specularColorMap.value=x.specularColorMap,t(x.specularColorMap,y.specularColorMapTransform)),x.specularIntensityMap&&(y.specularIntensityMap.value=x.specularIntensityMap,t(x.specularIntensityMap,y.specularIntensityMapTransform))}function E(y,x){x.matcap&&(y.matcap.value=x.matcap)}function M(y,x){const b=e.get(x).light;y.referencePosition.value.setFromMatrixPosition(b.matrixWorld),y.nearDistance.value=b.shadow.camera.near,y.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function RC(a,e,t,n){let i={},o={},l=[];const u=a.getParameter(a.MAX_UNIFORM_BUFFER_BINDINGS);function f(b,R){const T=R.program;n.uniformBlockBinding(b,T)}function h(b,R){let T=i[b.id];T===void 0&&(E(b),T=p(b),i[b.id]=T,b.addEventListener("dispose",y));const D=R.program;n.updateUBOMapping(b,D);const N=e.render.frame;o[b.id]!==N&&(g(b),o[b.id]=N)}function p(b){const R=m();b.__bindingPointIndex=R;const T=a.createBuffer(),D=b.__size,N=b.usage;return a.bindBuffer(a.UNIFORM_BUFFER,T),a.bufferData(a.UNIFORM_BUFFER,D,N),a.bindBuffer(a.UNIFORM_BUFFER,null),a.bindBufferBase(a.UNIFORM_BUFFER,R,T),T}function m(){for(let b=0;b<u;b++)if(l.indexOf(b)===-1)return l.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function g(b){const R=i[b.id],T=b.uniforms,D=b.__cache;a.bindBuffer(a.UNIFORM_BUFFER,R);for(let N=0,I=T.length;N<I;N++){const F=Array.isArray(T[N])?T[N]:[T[N]];for(let A=0,C=F.length;A<C;A++){const B=F[A];if(v(B,N,A,D)===!0){const Z=B.__offset,K=Array.isArray(B.value)?B.value:[B.value];let ce=0;for(let re=0;re<K.length;re++){const J=K[re],oe=M(J);typeof J=="number"||typeof J=="boolean"?(B.__data[0]=J,a.bufferSubData(a.UNIFORM_BUFFER,Z+ce,B.__data)):J.isMatrix3?(B.__data[0]=J.elements[0],B.__data[1]=J.elements[1],B.__data[2]=J.elements[2],B.__data[3]=0,B.__data[4]=J.elements[3],B.__data[5]=J.elements[4],B.__data[6]=J.elements[5],B.__data[7]=0,B.__data[8]=J.elements[6],B.__data[9]=J.elements[7],B.__data[10]=J.elements[8],B.__data[11]=0):(J.toArray(B.__data,ce),ce+=oe.storage/Float32Array.BYTES_PER_ELEMENT)}a.bufferSubData(a.UNIFORM_BUFFER,Z,B.__data)}}}a.bindBuffer(a.UNIFORM_BUFFER,null)}function v(b,R,T,D){const N=b.value,I=R+"_"+T;if(D[I]===void 0)return typeof N=="number"||typeof N=="boolean"?D[I]=N:D[I]=N.clone(),!0;{const F=D[I];if(typeof N=="number"||typeof N=="boolean"){if(F!==N)return D[I]=N,!0}else if(F.equals(N)===!1)return F.copy(N),!0}return!1}function E(b){const R=b.uniforms;let T=0;const D=16;for(let I=0,F=R.length;I<F;I++){const A=Array.isArray(R[I])?R[I]:[R[I]];for(let C=0,B=A.length;C<B;C++){const Z=A[C],K=Array.isArray(Z.value)?Z.value:[Z.value];for(let ce=0,re=K.length;ce<re;ce++){const J=K[ce],oe=M(J),z=T%D,ue=z%oe.boundary,le=z+ue;T+=ue,le!==0&&D-le<oe.storage&&(T+=D-le),Z.__data=new Float32Array(oe.storage/Float32Array.BYTES_PER_ELEMENT),Z.__offset=T,T+=oe.storage}}}const N=T%D;return N>0&&(T+=D-N),b.__size=T,b.__cache={},this}function M(b){const R={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(R.boundary=4,R.storage=4):b.isVector2?(R.boundary=8,R.storage=8):b.isVector3||b.isColor?(R.boundary=16,R.storage=12):b.isVector4?(R.boundary=16,R.storage=16):b.isMatrix3?(R.boundary=48,R.storage=48):b.isMatrix4?(R.boundary=64,R.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),R}function y(b){const R=b.target;R.removeEventListener("dispose",y);const T=l.indexOf(R.__bindingPointIndex);l.splice(T,1),a.deleteBuffer(i[R.id]),delete i[R.id],delete o[R.id]}function x(){for(const b in i)a.deleteBuffer(i[b]);l=[],i={},o={}}return{bind:f,update:h,dispose:x}}class CC{constructor(e={}){const{canvas:t=PE(),context:n=null,depth:i=!0,stencil:o=!1,alpha:l=!1,antialias:u=!1,premultipliedAlpha:f=!0,preserveDrawingBuffer:h=!1,powerPreference:p="default",failIfMajorPerformanceCaveat:m=!1,reverseDepthBuffer:g=!1}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=l;const E=new Uint32Array(4),M=new Int32Array(4);let y=null,x=null;const b=[],R=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Tn,this.toneMapping=ws,this.toneMappingExposure=1;const T=this;let D=!1,N=0,I=0,F=null,A=-1,C=null;const B=new wt,Z=new wt;let K=null;const ce=new nt(0);let re=0,J=t.width,oe=t.height,z=1,ue=null,le=null;const k=new wt(0,0,J,oe),Y=new wt(0,0,J,oe);let Ee=!1;const $=new lm;let ne=!1,xe=!1;const me=new ot,Te=new ot,Ie=new j,Ze=new wt,Dt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let _t=!1;function Ot(){return F===null?z:1}let H=n;function On(L,q){return t.getContext(L,q)}try{const L={alpha:!0,depth:i,stencil:o,antialias:u,premultipliedAlpha:f,preserveDrawingBuffer:h,powerPreference:p,failIfMajorPerformanceCaveat:m};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${$p}`),t.addEventListener("webglcontextlost",de,!1),t.addEventListener("webglcontextrestored",Le,!1),t.addEventListener("webglcontextcreationerror",Pe,!1),H===null){const q="webgl2";if(H=On(q,L),H===null)throw On(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(L){throw console.error("THREE.WebGLRenderer: "+L.message),L}let dt,ct,je,Lt,We,U,P,te,pe,_e,he,He,Re,Ue,ut,Me,ke,qe,Qe,Be,ft,it,bt,X;function Ce(){dt=new OA(H),dt.init(),it=new xC(H,dt),ct=new LA(H,dt,e,it),je=new _C(H,dt),ct.reverseDepthBuffer&&g&&je.buffers.depth.setReversed(!0),Lt=new zA(H),We=new rC,U=new vC(H,dt,je,We,ct,it,Lt),P=new DA(T),te=new FA(T),pe=new YT(H),bt=new bA(H,pe),_e=new kA(H,pe,Lt,bt),he=new HA(H,_e,pe,Lt),Qe=new VA(H,ct,U),Me=new IA(We),He=new iC(T,P,te,dt,ct,bt,Me),Re=new AC(T,We),Ue=new oC,ut=new hC(dt),qe=new CA(T,P,te,je,he,v,f),ke=new mC(T,he,ct),X=new RC(H,Lt,ct,je),Be=new PA(H,dt,Lt),ft=new BA(H,dt,Lt),Lt.programs=He.programs,T.capabilities=ct,T.extensions=dt,T.properties=We,T.renderLists=Ue,T.shadowMap=ke,T.state=je,T.info=Lt}Ce();const fe=new TC(T,H);this.xr=fe,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const L=dt.get("WEBGL_lose_context");L&&L.loseContext()},this.forceContextRestore=function(){const L=dt.get("WEBGL_lose_context");L&&L.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(L){L!==void 0&&(z=L,this.setSize(J,oe,!1))},this.getSize=function(L){return L.set(J,oe)},this.setSize=function(L,q,se=!0){if(fe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}J=L,oe=q,t.width=Math.floor(L*z),t.height=Math.floor(q*z),se===!0&&(t.style.width=L+"px",t.style.height=q+"px"),this.setViewport(0,0,L,q)},this.getDrawingBufferSize=function(L){return L.set(J*z,oe*z).floor()},this.setDrawingBufferSize=function(L,q,se){J=L,oe=q,z=se,t.width=Math.floor(L*se),t.height=Math.floor(q*se),this.setViewport(0,0,L,q)},this.getCurrentViewport=function(L){return L.copy(B)},this.getViewport=function(L){return L.copy(k)},this.setViewport=function(L,q,se,ae){L.isVector4?k.set(L.x,L.y,L.z,L.w):k.set(L,q,se,ae),je.viewport(B.copy(k).multiplyScalar(z).round())},this.getScissor=function(L){return L.copy(Y)},this.setScissor=function(L,q,se,ae){L.isVector4?Y.set(L.x,L.y,L.z,L.w):Y.set(L,q,se,ae),je.scissor(Z.copy(Y).multiplyScalar(z).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(L){je.setScissorTest(Ee=L)},this.setOpaqueSort=function(L){ue=L},this.setTransparentSort=function(L){le=L},this.getClearColor=function(L){return L.copy(qe.getClearColor())},this.setClearColor=function(){qe.setClearColor.apply(qe,arguments)},this.getClearAlpha=function(){return qe.getClearAlpha()},this.setClearAlpha=function(){qe.setClearAlpha.apply(qe,arguments)},this.clear=function(L=!0,q=!0,se=!0){let ae=0;if(L){let G=!1;if(F!==null){const Se=F.texture.format;G=Se===im||Se===nm||Se===tm}if(G){const Se=F.texture.type,be=Se===kr||Se===go||Se===Bl||Se===Ea||Se===Qp||Se===Jp,Ne=qe.getClearColor(),Fe=qe.getClearAlpha(),Je=Ne.r,et=Ne.g,Xe=Ne.b;be?(E[0]=Je,E[1]=et,E[2]=Xe,E[3]=Fe,H.clearBufferuiv(H.COLOR,0,E)):(M[0]=Je,M[1]=et,M[2]=Xe,M[3]=Fe,H.clearBufferiv(H.COLOR,0,M))}else ae|=H.COLOR_BUFFER_BIT}q&&(ae|=H.DEPTH_BUFFER_BIT),se&&(ae|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(ae)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",de,!1),t.removeEventListener("webglcontextrestored",Le,!1),t.removeEventListener("webglcontextcreationerror",Pe,!1),qe.dispose(),Ue.dispose(),ut.dispose(),We.dispose(),P.dispose(),te.dispose(),he.dispose(),bt.dispose(),X.dispose(),He.dispose(),fe.dispose(),fe.removeEventListener("sessionstart",So),fe.removeEventListener("sessionend",Hr),pr.stop()};function de(L){L.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function Le(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const L=Lt.autoReset,q=ke.enabled,se=ke.autoUpdate,ae=ke.needsUpdate,G=ke.type;Ce(),Lt.autoReset=L,ke.enabled=q,ke.autoUpdate=se,ke.needsUpdate=ae,ke.type=G}function Pe(L){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",L.statusMessage)}function rt(L){const q=L.target;q.removeEventListener("dispose",rt),zt(q)}function zt(L){ln(L),We.remove(L)}function ln(L){const q=We.get(L).programs;q!==void 0&&(q.forEach(function(se){He.releaseProgram(se)}),L.isShaderMaterial&&He.releaseShaderCache(L))}this.renderBufferDirect=function(L,q,se,ae,G,Se){q===null&&(q=Dt);const be=G.isMesh&&G.matrixWorld.determinant()<0,Ne=tu(L,q,se,ae,G);je.setMaterial(ae,be);let Fe=se.index,Je=1;if(ae.wireframe===!0){if(Fe=_e.getWireframeAttribute(se),Fe===void 0)return;Je=2}const et=se.drawRange,Xe=se.attributes.position;let st=et.start*Je,At=(et.start+et.count)*Je;Se!==null&&(st=Math.max(st,Se.start*Je),At=Math.min(At,(Se.start+Se.count)*Je)),Fe!==null?(st=Math.max(st,0),At=Math.min(At,Fe.count)):Xe!=null&&(st=Math.max(st,0),At=Math.min(At,Xe.count));const Rt=At-st;if(Rt<0||Rt===1/0)return;bt.setup(G,ae,Ne,se,Fe);let Gt,yt=Be;if(Fe!==null&&(Gt=pe.get(Fe),yt=ft,yt.setIndex(Gt)),G.isMesh)ae.wireframe===!0?(je.setLineWidth(ae.wireframeLinewidth*Ot()),yt.setMode(H.LINES)):yt.setMode(H.TRIANGLES);else if(G.isLine){let Ye=ae.linewidth;Ye===void 0&&(Ye=1),je.setLineWidth(Ye*Ot()),G.isLineSegments?yt.setMode(H.LINES):G.isLineLoop?yt.setMode(H.LINE_LOOP):yt.setMode(H.LINE_STRIP)}else G.isPoints?yt.setMode(H.POINTS):G.isSprite&&yt.setMode(H.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)yt.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(dt.get("WEBGL_multi_draw"))yt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Ye=G._multiDrawStarts,Zt=G._multiDrawCounts,vt=G._multiDrawCount,Sn=Fe?pe.get(Fe).bytesPerElement:1,Di=We.get(ae).currentProgram.getUniforms();for(let Bn=0;Bn<vt;Bn++)Di.setValue(H,"_gl_DrawID",Bn),yt.render(Ye[Bn]/Sn,Zt[Bn])}else if(G.isInstancedMesh)yt.renderInstances(st,Rt,G.count);else if(se.isInstancedBufferGeometry){const Ye=se._maxInstanceCount!==void 0?se._maxInstanceCount:1/0,Zt=Math.min(se.instanceCount,Ye);yt.renderInstances(st,Rt,Zt)}else yt.render(st,Rt)};function Et(L,q,se){L.transparent===!0&&L.side===tr&&L.forceSinglePass===!1?(L.side=jn,L.needsUpdate=!0,Mo(L,q,se),L.side=or,L.needsUpdate=!0,Mo(L,q,se),L.side=tr):Mo(L,q,se)}this.compile=function(L,q,se=null){se===null&&(se=L),x=ut.get(se),x.init(q),R.push(x),se.traverseVisible(function(G){G.isLight&&G.layers.test(q.layers)&&(x.pushLight(G),G.castShadow&&x.pushShadow(G))}),L!==se&&L.traverseVisible(function(G){G.isLight&&G.layers.test(q.layers)&&(x.pushLight(G),G.castShadow&&x.pushShadow(G))}),x.setupLights();const ae=new Set;return L.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const Se=G.material;if(Se)if(Array.isArray(Se))for(let be=0;be<Se.length;be++){const Ne=Se[be];Et(Ne,se,G),ae.add(Ne)}else Et(Se,se,G),ae.add(Se)}),R.pop(),x=null,ae},this.compileAsync=function(L,q,se=null){const ae=this.compile(L,q,se);return new Promise(G=>{function Se(){if(ae.forEach(function(be){We.get(be).currentProgram.isReady()&&ae.delete(be)}),ae.size===0){G(L);return}setTimeout(Se,10)}dt.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let $n=null;function kn(L){$n&&$n(L)}function So(){pr.stop()}function Hr(){pr.start()}const pr=new Px;pr.setAnimationLoop(kn),typeof self<"u"&&pr.setContext(self),this.setAnimationLoop=function(L){$n=L,fe.setAnimationLoop(L),L===null?pr.stop():pr.start()},fe.addEventListener("sessionstart",So),fe.addEventListener("sessionend",Hr),this.render=function(L,q){if(q!==void 0&&q.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),fe.enabled===!0&&fe.isPresenting===!0&&(fe.cameraAutoUpdate===!0&&fe.updateCamera(q),q=fe.getCamera()),L.isScene===!0&&L.onBeforeRender(T,L,q,F),x=ut.get(L,R.length),x.init(q),R.push(x),Te.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),$.setFromProjectionMatrix(Te),xe=this.localClippingEnabled,ne=Me.init(this.clippingPlanes,xe),y=Ue.get(L,b.length),y.init(),b.push(y),fe.enabled===!0&&fe.isPresenting===!0){const Se=T.xr.getDepthSensingMesh();Se!==null&&mr(Se,q,-1/0,T.sortObjects)}mr(L,q,0,T.sortObjects),y.finish(),T.sortObjects===!0&&y.sort(ue,le),_t=fe.enabled===!1||fe.isPresenting===!1||fe.hasDepthSensing()===!1,_t&&qe.addToRenderList(y,L),this.info.render.frame++,ne===!0&&Me.beginShadows();const se=x.state.shadowsArray;ke.render(se,L,q),ne===!0&&Me.endShadows(),this.info.autoReset===!0&&this.info.reset();const ae=y.opaque,G=y.transmissive;if(x.setupLights(),q.isArrayCamera){const Se=q.cameras;if(G.length>0)for(let be=0,Ne=Se.length;be<Ne;be++){const Fe=Se[be];Ds(ae,G,L,Fe)}_t&&qe.render(L);for(let be=0,Ne=Se.length;be<Ne;be++){const Fe=Se[be];Is(y,L,Fe,Fe.viewport)}}else G.length>0&&Ds(ae,G,L,q),_t&&qe.render(L),Is(y,L,q);F!==null&&(U.updateMultisampleRenderTarget(F),U.updateRenderTargetMipmap(F)),L.isScene===!0&&L.onAfterRender(T,L,q),bt.resetDefaultState(),A=-1,C=null,R.pop(),R.length>0?(x=R[R.length-1],ne===!0&&Me.setGlobalState(T.clippingPlanes,x.state.camera)):x=null,b.pop(),b.length>0?y=b[b.length-1]:y=null};function mr(L,q,se,ae){if(L.visible===!1)return;if(L.layers.test(q.layers)){if(L.isGroup)se=L.renderOrder;else if(L.isLOD)L.autoUpdate===!0&&L.update(q);else if(L.isLight)x.pushLight(L),L.castShadow&&x.pushShadow(L);else if(L.isSprite){if(!L.frustumCulled||$.intersectsSprite(L)){ae&&Ze.setFromMatrixPosition(L.matrixWorld).applyMatrix4(Te);const be=he.update(L),Ne=L.material;Ne.visible&&y.push(L,be,Ne,se,Ze.z,null)}}else if((L.isMesh||L.isLine||L.isPoints)&&(!L.frustumCulled||$.intersectsObject(L))){const be=he.update(L),Ne=L.material;if(ae&&(L.boundingSphere!==void 0?(L.boundingSphere===null&&L.computeBoundingSphere(),Ze.copy(L.boundingSphere.center)):(be.boundingSphere===null&&be.computeBoundingSphere(),Ze.copy(be.boundingSphere.center)),Ze.applyMatrix4(L.matrixWorld).applyMatrix4(Te)),Array.isArray(Ne)){const Fe=be.groups;for(let Je=0,et=Fe.length;Je<et;Je++){const Xe=Fe[Je],st=Ne[Xe.materialIndex];st&&st.visible&&y.push(L,be,st,se,Ze.z,Xe)}}else Ne.visible&&y.push(L,be,Ne,se,Ze.z,null)}}const Se=L.children;for(let be=0,Ne=Se.length;be<Ne;be++)mr(Se[be],q,se,ae)}function Is(L,q,se,ae){const G=L.opaque,Se=L.transmissive,be=L.transparent;x.setupLightsView(se),ne===!0&&Me.setGlobalState(T.clippingPlanes,se),ae&&je.viewport(B.copy(ae)),G.length>0&&Gr(G,q,se),Se.length>0&&Gr(Se,q,se),be.length>0&&Gr(be,q,se),je.buffers.depth.setTest(!0),je.buffers.depth.setMask(!0),je.buffers.color.setMask(!0),je.setPolygonOffset(!1)}function Ds(L,q,se,ae){if((se.isScene===!0?se.overrideMaterial:null)!==null)return;x.state.transmissionRenderTarget[ae.id]===void 0&&(x.state.transmissionRenderTarget[ae.id]=new Cs(1,1,{generateMipmaps:!0,type:dt.has("EXT_color_buffer_half_float")||dt.has("EXT_color_buffer_float")?$l:kr,minFilter:Nr,samples:4,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:St.workingColorSpace}));const Se=x.state.transmissionRenderTarget[ae.id],be=ae.viewport||B;Se.setSize(be.z,be.w);const Ne=T.getRenderTarget();T.setRenderTarget(Se),T.getClearColor(ce),re=T.getClearAlpha(),re<1&&T.setClearColor(16777215,.5),T.clear(),_t&&qe.render(se);const Fe=T.toneMapping;T.toneMapping=ws;const Je=ae.viewport;if(ae.viewport!==void 0&&(ae.viewport=void 0),x.setupLightsView(ae),ne===!0&&Me.setGlobalState(T.clippingPlanes,ae),Gr(L,se,ae),U.updateMultisampleRenderTarget(Se),U.updateRenderTargetMipmap(Se),dt.has("WEBGL_multisampled_render_to_texture")===!1){let et=!1;for(let Xe=0,st=q.length;Xe<st;Xe++){const At=q[Xe],Rt=At.object,Gt=At.geometry,yt=At.material,Ye=At.group;if(yt.side===tr&&Rt.layers.test(ae.layers)){const Zt=yt.side;yt.side=jn,yt.needsUpdate=!0,Jl(Rt,se,ae,Gt,yt,Ye),yt.side=Zt,yt.needsUpdate=!0,et=!0}}et===!0&&(U.updateMultisampleRenderTarget(Se),U.updateRenderTargetMipmap(Se))}T.setRenderTarget(Ne),T.setClearColor(ce,re),Je!==void 0&&(ae.viewport=Je),T.toneMapping=Fe}function Gr(L,q,se){const ae=q.isScene===!0?q.overrideMaterial:null;for(let G=0,Se=L.length;G<Se;G++){const be=L[G],Ne=be.object,Fe=be.geometry,Je=ae===null?be.material:ae,et=be.group;Ne.layers.test(se.layers)&&Jl(Ne,q,se,Fe,Je,et)}}function Jl(L,q,se,ae,G,Se){L.onBeforeRender(T,q,se,ae,G,Se),L.modelViewMatrix.multiplyMatrices(se.matrixWorldInverse,L.matrixWorld),L.normalMatrix.getNormalMatrix(L.modelViewMatrix),G.onBeforeRender(T,q,se,ae,L,Se),G.transparent===!0&&G.side===tr&&G.forceSinglePass===!1?(G.side=jn,G.needsUpdate=!0,T.renderBufferDirect(se,q,ae,G,L,Se),G.side=or,G.needsUpdate=!0,T.renderBufferDirect(se,q,ae,G,L,Se),G.side=tr):T.renderBufferDirect(se,q,ae,G,L,Se),L.onAfterRender(T,q,se,ae,G,Se)}function Mo(L,q,se){q.isScene!==!0&&(q=Dt);const ae=We.get(L),G=x.state.lights,Se=x.state.shadowsArray,be=G.state.version,Ne=He.getParameters(L,G.state,Se,q,se),Fe=He.getProgramCacheKey(Ne);let Je=ae.programs;ae.environment=L.isMeshStandardMaterial?q.environment:null,ae.fog=q.fog,ae.envMap=(L.isMeshStandardMaterial?te:P).get(L.envMap||ae.environment),ae.envMapRotation=ae.environment!==null&&L.envMap===null?q.environmentRotation:L.envMapRotation,Je===void 0&&(L.addEventListener("dispose",rt),Je=new Map,ae.programs=Je);let et=Je.get(Fe);if(et!==void 0){if(ae.currentProgram===et&&ae.lightsStateVersion===be)return qi(L,Ne),et}else Ne.uniforms=He.getUniforms(L),L.onBeforeCompile(Ne,T),et=He.acquireProgram(Ne,Fe),Je.set(Fe,et),ae.uniforms=Ne.uniforms;const Xe=ae.uniforms;return(!L.isShaderMaterial&&!L.isRawShaderMaterial||L.clipping===!0)&&(Xe.clippingPlanes=Me.uniform),qi(L,Ne),ae.needsLights=mf(L),ae.lightsStateVersion=be,ae.needsLights&&(Xe.ambientLightColor.value=G.state.ambient,Xe.lightProbe.value=G.state.probe,Xe.directionalLights.value=G.state.directional,Xe.directionalLightShadows.value=G.state.directionalShadow,Xe.spotLights.value=G.state.spot,Xe.spotLightShadows.value=G.state.spotShadow,Xe.rectAreaLights.value=G.state.rectArea,Xe.ltc_1.value=G.state.rectAreaLTC1,Xe.ltc_2.value=G.state.rectAreaLTC2,Xe.pointLights.value=G.state.point,Xe.pointLightShadows.value=G.state.pointShadow,Xe.hemisphereLights.value=G.state.hemi,Xe.directionalShadowMap.value=G.state.directionalShadowMap,Xe.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Xe.spotShadowMap.value=G.state.spotShadowMap,Xe.spotLightMatrix.value=G.state.spotLightMatrix,Xe.spotLightMap.value=G.state.spotLightMap,Xe.pointShadowMap.value=G.state.pointShadowMap,Xe.pointShadowMatrix.value=G.state.pointShadowMatrix),ae.currentProgram=et,ae.uniformsList=null,et}function eu(L){if(L.uniformsList===null){const q=L.currentProgram.getUniforms();L.uniformsList=zc.seqWithValue(q.seq,L.uniforms)}return L.uniformsList}function qi(L,q){const se=We.get(L);se.outputColorSpace=q.outputColorSpace,se.batching=q.batching,se.batchingColor=q.batchingColor,se.instancing=q.instancing,se.instancingColor=q.instancingColor,se.instancingMorph=q.instancingMorph,se.skinning=q.skinning,se.morphTargets=q.morphTargets,se.morphNormals=q.morphNormals,se.morphColors=q.morphColors,se.morphTargetsCount=q.morphTargetsCount,se.numClippingPlanes=q.numClippingPlanes,se.numIntersection=q.numClipIntersection,se.vertexAlphas=q.vertexAlphas,se.vertexTangents=q.vertexTangents,se.toneMapping=q.toneMapping}function tu(L,q,se,ae,G){q.isScene!==!0&&(q=Dt),U.resetTextureUnits();const Se=q.fog,be=ae.isMeshStandardMaterial?q.environment:null,Ne=F===null?T.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Kn,Fe=(ae.isMeshStandardMaterial?te:P).get(ae.envMap||be),Je=ae.vertexColors===!0&&!!se.attributes.color&&se.attributes.color.itemSize===4,et=!!se.attributes.tangent&&(!!ae.normalMap||ae.anisotropy>0),Xe=!!se.morphAttributes.position,st=!!se.morphAttributes.normal,At=!!se.morphAttributes.color;let Rt=ws;ae.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(Rt=T.toneMapping);const Gt=se.morphAttributes.position||se.morphAttributes.normal||se.morphAttributes.color,yt=Gt!==void 0?Gt.length:0,Ye=We.get(ae),Zt=x.state.lights;if(ne===!0&&(xe===!0||L!==C)){const tn=L===C&&ae.id===A;Me.setState(ae,L,tn)}let vt=!1;ae.version===Ye.__version?(Ye.needsLights&&Ye.lightsStateVersion!==Zt.state.version||Ye.outputColorSpace!==Ne||G.isBatchedMesh&&Ye.batching===!1||!G.isBatchedMesh&&Ye.batching===!0||G.isBatchedMesh&&Ye.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Ye.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Ye.instancing===!1||!G.isInstancedMesh&&Ye.instancing===!0||G.isSkinnedMesh&&Ye.skinning===!1||!G.isSkinnedMesh&&Ye.skinning===!0||G.isInstancedMesh&&Ye.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ye.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Ye.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Ye.instancingMorph===!1&&G.morphTexture!==null||Ye.envMap!==Fe||ae.fog===!0&&Ye.fog!==Se||Ye.numClippingPlanes!==void 0&&(Ye.numClippingPlanes!==Me.numPlanes||Ye.numIntersection!==Me.numIntersection)||Ye.vertexAlphas!==Je||Ye.vertexTangents!==et||Ye.morphTargets!==Xe||Ye.morphNormals!==st||Ye.morphColors!==At||Ye.toneMapping!==Rt||Ye.morphTargetsCount!==yt)&&(vt=!0):(vt=!0,Ye.__version=ae.version);let Sn=Ye.currentProgram;vt===!0&&(Sn=Mo(ae,q,G));let Di=!1,Bn=!1,Ns=!1;const Nt=Sn.getUniforms(),zn=Ye.uniforms;if(je.useProgram(Sn.program)&&(Di=!0,Bn=!0,Ns=!0),ae.id!==A&&(A=ae.id,Bn=!0),Di||C!==L){je.buffers.depth.getReversed()?(me.copy(L.projectionMatrix),IE(me),DE(me),Nt.setValue(H,"projectionMatrix",me)):Nt.setValue(H,"projectionMatrix",L.projectionMatrix),Nt.setValue(H,"viewMatrix",L.matrixWorldInverse);const An=Nt.map.cameraPosition;An!==void 0&&An.setValue(H,Ie.setFromMatrixPosition(L.matrixWorld)),ct.logarithmicDepthBuffer&&Nt.setValue(H,"logDepthBufFC",2/(Math.log(L.far+1)/Math.LN2)),(ae.isMeshPhongMaterial||ae.isMeshToonMaterial||ae.isMeshLambertMaterial||ae.isMeshBasicMaterial||ae.isMeshStandardMaterial||ae.isShaderMaterial)&&Nt.setValue(H,"isOrthographic",L.isOrthographicCamera===!0),C!==L&&(C=L,Bn=!0,Ns=!0)}if(G.isSkinnedMesh){Nt.setOptional(H,G,"bindMatrix"),Nt.setOptional(H,G,"bindMatrixInverse");const tn=G.skeleton;tn&&(tn.boneTexture===null&&tn.computeBoneTexture(),Nt.setValue(H,"boneTexture",tn.boneTexture,U))}G.isBatchedMesh&&(Nt.setOptional(H,G,"batchingTexture"),Nt.setValue(H,"batchingTexture",G._matricesTexture,U),Nt.setOptional(H,G,"batchingIdTexture"),Nt.setValue(H,"batchingIdTexture",G._indirectTexture,U),Nt.setOptional(H,G,"batchingColorTexture"),G._colorsTexture!==null&&Nt.setValue(H,"batchingColorTexture",G._colorsTexture,U));const wn=se.morphAttributes;if((wn.position!==void 0||wn.normal!==void 0||wn.color!==void 0)&&Qe.update(G,se,Sn),(Bn||Ye.receiveShadow!==G.receiveShadow)&&(Ye.receiveShadow=G.receiveShadow,Nt.setValue(H,"receiveShadow",G.receiveShadow)),ae.isMeshGouraudMaterial&&ae.envMap!==null&&(zn.envMap.value=Fe,zn.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),ae.isMeshStandardMaterial&&ae.envMap===null&&q.environment!==null&&(zn.envMapIntensity.value=q.environmentIntensity),Bn&&(Nt.setValue(H,"toneMappingExposure",T.toneMappingExposure),Ye.needsLights&&nu(zn,Ns),Se&&ae.fog===!0&&Re.refreshFogUniforms(zn,Se),Re.refreshMaterialUniforms(zn,ae,z,oe,x.state.transmissionRenderTarget[L.id]),zc.upload(H,eu(Ye),zn,U)),ae.isShaderMaterial&&ae.uniformsNeedUpdate===!0&&(zc.upload(H,eu(Ye),zn,U),ae.uniformsNeedUpdate=!1),ae.isSpriteMaterial&&Nt.setValue(H,"center",G.center),Nt.setValue(H,"modelViewMatrix",G.modelViewMatrix),Nt.setValue(H,"normalMatrix",G.normalMatrix),Nt.setValue(H,"modelMatrix",G.matrixWorld),ae.isShaderMaterial||ae.isRawShaderMaterial){const tn=ae.uniformsGroups;for(let An=0,Us=tn.length;An<Us;An++){const pt=tn[An];X.update(pt,Sn),X.bind(pt,Sn)}}return Sn}function nu(L,q){L.ambientLightColor.needsUpdate=q,L.lightProbe.needsUpdate=q,L.directionalLights.needsUpdate=q,L.directionalLightShadows.needsUpdate=q,L.pointLights.needsUpdate=q,L.pointLightShadows.needsUpdate=q,L.spotLights.needsUpdate=q,L.spotLightShadows.needsUpdate=q,L.rectAreaLights.needsUpdate=q,L.hemisphereLights.needsUpdate=q}function mf(L){return L.isMeshLambertMaterial||L.isMeshToonMaterial||L.isMeshPhongMaterial||L.isMeshStandardMaterial||L.isShadowMaterial||L.isShaderMaterial&&L.lights===!0}this.getActiveCubeFace=function(){return N},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(L,q,se){We.get(L.texture).__webglTexture=q,We.get(L.depthTexture).__webglTexture=se;const ae=We.get(L);ae.__hasExternalTextures=!0,ae.__autoAllocateDepthBuffer=se===void 0,ae.__autoAllocateDepthBuffer||dt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ae.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(L,q){const se=We.get(L);se.__webglFramebuffer=q,se.__useDefaultFramebuffer=q===void 0},this.setRenderTarget=function(L,q=0,se=0){F=L,N=q,I=se;let ae=!0,G=null,Se=!1,be=!1;if(L){const Fe=We.get(L);if(Fe.__useDefaultFramebuffer!==void 0)je.bindFramebuffer(H.FRAMEBUFFER,null),ae=!1;else if(Fe.__webglFramebuffer===void 0)U.setupRenderTarget(L);else if(Fe.__hasExternalTextures)U.rebindTextures(L,We.get(L.texture).__webglTexture,We.get(L.depthTexture).__webglTexture);else if(L.depthBuffer){const Xe=L.depthTexture;if(Fe.__boundDepthTexture!==Xe){if(Xe!==null&&We.has(Xe)&&(L.width!==Xe.image.width||L.height!==Xe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");U.setupDepthRenderbuffer(L)}}const Je=L.texture;(Je.isData3DTexture||Je.isDataArrayTexture||Je.isCompressedArrayTexture)&&(be=!0);const et=We.get(L).__webglFramebuffer;L.isWebGLCubeRenderTarget?(Array.isArray(et[q])?G=et[q][se]:G=et[q],Se=!0):L.samples>0&&U.useMultisampledRTT(L)===!1?G=We.get(L).__webglMultisampledFramebuffer:Array.isArray(et)?G=et[se]:G=et,B.copy(L.viewport),Z.copy(L.scissor),K=L.scissorTest}else B.copy(k).multiplyScalar(z).floor(),Z.copy(Y).multiplyScalar(z).floor(),K=Ee;if(je.bindFramebuffer(H.FRAMEBUFFER,G)&&ae&&je.drawBuffers(L,G),je.viewport(B),je.scissor(Z),je.setScissorTest(K),Se){const Fe=We.get(L.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+q,Fe.__webglTexture,se)}else if(be){const Fe=We.get(L.texture),Je=q||0;H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,Fe.__webglTexture,se||0,Je)}A=-1},this.readRenderTargetPixels=function(L,q,se,ae,G,Se,be){if(!(L&&L.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ne=We.get(L).__webglFramebuffer;if(L.isWebGLCubeRenderTarget&&be!==void 0&&(Ne=Ne[be]),Ne){je.bindFramebuffer(H.FRAMEBUFFER,Ne);try{const Fe=L.texture,Je=Fe.format,et=Fe.type;if(!ct.textureFormatReadable(Je)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ct.textureTypeReadable(et)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=L.width-ae&&se>=0&&se<=L.height-G&&H.readPixels(q,se,ae,G,it.convert(Je),it.convert(et),Se)}finally{const Fe=F!==null?We.get(F).__webglFramebuffer:null;je.bindFramebuffer(H.FRAMEBUFFER,Fe)}}},this.readRenderTargetPixelsAsync=async function(L,q,se,ae,G,Se,be){if(!(L&&L.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ne=We.get(L).__webglFramebuffer;if(L.isWebGLCubeRenderTarget&&be!==void 0&&(Ne=Ne[be]),Ne){const Fe=L.texture,Je=Fe.format,et=Fe.type;if(!ct.textureFormatReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ct.textureTypeReadable(et))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(q>=0&&q<=L.width-ae&&se>=0&&se<=L.height-G){je.bindFramebuffer(H.FRAMEBUFFER,Ne);const Xe=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,Xe),H.bufferData(H.PIXEL_PACK_BUFFER,Se.byteLength,H.STREAM_READ),H.readPixels(q,se,ae,G,it.convert(Je),it.convert(et),0);const st=F!==null?We.get(F).__webglFramebuffer:null;je.bindFramebuffer(H.FRAMEBUFFER,st);const At=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await LE(H,At,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,Xe),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,Se),H.deleteBuffer(Xe),H.deleteSync(At),Se}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(L,q=null,se=0){L.isTexture!==!0&&(aa("WebGLRenderer: copyFramebufferToTexture function signature has changed."),q=arguments[0]||null,L=arguments[1]);const ae=Math.pow(2,-se),G=Math.floor(L.image.width*ae),Se=Math.floor(L.image.height*ae),be=q!==null?q.x:0,Ne=q!==null?q.y:0;U.setTexture2D(L,0),H.copyTexSubImage2D(H.TEXTURE_2D,se,0,0,be,Ne,G,Se),je.unbindTexture()};const iu=H.createFramebuffer(),ru=H.createFramebuffer();this.copyTextureToTexture=function(L,q,se=null,ae=null,G=0,Se=null){L.isTexture!==!0&&(aa("WebGLRenderer: copyTextureToTexture function signature has changed."),ae=arguments[0]||null,L=arguments[1],q=arguments[2],Se=arguments[3]||0,se=null),Se===null&&(G!==0?(aa("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Se=G,G=0):Se=0);let be,Ne,Fe,Je,et,Xe,st,At,Rt;const Gt=L.isCompressedTexture?L.mipmaps[Se]:L.image;if(se!==null)be=se.max.x-se.min.x,Ne=se.max.y-se.min.y,Fe=se.isBox3?se.max.z-se.min.z:1,Je=se.min.x,et=se.min.y,Xe=se.isBox3?se.min.z:0;else{const wn=Math.pow(2,-G);be=Math.floor(Gt.width*wn),Ne=Math.floor(Gt.height*wn),L.isDataArrayTexture?Fe=Gt.depth:L.isData3DTexture?Fe=Math.floor(Gt.depth*wn):Fe=1,Je=0,et=0,Xe=0}ae!==null?(st=ae.x,At=ae.y,Rt=ae.z):(st=0,At=0,Rt=0);const yt=it.convert(q.format),Ye=it.convert(q.type);let Zt;q.isData3DTexture?(U.setTexture3D(q,0),Zt=H.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(U.setTexture2DArray(q,0),Zt=H.TEXTURE_2D_ARRAY):(U.setTexture2D(q,0),Zt=H.TEXTURE_2D),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,q.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,q.unpackAlignment);const vt=H.getParameter(H.UNPACK_ROW_LENGTH),Sn=H.getParameter(H.UNPACK_IMAGE_HEIGHT),Di=H.getParameter(H.UNPACK_SKIP_PIXELS),Bn=H.getParameter(H.UNPACK_SKIP_ROWS),Ns=H.getParameter(H.UNPACK_SKIP_IMAGES);H.pixelStorei(H.UNPACK_ROW_LENGTH,Gt.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,Gt.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,Je),H.pixelStorei(H.UNPACK_SKIP_ROWS,et),H.pixelStorei(H.UNPACK_SKIP_IMAGES,Xe);const Nt=L.isDataArrayTexture||L.isData3DTexture,zn=q.isDataArrayTexture||q.isData3DTexture;if(L.isDepthTexture){const wn=We.get(L),tn=We.get(q),An=We.get(wn.__renderTarget),Us=We.get(tn.__renderTarget);je.bindFramebuffer(H.READ_FRAMEBUFFER,An.__webglFramebuffer),je.bindFramebuffer(H.DRAW_FRAMEBUFFER,Us.__webglFramebuffer);for(let pt=0;pt<Fe;pt++)Nt&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,We.get(L).__webglTexture,G,Xe+pt),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,We.get(q).__webglTexture,Se,Rt+pt)),H.blitFramebuffer(Je,et,be,Ne,st,At,be,Ne,H.DEPTH_BUFFER_BIT,H.NEAREST);je.bindFramebuffer(H.READ_FRAMEBUFFER,null),je.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(G!==0||L.isRenderTargetTexture||We.has(L)){const wn=We.get(L),tn=We.get(q);je.bindFramebuffer(H.READ_FRAMEBUFFER,iu),je.bindFramebuffer(H.DRAW_FRAMEBUFFER,ru);for(let An=0;An<Fe;An++)Nt?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,wn.__webglTexture,G,Xe+An):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,wn.__webglTexture,G),zn?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,tn.__webglTexture,Se,Rt+An):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,tn.__webglTexture,Se),G!==0?H.blitFramebuffer(Je,et,be,Ne,st,At,be,Ne,H.COLOR_BUFFER_BIT,H.NEAREST):zn?H.copyTexSubImage3D(Zt,Se,st,At,Rt+An,Je,et,be,Ne):H.copyTexSubImage2D(Zt,Se,st,At,Je,et,be,Ne);je.bindFramebuffer(H.READ_FRAMEBUFFER,null),je.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else zn?L.isDataTexture||L.isData3DTexture?H.texSubImage3D(Zt,Se,st,At,Rt,be,Ne,Fe,yt,Ye,Gt.data):q.isCompressedArrayTexture?H.compressedTexSubImage3D(Zt,Se,st,At,Rt,be,Ne,Fe,yt,Gt.data):H.texSubImage3D(Zt,Se,st,At,Rt,be,Ne,Fe,yt,Ye,Gt):L.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,Se,st,At,be,Ne,yt,Ye,Gt.data):L.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,Se,st,At,Gt.width,Gt.height,yt,Gt.data):H.texSubImage2D(H.TEXTURE_2D,Se,st,At,be,Ne,yt,Ye,Gt);H.pixelStorei(H.UNPACK_ROW_LENGTH,vt),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,Sn),H.pixelStorei(H.UNPACK_SKIP_PIXELS,Di),H.pixelStorei(H.UNPACK_SKIP_ROWS,Bn),H.pixelStorei(H.UNPACK_SKIP_IMAGES,Ns),Se===0&&q.generateMipmaps&&H.generateMipmap(Zt),je.unbindTexture()},this.copyTextureToTexture3D=function(L,q,se=null,ae=null,G=0){return L.isTexture!==!0&&(aa("WebGLRenderer: copyTextureToTexture3D function signature has changed."),se=arguments[0]||null,ae=arguments[1]||null,L=arguments[2],q=arguments[3],G=arguments[4]||0),aa('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(L,q,se,ae,G)},this.initRenderTarget=function(L){We.get(L).__webglFramebuffer===void 0&&U.setupRenderTarget(L)},this.initTexture=function(L){L.isCubeTexture?U.setTextureCube(L,0):L.isData3DTexture?U.setTexture3D(L,0):L.isDataArrayTexture||L.isCompressedArrayTexture?U.setTexture2DArray(L,0):U.setTexture2D(L,0),je.unbindTexture()},this.resetState=function(){N=0,I=0,F=null,je.reset(),bt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ur}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=St._getDrawingBufferColorSpace(e),t.unpackColorSpace=St._getUnpackColorSpace()}}class ff extends vn{constructor(){const e=ff.SkyShader,t=new lr({name:e.name,uniforms:Kc.clone(e.uniforms),vertexShader:e.vertexShader,fragmentShader:e.fragmentShader,side:jn,depthWrite:!1});super(new Fa(1,1,1),t),this.isSky=!0}}ff.SkyShader={name:"SkyShader",uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new j},up:{value:new j(0,1,0)}},vertexShader:`
...
*/var kv,Ms,va,Cm,uo,Bv,bm,nP=function(){return typeof window<"u"},zr={},ro=180/Math.PI,xa=Math.PI/180,oa=Math.atan2,zv=1e8,Pm=/([A-Z])/g,iP=/(left|right|width|margin|padding|x)/i,rP=/[\s,\(]\S/,ir={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Xp=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},sP=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},oP=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},aP=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},wy=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Ay=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},lP=function(e,t,n){return e.style[t]=n},uP=function(e,t,n){return e.style.setProperty(t,n)},cP=function(e,t,n){return e._gsap[t]=n},fP=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},hP=function(e,t,n,i,o){var l=e._gsap;l.scaleX=l.scaleY=n,l.renderTransform(o,l)},dP=function(e,t,n,i,o){var l=e._gsap;l[t]=n,l.renderTransform(o,l)},Kt="transform",oi=Kt+"Origin",pP=function a(e,t){var n=this,i=this.target,o=i.style,l=i._gsap;if(e in zr&&o){if(this.tfm=this.tfm||{},e!=="transform")e=ir[e]||e,~e.indexOf(",")?e.split(",").forEach(function(u){return n.tfm[u]=Dr(i,u)}):this.tfm[e]=l.x?l[e]:Dr(i,e),e===oi&&(this.tfm.zOrigin=l.zOrigin);else return ir.transform.split(",").forEach(function(u){return a.call(n,u,t)});if(this.props.indexOf(Kt)>=0)return;l.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(oi,t,"")),e=Kt}(o||t)&&this.props.push(e,t,o[e])},Ry=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},mP=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,o,l;for(o=0;o<e.length;o+=3)e[o+1]?t[e[o]]=e[o+2]:e[o+2]?n[e[o]]=e[o+2]:n.removeProperty(e[o].substr(0,2)==="--"?e[o]:e[o].replace(Pm,"-$1").toLowerCase());if(this.tfm){for(l in this.tfm)i[l]=this.tfm[l];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),o=bm(),(!o||!o.isStart)&&!n[Kt]&&(Ry(n),i.zOrigin&&n[oi]&&(n[oi]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Cy=function(e,t){var n={target:e,props:[],revert:mP,save:pP};return e._gsap||ai.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},by,jp=function(e,t){var n=Ms.createElementNS?Ms.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Ms.createElement(e);return n&&n.style?n:Ms.createElement(e)},sr=function a(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Pm,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&a(e,Ua(t)||t,1)||""},Vv="O,Moz,ms,Ms,Webkit".split(","),Ua=function(e,t,n){var i=t||uo,o=i.style,l=5;if(e in o&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);l--&&!(Vv[l]+e in o););return l<0?null:(l===3?"ms":l>=0?Vv[l]:"")+e},Yp=function(){nP()&&window.document&&(kv=window,Ms=kv.document,va=Ms.documentElement,uo=jp("div")||{style:{}},jp("div"),Kt=Ua(Kt),oi=Kt+"Origin",uo.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",by=!!Ua("perspective"),bm=ai.core.reverting,Cm=1)},zd=function a(e){var t=jp("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,o=this.style.cssText,l;if(va.appendChild(t),t.appendChild(this),this.style.display="block",e)try{l=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=a}catch{}else this._gsapBBox&&(l=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),va.removeChild(t),this.style.cssText=o,l},Hv=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Py=function(e){var t;try{t=e.getBBox()}catch{t=zd.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===zd||(t=zd.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Hv(e,["x","cx","x1"])||0,y:+Hv(e,["y","cy","y1"])||0,width:0,height:0}:t},Ly=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Py(e))},vo=function(e,t){if(t){var n=e.style,i;t in zr&&t!==oi&&(t=Kt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(Pm,"-$1").toLowerCase())):n.removeAttribute(t)}},Es=function(e,t,n,i,o,l){var u=new si(e._pt,t,n,0,1,l?Ay:wy);return e._pt=u,u.b=i,u.e=o,e._props.push(n),u},Gv={deg:1,rad:1,turn:1},gP={grid:1,flex:1},Ps=function a(e,t,n,i){var o=parseFloat(n)||0,l=(n+"").trim().substr((o+"").length)||"px",u=uo.style,f=iP.test(t),h=e.tagName.toLowerCase()==="svg",p=(h?"client":"offset")+(f?"Width":"Height"),m=100,g=i==="px",v=i==="%",E,M,y,x;if(i===l||!o||Gv[i]||Gv[l])return o;if(l!=="px"&&!g&&(o=a(e,t,n,"px")),x=e.getCTM&&Ly(e),(v||l==="%")&&(zr[t]||~t.indexOf("adius")))return E=x?e.getBBox()[f?"width":"height"]:e[p],rn(v?o/E*m:o/100*E);if(u[f?"width":"height"]=m+(g?l:i),M=~t.indexOf("adius")||i==="em"&&e.appendChild&&!h?e:e.parentNode,x&&(M=(e.ownerSVGElement||{}).parentNode),(!M||M===Ms||!M.appendChild)&&(M=Ms.body),y=M._gsap,y&&v&&y.width&&f&&y.time===mi.time&&!y.uncache)return rn(o/y.width*m);if(v&&(t==="height"||t==="width")){var b=e.style[t];e.style[t]=m+i,E=e[p],b?e.style[t]=b:vo(e,t)}else(v||l==="%")&&!gP[sr(M,"display")]&&(u.position=sr(e,"position")),M===e&&(u.position="static"),M.appendChild(uo),E=uo[p],M.removeChild(uo),u.position="absolute";return f&&v&&(y=co(M),y.time=mi.time,y.width=M[p]),rn(g?E*o/m:E&&o?m/E*o:0)},Dr=function(e,t,n,i){var o;return Cm||Yp(),t in ir&&t!=="transform"&&(t=ir[t],~t.indexOf(",")&&(t=t.split(",")[0])),zr[t]&&t!=="transform"?(o=Kl(e,i),o=t!=="transformOrigin"?o[t]:o.svg?o.origin:sf(sr(e,oi))+" "+o.zOrigin+"px"):(o=e.style[t],(!o||o==="auto"||i||~(o+"").indexOf("calc("))&&(o=rf[t]&&rf[t](e,t,n)||sr(e,t)||Yx(e,t)||(t==="opacity"?1:0))),n&&!~(o+"").trim().indexOf(" ")?Ps(e,t,o,n)+n:o},_P=function(e,t,n,i){if(!n||n==="none"){var o=Ua(t,e,1),l=o&&sr(e,o,1);l&&l!==n?(t=o,n=l):t==="borderColor"&&(n=sr(e,"borderTopColor"))}var u=new si(this._pt,e.style,t,0,1,My),f=0,h=0,p,m,g,v,E,M,y,x,b,R,T,D;if(u.b=n,u.e=i,n+="",i+="",i==="auto"&&(M=e.style[t],e.style[t]=i,i=sr(e,t)||i,M?e.style[t]=M:vo(e,t)),p=[n,i],hy(p),n=p[0],i=p[1],g=n.match(fa)||[],D=i.match(fa)||[],D.length){for(;m=fa.exec(i);)y=m[0],b=i.substring(f,m.index),E?E=(E+1)%5:(b.substr(-5)==="rgba("||b.substr(-5)==="hsla(")&&(E=1),y!==(M=g[h++]||"")&&(v=parseFloat(M)||0,T=M.substr((v+"").length),y.charAt(1)==="="&&(y=_a(v,y)+T),x=parseFloat(y),R=y.substr((x+"").length),f=fa.lastIndex-R.length,R||(R=R||vi.units[t]||T,f===i.length&&(i+=R,u.e+=R)),T!==R&&(v=Ps(e,t,M,R)||0),u._pt={_next:u._pt,p:b||h===1?b:",",s:v,c:x-v,m:E&&E<4||t==="zIndex"?Math.round:0});u.c=f<i.length?i.substring(f,i.length):""}else u.r=t==="display"&&i==="none"?Ay:wy;return Vx.test(i)&&(u.e=0),this._pt=u,u},Wv={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},vP=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Wv[n]||n,t[1]=Wv[i]||i,t.join(" ")},xP=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,o=t.u,l=n._gsap,u,f,h;if(o==="all"||o===!0)i.cssText="",f=1;else for(o=o.split(","),h=o.length;--h>-1;)u=o[h],zr[u]&&(f=1,u=u==="transformOrigin"?oi:Kt),vo(n,u);f&&(vo(n,Kt),l&&(l.svg&&n.removeAttribute("transform"),Kl(n,1),l.uncache=1,Ry(i)))}},rf={clearProps:function(e,t,n,i,o){if(o.data!=="isFromStart"){var l=e._pt=new si(e._pt,t,n,0,0,xP);return l.u=i,l.pr=-10,l.tween=o,e._props.push(n),1}}},ql=[1,0,0,1,0,0],Iy={},Dy=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Xv=function(e){var t=sr(e,Kt);return Dy(t)?ql:t.substr(7).match(zx).map(rn)},Lm=function(e,t){var n=e._gsap||co(e),i=e.style,o=Xv(e),l,u,f,h;return n.svg&&e.getAttribute("transform")?(f=e.transform.baseVal.consolidate().matrix,o=[f.a,f.b,f.c,f.d,f.e,f.f],o.join(",")==="1,0,0,1,0,0"?ql:o):(o===ql&&!e.offsetParent&&e!==va&&!n.svg&&(f=i.display,i.display="block",l=e.parentNode,(!l||!e.offsetParent)&&(h=1,u=e.nextElementSibling,va.appendChild(e)),o=Xv(e),f?i.display=f:vo(e,"display"),h&&(u?l.insertBefore(e,u):l?l.appendChild(e):va.removeChild(e))),t&&o.length>6?[o[0],o[1],o[4],o[5],o[12],o[13]]:o)},qp=function(e,t,n,i,o,l){var u=e._gsap,f=o||Lm(e,!0),h=u.xOrigin||0,p=u.yOrigin||0,m=u.xOffset||0,g=u.yOffset||0,v=f[0],E=f[1],M=f[2],y=f[3],x=f[4],b=f[5],R=t.split(" "),T=parseFloat(R[0])||0,D=parseFloat(R[1])||0,N,I,F,A;n?f!==ql&&(I=v*y-E*M)&&(F=T*(y/I)+D*(-M/I)+(M*b-y*x)/I,A=T*(-E/I)+D*(v/I)-(v*b-E*x)/I,T=F,D=A):(N=Py(e),T=N.x+(~R[0].indexOf("%")?T/100*N.width:T),D=N.y+(~(R[1]||R[0]).indexOf("%")?D/100*N.height:D)),i||i!==!1&&u.smooth?(x=T-h,b=D-p,u.xOffset=m+(x*v+b*M)-x,u.yOffset=g+(x*E+b*y)-b):u.xOffset=u.yOffset=0,u.xOrigin=T,u.yOrigin=D,u.smooth=!!i,u.origin=t,u.originIsAbsolute=!!n,e.style[oi]="0px 0px",l&&(Es(l,u,"xOrigin",h,T),Es(l,u,"yOrigin",p,D),Es(l,u,"xOffset",m,u.xOffset),Es(l,u,"yOffset",g,u.yOffset)),e.setAttribute("data-svg-origin",T+" "+D)},Kl=function(e,t){var n=e._gsap||new gy(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,o=n.scaleX<0,l="px",u="deg",f=getComputedStyle(e),h=sr(e,oi)||"0",p,m,g,v,E,M,y,x,b,R,T,D,N,I,F,A,C,B,Z,K,ce,re,J,oe,z,ue,le,k,Y,Ee,$,ne;return p=m=g=M=y=x=b=R=T=0,v=E=1,n.svg=!!(e.getCTM&&Ly(e)),f.translate&&((f.translate!=="none"||f.scale!=="none"||f.rotate!=="none")&&(i[Kt]=(f.translate!=="none"?"translate3d("+(f.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(f.rotate!=="none"?"rotate("+f.rotate+") ":"")+(f.scale!=="none"?"scale("+f.scale.split(" ").join(",")+") ":"")+(f[Kt]!=="none"?f[Kt]:"")),i.scale=i.rotate=i.translate="none"),I=Lm(e,n.svg),n.svg&&(n.uncache?(z=e.getBBox(),h=n.xOrigin-z.x+"px "+(n.yOrigin-z.y)+"px",oe=""):oe=!t&&e.getAttribute("data-svg-origin"),qp(e,oe||h,!!oe||n.originIsAbsolute,n.smooth!==!1,I)),D=n.xOrigin||0,N=n.yOrigin||0,I!==ql&&(B=I[0],Z=I[1],K=I[2],ce=I[3],p=re=I[4],m=J=I[5],I.length===6?(v=Math.sqrt(B*B+Z*Z),E=Math.sqrt(ce*ce+K*K),M=B||Z?oa(Z,B)*ro:0,b=K||ce?oa(K,ce)*ro+M:0,b&&(E*=Math.abs(Math.cos(b*xa))),n.svg&&(p-=D-(D*B+N*K),m-=N-(D*Z+N*ce))):(ne=I[6],Ee=I[7],le=I[8],k=I[9],Y=I[10],$=I[11],p=I[12],m=I[13],g=I[14],F=oa(ne,Y),y=F*ro,F&&(A=Math.cos(-F),C=Math.sin(-F),oe=re*A+le*C,z=J*A+k*C,ue=ne*A+Y*C,le=re*-C+le*A,k=J*-C+k*A,Y=ne*-C+Y*A,$=Ee*-C+$*A,re=oe,J=z,ne=ue),F=oa(-K,Y),x=F*ro,F&&(A=Math.cos(-F),C=Math.sin(-F),oe=B*A-le*C,z=Z*A-k*C,ue=K*A-Y*C,$=ce*C+$*A,B=oe,Z=z,K=ue),F=oa(Z,B),M=F*ro,F&&(A=Math.cos(F),C=Math.sin(F),oe=B*A+Z*C,z=re*A+J*C,Z=Z*A-B*C,J=J*A-re*C,B=oe,re=z),y&&Math.abs(y)+Math.abs(M)>359.9&&(y=M=0,x=180-x),v=rn(Math.sqrt(B*B+Z*Z+K*K)),E=rn(Math.sqrt(J*J+ne*ne)),F=oa(re,J),b=Math.abs(F)>2e-4?F*ro:0,T=$?1/($<0?-$:$):0),n.svg&&(oe=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Dy(sr(e,Kt)),oe&&e.setAttribute("transform",oe))),Math.abs(b)>90&&Math.abs(b)<270&&(o?(v*=-1,b+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,b+=b<=0?180:-180)),t=t||n.uncache,n.x=p-((n.xPercent=p&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-p)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+l,n.y=m-((n.yPercent=m&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-m)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+l,n.z=g+l,n.scaleX=rn(v),n.scaleY=rn(E),n.rotation=rn(M)+u,n.rotationX=rn(y)+u,n.rotationY=rn(x)+u,n.skewX=b+u,n.skewY=R+u,n.transformPerspective=T+l,(n.zOrigin=parseFloat(h.split(" ")[2])||!t&&n.zOrigin||0)&&(i[oi]=sf(h)),n.xOffset=n.yOffset=0,n.force3D=vi.force3D,n.renderTransform=n.svg?SP:by?Ny:yP,n.uncache=0,n},sf=function(e){return(e=e.split(" "))[0]+" "+e[1]},Vd=function(e,t,n){var i=Nn(t);return rn(parseFloat(t)+parseFloat(Ps(e,"x",n+"px",i)))+i},yP=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Ny(e,t)},to="0deg",Cl="0px",no=") ",Ny=function(e,t){var n=t||this,i=n.xPercent,o=n.yPercent,l=n.x,u=n.y,f=n.z,h=n.rotation,p=n.rotationY,m=n.rotationX,g=n.skewX,v=n.skewY,E=n.scaleX,M=n.scaleY,y=n.transformPerspective,x=n.force3D,b=n.target,R=n.zOrigin,T="",D=x==="auto"&&e&&e!==1||x===!0;if(R&&(m!==to||p!==to)){var N=parseFloat(p)*xa,I=Math.sin(N),F=Math.cos(N),A;N=parseFloat(m)*xa,A=Math.cos(N),l=Vd(b,l,I*A*-R),u=Vd(b,u,-Math.sin(N)*-R),f=Vd(b,f,F*A*-R+R)}y!==Cl&&(T+="perspective("+y+no),(i||o)&&(T+="translate("+i+"%, "+o+"%) "),(D||l!==Cl||u!==Cl||f!==Cl)&&(T+=f!==Cl||D?"translate3d("+l+", "+u+", "+f+") ":"translate("+l+", "+u+no),h!==to&&(T+="rotate("+h+no),p!==to&&(T+="rotateY("+p+no),m!==to&&(T+="rotateX("+m+no),(g!==to||v!==to)&&(T+="skew("+g+", "+v+no),(E!==1||M!==1)&&(T+="scale("+E+", "+M+no),b.style[Kt]=T||"translate(0, 0)"},SP=function(e,t){var n=t||this,i=n.xPercent,o=n.yPercent,l=n.x,u=n.y,f=n.rotation,h=n.skewX,p=n.skewY,m=n.scaleX,g=n.scaleY,v=n.target,E=n.xOrigin,M=n.yOrigin,y=n.xOffset,x=n.yOffset,b=n.forceCSS,R=parseFloat(l),T=parseFloat(u),D,N,I,F,A;f=parseFloat(f),h=parseFloat(h),p=parseFloat(p),p&&(p=parseFloat(p),h+=p,f+=p),f||h?(f*=xa,h*=xa,D=Math.cos(f)*m,N=Math.sin(f)*m,I=Math.sin(f-h)*-g,F=Math.cos(f-h)*g,h&&(p*=xa,A=Math.tan(h-p),A=Math.sqrt(1+A*A),I*=A,F*=A,p&&(A=Math.tan(p),A=Math.sqrt(1+A*A),D*=A,N*=A)),D=rn(D),N=rn(N),I=rn(I),F=rn(F)):(D=m,F=g,N=I=0),(R&&!~(l+"").indexOf("px")||T&&!~(u+"").indexOf("px"))&&(R=Ps(v,"x",l,"px"),T=Ps(v,"y",u,"px")),(E||M||y||x)&&(R=rn(R+E-(E*D+M*I)+y),T=rn(T+M-(E*N+M*F)+x)),(i||o)&&(A=v.getBBox(),R=rn(R+i/100*A.width),T=rn(T+o/100*A.height)),A="matrix("+D+","+N+","+I+","+F+","+R+","+T+")",v.setAttribute("transform",A),b&&(v.style[Kt]=A)},MP=function(e,t,n,i,o){var l=360,u=yn(o),f=parseFloat(o)*(u&&~o.indexOf("rad")?ro:1),h=f-i,p=i+h+"deg",m,g;return u&&(m=o.split("_")[1],m==="short"&&(h%=l,h!==h%(l/2)&&(h+=h<0?l:-l)),m==="cw"&&h<0?h=(h+l*zv)%l-~~(h/l)*l:m==="ccw"&&h>0&&(h=(h-l*zv)%l-~~(h/l)*l)),e._pt=g=new si(e._pt,t,n,i,h,sP),g.e=p,g.u="deg",e._props.push(n),g},jv=function(e,t){for(var n in t)e[n]=t[n];return e},EP=function(e,t,n){var i=jv({},n._gsap),o="perspective,force3D,transformOrigin,svgOrigin",l=n.style,u,f,h,p,m,g,v,E;i.svg?(h=n.getAttribute("transform"),n.setAttribute("transform",""),l[Kt]=t,u=Kl(n,1),vo(n,Kt),n.setAttribute("transform",h)):(h=getComputedStyle(n)[Kt],l[Kt]=t,u=Kl(n,1),l[Kt]=h);for(f in zr)h=i[f],p=u[f],h!==p&&o.indexOf(f)<0&&(v=Nn(h),E=Nn(p),m=v!==E?Ps(n,f,h,E):parseFloat(h),g=parseFloat(p),e._pt=new si(e._pt,u,f,m,g-m,Xp),e._pt.u=E||0,e._props.push(f));jv(u,i)};ri("padding,margin,Width,Radius",function(a,e){var t="Top",n="Right",i="Bottom",o="Left",l=(e<3?[t,n,i,o]:[t+o,t+n,i+n,i+o]).map(function(u){return e<2?a+u:"border"+u+a});rf[e>1?"border"+a:a]=function(u,f,h,p,m){var g,v;if(arguments.length<4)return g=l.map(function(E){return Dr(u,E,h)}),v=g.join(" "),v.split(g[0]).length===5?g[0]:v;g=(p+"").split(" "),v={},l.forEach(function(E,M){return v[E]=g[M]=g[M]||g[(M-1)/2|0]}),u.init(f,v,m)}});var Uy={name:"css",register:Yp,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,o){var l=this._props,u=e.style,f=n.vars.startAt,h,p,m,g,v,E,M,y,x,b,R,T,D,N,I,F;Cm||Yp(),this.styles=this.styles||Cy(e),F=this.styles.props,this.tween=n;for(M in t)if(M!=="autoRound"&&(p=t[M],!(pi[M]&&_y(M,t,n,i,e,o)))){if(v=typeof p,E=rf[M],v==="function"&&(p=p.call(n,i,e,o),v=typeof p),v==="string"&&~p.indexOf("random(")&&(p=Xl(p)),E)E(this,e,M,p,n)&&(I=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(e).getPropertyValue(M)+"").trim(),p+="",Rs.lastIndex=0,Rs.test(h)||(y=Nn(h),x=Nn(p)),x?y!==x&&(h=Ps(e,M,h,x)+x):y&&(p+=y),this.add(u,"setProperty",h,p,i,o,0,0,M),l.push(M),F.push(M,0,u[M]);else if(v!=="undefined"){if(f&&M in f?(h=typeof f[M]=="function"?f[M].call(n,i,e,o):f[M],yn(h)&&~h.indexOf("random(")&&(h=Xl(h)),Nn(h+"")||h==="auto"||(h+=vi.units[M]||Nn(Dr(e,M))||""),(h+"").charAt(1)==="="&&(h=Dr(e,M))):h=Dr(e,M),g=parseFloat(h),b=v==="string"&&p.charAt(1)==="="&&p.substr(0,2),b&&(p=p.substr(2)),m=parseFloat(p),M in ir&&(M==="autoAlpha"&&(g===1&&Dr(e,"visibility")==="hidden"&&m&&(g=0),F.push("visibility",0,u.visibility),Es(this,u,"visibility",g?"inherit":"hidden",m?"inherit":"hidden",!m)),M!=="scale"&&M!=="transform"&&(M=ir[M],~M.indexOf(",")&&(M=M.split(",")[0]))),R=M in zr,R){if(this.styles.save(M),T||(D=e._gsap,D.renderTransform&&!t.parseTransform||Kl(e,t.parseTransform),N=t.smoothOrigin!==!1&&D.smooth,T=this._pt=new si(this._pt,u,Kt,0,1,D.renderTransform,D,0,-1),T.dep=1),M==="scale")this._pt=new si(this._pt,D,"scaleY",D.scaleY,(b?_a(D.scaleY,b+m):m)-D.scaleY||0,Xp),this._pt.u=0,l.push("scaleY",M),M+="X";else if(M==="transformOrigin"){F.push(oi,0,u[oi]),p=vP(p),D.svg?qp(e,p,0,N,0,this):(x=parseFloat(p.split(" ")[2])||0,x!==D.zOrigin&&Es(this,D,"zOrigin",D.zOrigin,x),Es(this,u,M,sf(h),sf(p)));continue}else if(M==="svgOrigin"){qp(e,p,1,N,0,this);continue}else if(M in Iy){MP(this,D,M,g,b?_a(g,b+p):p);continue}else if(M==="smoothOrigin"){Es(this,D,"smooth",D.smooth,p);continue}else if(M==="force3D"){D[M]=p;continue}else if(M==="transform"){EP(this,p,e);continue}}else M in u||(M=Ua(M)||M);if(R||(m||m===0)&&(g||g===0)&&!rP.test(p)&&M in u)y=(h+"").substr((g+"").length),m||(m=0),x=Nn(p)||(M in vi.units?vi.units[M]:y),y!==x&&(g=Ps(e,M,h,x)),this._pt=new si(this._pt,R?D:u,M,g,(b?_a(g,b+m):m)-g,!R&&(x==="px"||M==="zIndex")&&t.autoRound!==!1?aP:Xp),this._pt.u=x||0,y!==x&&x!=="%"&&(this._pt.b=h,this._pt.r=oP);else if(M in u)_P.call(this,e,M,h,b?b+p:p);else if(M in e)this.add(e,M,h||e[M],b?b+p:p,i,o);else if(M!=="parseTransform"){xm(M,p);continue}R||(M in u?F.push(M,0,u[M]):F.push(M,1,h||e[M])),l.push(M)}}I&&Ey(this)},render:function(e,t){if(t.tween._time||!bm())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Dr,aliases:ir,getSetter:function(e,t,n){var i=ir[t];return i&&i.indexOf(",")<0&&(t=i),t in zr&&t!==oi&&(e._gsap.x||Dr(e,"x"))?n&&Bv===n?t==="scale"?fP:cP:(Bv=n||{})&&(t==="scale"?hP:dP):e.style&&!gm(e.style[t])?lP:~t.indexOf("-")?uP:Am(e,t)},core:{_removeProperty:vo,_getMatrix:Lm}};ai.utils.checkPrefix=Ua;ai.core.getStyleSaver=Cy;(function(a,e,t,n){var i=ri(a+","+e+","+t,function(o){zr[o]=1});ri(e,function(o){vi.units[o]="deg",Iy[o]=1}),ir[i[13]]=a+","+e,ri(n,function(o){var l=o.split(":");ir[l[1]]=i[l[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ri("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(a){vi.units[a]="px"});ai.registerPlugin(Uy);var Wc=ai.registerPlugin(Uy)||ai;Wc.core.Tween;class TP extends vn{constructor(e,t={}){super(e),this.isWater=!0;const n=this,i=t.textureWidth!==void 0?t.textureWidth:512,o=t.textureHeight!==void 0?t.textureHeight:512,l=t.clipBias!==void 0?t.clipBias:0,u=t.alpha!==void 0?t.alpha:1,f=t.time!==void 0?t.time:0,h=t.waterNormals!==void 0?t.waterNormals:null,p=t.sunDirection!==void 0?t.sunDirection:new j(.70707,.70707,0),m=new nt(t.sunColor!==void 0?t.sunColor:16777215),g=new nt(t.waterColor!==void 0?t.waterColor:8355711),v=t.eye!==void 0?t.eye:new j(0,0,0),E=t.distortionScale!==void 0?t.distortionScale:20,M=t.side!==void 0?t.side:or,y=t.fog!==void 0?t.fog:!1,x=new _s,b=new j,R=new j,T=new j,D=new ot,N=new j(0,0,-1),I=new wt,F=new j,A=new j,C=new wt,B=new ot,Z=new Dn,K=new Cs(i,o),ce={name:"MirrorShader",uniforms:Kc.merge([Ae.fog,Ae.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new ot},sunColor:{value:new nt(8355711)},sunDirection:{value:new j(.70707,.70707,0)},eye:{value:new j},waterColor:{value:new nt(5592405)}}]),vertexShader:`
				...
				void main() {
					...
					#include <colorspace_fragment>
					#include <fog_fragment>	
				}`},re=new lr({name:ce.name,uniforms:Kc.clone(ce.uniforms),vertexShader:ce.vertexShader,fragmentShader:ce.fragmentShader,lights:!0,side:M,fog:y});re.uniforms.mirrorSampler.value=K.texture,re.uniforms.textureMatrix.value=B,re.uniforms.alpha.value=u,re.uniforms.time.value=f,re.uniforms.normalSampler.value=h,re.uniforms.sunColor.value=m,re.uniforms.waterColor.value=g,re.uniforms.sunDirection.value=p,re.uniforms.distortionScale.value=E,re.uniforms.eye.value=v,n.material=re,n.onBeforeRender=function(J,oe,z){if(R.setFromMatrixPosition(n.matrixWorld),T.setFromMatrixPosition(z.matrixWorld),D.extractRotation(n.matrixWorld),b.set(0,0,1),b.applyMatrix4(D),F.subVectors(R,T),F.dot(b)>0)return;F.reflect(b).negate(),F.add(R),D.extractRotation(z.matrixWorld),N.set(0,0,-1),N.applyMatrix4(D),N.add(T),A.subVectors(R,N),A.reflect(b).negate(),A.add(R),Z.position.copy(F),Z.up.set(0,1,0),Z.up.applyMatrix4(D),Z.up.reflect(b),Z.lookAt(A),Z.far=z.far,Z.updateMatrixWorld(),Z.projectionMatrix.copy(z.projectionMatrix),B.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),B.multiply(Z.projectionMatrix),B.multiply(Z.matrixWorldInverse),x.setFromNormalAndCoplanarPoint(b,R),x.applyMatrix4(Z.matrixWorldInverse),I.set(x.normal.x,x.normal.y,x.normal.z,x.constant);const ue=Z.projectionMatrix;C.x=(Math.sign(I.x)+ue.elements[8])/ue.elements[0],C.y=(Math.sign(I.y)+ue.elements[9])/ue.elements[5],C.z=-1,C.w=(1+ue.elements[10])/ue.elements[14],I.multiplyScalar(2/I.dot(C)),ue.elements[2]=I.x,ue.elements[6]=I.y,ue.elements[10]=I.z+1-l,ue.elements[14]=I.w,v.setFromMatrixPosition(z.matrixWorld);const le=J.getRenderTarget(),k=J.xr.enabled,Y=J.shadowMap.autoUpdate;n.visible=!1,J.xr.enabled=!1,J.shadowMap.autoUpdate=!1,J.setRenderTarget(K),J.state.buffers.depth.setMask(!0),J.autoClear===!1&&J.clear(),J.render(oe,Z),n.visible=!0,J.xr.enabled=k,J.shadowMap.autoUpdate=Y,J.setRenderTarget(le);const Ee=z.viewport;Ee!==void 0&&J.state.viewport(Ee)}}}function wP(){const[a,e]=gs.useState(!1),t=gs.useRef(!1),n=gs.useRef({x:0,y:0}),i=gs.useRef({horizontal:0,vertical:0}),o=gs.useRef({x:4,y:1,z:-10}),l=new j(.25,.55,0),u=gs.useRef(null);return gs.useEffect(()=>{(()=>{window.innerWidth<=768?o.current={x:2.5,y:1,z:-12}:o.current={x:3.5,y:1,z:-10}})();const h=document.getElementById("canvas"),p={width:window.innerWidth,height:window.innerHeight},m=new tT,g=new Dn(25,p.width/p.height,.1,1e4);g.position.set(o.current.x-25,o.current.y+2,o.current.z),g.lookAt(l),m.add(g),a&&(()=>{Wc.to(g.position,{x:o.current.x,y:o.current.y,duration:3.5,ease:"circ.out",onUpdate:()=>{g.lookAt(l)}})})();const E=Math.sqrt(o.current.x**2+o.current.y**2+o.current.z**2);i.current.horizontal=Math.atan2(o.current.x,o.current.z),i.current.vertical=Math.asin(o.current.y/E);const M=new CC({canvas:h,antialias:!0});M.shadowMap.enabled=!0,M.shadowMap.type=qv,M.setSize(p.width,p.height);const y=new LT(16777215,1);m.add(y);const x=new Pp(16777215,5);x.position.set(-100,20,1e3),x.castShadow=!0,x.shadow.mapSize.width=4096,x.shadow.mapSize.height=4096,x.shadow.camera.near=.5,x.shadow.camera.far=1500,x.shadow.camera.left=-50,x.shadow.camera.right=50,x.shadow.camera.top=50,x.shadow.camera.bottom=-50,m.add(x);const b=new Pp(16777215,.6);b.position.set(0,300,-100),b.castShadow=!0,b.shadow.mapSize.width=512,b.shadow.mapSize.height=512,m.add(b);const R=new Ra(500,500),T=new lf({color:11184810}),D=new vn(R,T);D.rotation.x=-Math.PI/2,D.position.y=0,D.position.z=-243,D.receiveShadow=!0,m.add(D);const N=new bC;N.load("./models/testmodel0101_v2.gltf",Y=>{const Ee=Y.scene,$=Y.animations;if(Ee.traverse(ne=>{ne instanceof vn&&(ne.castShadow=!0,ne.receiveShadow=!0)}),m.add(Ee),e(!0),$&&$.length>0){const ne=new ev(Ee);$.forEach(Te=>{ne.clipAction(Te).play()});const xe=new Q0,me=()=>{requestAnimationFrame(me);const Te=xe.getDelta();ne.update(Te),M.render(m,g)};me()}}),N.load("./models/testmodel_child_.gltf",Y=>{const Ee=Y.scene,$=Y.animations;if(Ee.position.set(0,0,-.75),Ee.traverse(ne=>{ne instanceof vn&&(ne.castShadow=!0,ne.receiveShadow=!0)}),m.add(Ee),$&&$.length>0){const ne=new ev(Ee);$.forEach(Te=>{ne.clipAction(Te).play()});const xe=new Q0,me=()=>{requestAnimationFrame(me);const Te=xe.getDelta();ne.update(Te),M.render(m,g)};me()}});const I=new ff;I.scale.setScalar(5e4);const F=I.material.uniforms;F.turbidity.value=.5,F.rayleigh.value=.95,F.mieCoefficient.value=.005,F.mieDirectionalG.value=.8,F.sunPosition.value.set(-10,0,100),m.add(I);const A=new Ra(1e3,1e3),C=new bx().load("./textures/eslint.config.jpg",Y=>{Y.wrapS=Y.wrapT=mo}),B=new TP(A,{textureWidth:512,textureHeight:512,waterNormals:C,sunDirection:new j(-1,-1,-1),sunColor:16777215,waterColor:7695,distortionScale:3.7,fog:m.fog!==void 0});B.rotation.x=-Math.PI/2,m.add(B),u.current=B,B.position.y=-4;const Z=new j;Z.set(-10,15,100).normalize(),B.material.uniforms.sunDirection.value.copy(Z);const K=()=>{requestAnimationFrame(K),B.material.uniforms.time.value+=1/1e3,M.render(m,g)};K();const ce=()=>{p.width=window.innerWidth,p.height=window.innerHeight,g.aspect=p.width/p.height,g.updateProjectionMatrix(),M.setSize(p.width,p.height)},re=Y=>{t.current=!0,n.current={x:Y.clientX,y:Y.clientY}},J=Y=>{if(t.current){const Ee=Y.clientX-n.current.x,$=Y.clientY-n.current.y;n.current={x:Y.clientX,y:Y.clientY};const ne=.005;i.current.horizontal+=Ee*ne,i.current.vertical-=$*ne,i.current.vertical=Math.max(-Math.PI/2,Math.min(Math.PI/2,i.current.vertical));const xe=E*Math.cos(i.current.vertical)*Math.sin(i.current.horizontal),me=Math.max(1,E*Math.sin(i.current.vertical)),Te=E*Math.cos(i.current.vertical)*Math.cos(i.current.horizontal);g.position.set(xe,me,Te),g.lookAt(l)}},oe=()=>{t.current&&(t.current=!1,Wc.to(i.current,{horizontal:Math.atan2(o.current.x,o.current.z),vertical:Math.asin(o.current.y/E),duration:1,ease:"power2.out",onUpdate:()=>{const Y=E*Math.cos(i.current.vertical)*Math.sin(i.current.horizontal),Ee=Math.max(1,E*Math.sin(i.current.vertical)),$=E*Math.cos(i.current.vertical)*Math.cos(i.current.horizontal);g.position.set(Y,Ee,$),g.lookAt(l)}}))},z=Y=>{Y.touches.length===1&&(t.current=!0,n.current={x:Y.touches[0].clientX,y:Y.touches[0].clientY})},ue=Y=>{if(t.current&&Y.touches.length===1){const Ee=Y.touches[0].clientX-n.current.x,$=Y.touches[0].clientY-n.current.y;n.current={x:Y.touches[0].clientX,y:Y.touches[0].clientY};const ne=.005;i.current.horizontal+=Ee*ne,i.current.vertical-=$*ne,i.current.vertical=Math.max(-Math.PI/2,Math.min(Math.PI/2,i.current.vertical));const xe=Math.sqrt(o.current.x**2+o.current.y**2+o.current.z**2),me=xe*Math.cos(i.current.vertical)*Math.sin(i.current.horizontal),Te=Math.max(1,xe*Math.sin(i.current.vertical)),Ie=xe*Math.cos(i.current.vertical)*Math.cos(i.current.horizontal);g.position.set(me,Te,Ie),g.lookAt(l)}},le=()=>{t.current&&(t.current=!1,Wc.to(i.current,{horizontal:Math.atan2(o.current.x,o.current.z),vertical:Math.asin(o.current.y/Math.sqrt(o.current.x**2+o.current.y**2+o.current.z**2)),duration:1,ease:"power2.out",onUpdate:()=>{const Y=Math.sqrt(o.current.x**2+o.current.y**2+o.current.z**2),Ee=Y*Math.cos(i.current.vertical)*Math.sin(i.current.horizontal),$=Math.max(1,Y*Math.sin(i.current.vertical)),ne=Y*Math.cos(i.current.vertical)*Math.cos(i.current.horizontal);g.position.set(Ee,$,ne),g.lookAt(l)}}))};window.addEventListener("resize",ce),h.addEventListener("mousedown",re),window.addEventListener("mousemove",J),window.addEventListener("mouseup",oe),h.addEventListener("touchstart",z),window.addEventListener("touchmove",ue),window.addEventListener("touchend",le);const k=()=>{requestAnimationFrame(k),M.render(m,g)};return k(),()=>{window.removeEventListener("resize",ce),h.removeEventListener("mousedown",re),window.removeEventListener("mousemove",J),window.removeEventListener("mouseup",oe),h.removeEventListener("touchstart",z),window.removeEventListener("touchmove",ue),window.removeEventListener("touchend",le)}},[a]),Jt.jsxs(Jt.Fragment,{children:[Jt.jsx("div",{className:"noise"}),Jt.jsx("div",{className:`loading ${a?"hidden":""}`,children:Jt.jsxs("div",{className:"loading-wrapper",children:[Jt.jsx("img",{className:"loading-img",src:"./images/loading.gif",alt:"Loading"}),Jt.jsx("p",{className:"loading-text",children:"Loading..."})]})}),Jt.jsx("canvas",{className:"canvas",id:"canvas",style:{width:"100vw",height:"100vh",touchAction:"none"}}),Jt.jsx("div",{className:"container",children:Jt.jsxs("div",{className:"inner",children:[Jt.jsx("div",{className:"img2025",children:Jt.jsx("img",{src:"./images/2025.svg",alt:"二〇二五"})}),Jt.jsx("div",{className:"text",children:Jt.jsxs("p",{children:["あけましておめでとうございます。",Jt.jsx("br",{}),"昨年はいろいろとお世話になり、",Jt.jsx("wbr",{}),"ありがとうございました。",Jt.jsx("br",{}),"本年もどうぞよろしくお願いいたします。"]})}),Jt.jsx("div",{className:"copy-text",children:Jt.jsx("img",{src:"./images/text_2.svg",alt:"日の目を見る",width:"174",height:"680"})})]})}),Jt.jsx("div",{className:"fadein"})]})}SM.createRoot(document.getElementById("root")).render(Jt.jsx(gs.StrictMode,{children:Jt.jsx(wP,{})}));
