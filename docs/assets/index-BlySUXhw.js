 ...
 */var e0;function dM(){if(e0)return ht;e0=1;var a=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),n=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),l=Symbol.for("react.context"),u=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),m=Symbol.iterator;function g(k){return k===null||typeof k!="object"?null:(k=m&&k[m]||k["@@iterator"],typeof k=="function"?k:null)}var v={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function y(k,Z,Te){this.props=k,this.context=Z,this.refs=M,this.updater=Te||v}y.prototype.isReactComponent={},y.prototype.setState=function(k,Z){if(typeof k!="object"&&typeof k!="function"&&k!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,k,Z,"setState")},y.prototype.forceUpdate=function(k){this.updater.enqueueForceUpdate(this,k,"forceUpdate")};function x(){}x.prototype=y.prototype;function b(k,Z,Te){this.props=k,this.context=Z,this.refs=M,this.updater=Te||v}var R=b.prototype=new x;R.constructor=b,E(R,y.prototype),R.isPureReactComponent=!0;var T=Array.isArray,D=Object.prototype.hasOwnProperty,N={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function F(k,Z,Te){var K,ce={},Se=null,ve=null;if(Z!=null)for(K in Z.ref!==void 0&&(ve=Z.ref),Z.key!==void 0&&(Se=""+Z.key),Z)D.call(Z,K)&&!I.hasOwnProperty(K)&&(ce[K]=Z[K]);var we=arguments.length-2;if(we===1)ce.children=Te;else if(1<we){for(var Ne=Array(we),Ze=0;Ze<we;Ze++)Ne[Ze]=arguments[Ze+2];ce.children=Ne}if(k&&k.defaultProps)for(K in we=k.defaultProps,we)ce[K]===void 0&&(ce[K]=we[K]);return{$$typeof:a,type:k,key:Se,ref:ve,props:ce,_owner:N.current}}function A(k,Z){return{$$typeof:a,type:k.type,key:Z,ref:k.ref,props:k.props,_owner:k._owner}}function C(k){return typeof k=="object"&&k!==null&&k.$$typeof===a}function B(k){var Z={"=":"=0",":":"=2"};return"$"+k.replace(/[=:]/g,function(Te){return Z[Te]})}var $=/\/+/g;function q(k,Z){return typeof k=="object"&&k!==null&&k.key!=null?B(""+k.key):Z.toString(36)}function ue(k,Z,Te,K,ce){var Se=typeof k;(Se==="undefined"||Se==="boolean")&&(k=null);var ve=!1;if(k===null)ve=!0;else switch(Se){case"string":case"number":ve=!0;break;case"object":switch(k.$$typeof){case a:case e:ve=!0}}if(ve)return ve=k,ce=ce(ve),k=K===""?"."+q(ve,0):K,T(ce)?(Te="",k!=null&&(Te=k.replace($,"$&/")+"/"),ue(ce,Z,Te,"",function(Ze){return Ze})):ce!=null&&(C(ce)&&(ce=A(ce,Te+(!ce.key||ve&&ve.key===ce.key?"":(""+ce.key).replace($,"$&/")+"/")+k)),Z.push(ce)),1;if(ve=0,K=K===""?".":K+":",T(k))for(var we=0;we<k.length;we++){Se=k[we];var Ne=K+q(Se,we);ve+=ue(Se,Z,Te,Ne,ce)}else if(Ne=g(k),typeof Ne=="function")for(k=Ne.call(k),we=0;!(Se=k.next()).done;)Se=Se.value,Ne=K+q(Se,we++),ve+=ue(Se,Z,Te,Ne,ce);else if(Se==="object")throw Z=String(k),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(k).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.");return ve}function se(k,Z,Te){if(k==null)return k;var K=[],ce=0;return ue(k,K,"","",function(Se){return Z.call(Te,Se,ce++)}),K}function J(k){if(k._status===-1){var Z=k._result;Z=Z(),Z.then(function(Te){(k._status===0||k._status===-1)&&(k._status=1,k._result=Te)},function(Te){(k._status===0||k._status===-1)&&(k._status=2,k._result=Te)}),k._status===-1&&(k._status=0,k._result=Z)}if(k._status===1)return k._result.default;throw k._result}var ae={current:null},z={transition:null},ee={ReactCurrentDispatcher:ae,ReactCurrentBatchConfig:z,ReactCurrentOwner:N};function ie(){throw Error("act(...) is not supported in production builds of React.")}return ht.Children={map:se,forEach:function(k,Z,Te){se(k,function(){Z.apply(this,arguments)},Te)},count:function(k){var Z=0;return se(k,function(){Z++}),Z},toArray:function(k){return se(k,function(Z){return Z})||[]},only:function(k){if(!C(k))throw Error("React.Children.only expected to receive a single React element child.");return k}},ht.Component=y,ht.Fragment=t,ht.Profiler=r,ht.PureComponent=b,ht.StrictMode=n,ht.Suspense=f,ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ee,ht.act=ie,ht.cloneElement=function(k,Z,Te){if(k==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+k+".");var K=E({},k.props),ce=k.key,Se=k.ref,ve=k._owner;if(Z!=null){if(Z.ref!==void 0&&(Se=Z.ref,ve=N.current),Z.key!==void 0&&(ce=""+Z.key),k.type&&k.type.defaultProps)var we=k.type.defaultProps;for(Ne in Z)D.call(Z,Ne)&&!I.hasOwnProperty(Ne)&&(K[Ne]=Z[Ne]===void 0&&we!==void 0?we[Ne]:Z[Ne])}var Ne=arguments.length-2;if(Ne===1)K.children=Te;else if(1<Ne){we=Array(Ne);for(var Ze=0;Ze<Ne;Ze++)we[Ze]=arguments[Ze+2];K.children=we}return{$$typeof:a,type:k.type,key:ce,ref:Se,props:K,_owner:ve}},ht.createContext=function(k){return k={$$typeof:l,_currentValue:k,_currentValue2:k,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},k.Provider={$$typeof:o,_context:k},k.Consumer=k},ht.createElement=F,ht.createFactory=function(k){var Z=F.bind(null,k);return Z.type=k,Z},ht.createRef=function(){return{current:null}},ht.forwardRef=function(k){return{$$typeof:u,render:k}},ht.isValidElement=C,ht.lazy=function(k){return{$$typeof:p,_payload:{_status:-1,_result:k},_init:J}},ht.memo=function(k,Z){return{$$typeof:h,type:k,compare:Z===void 0?null:Z}},ht.startTransition=function(k){var Z=z.transition;z.transition={};try{k()}finally{z.transition=Z}},ht.unstable_act=ie,ht.useCallback=function(k,Z){return ae.current.useCallback(k,Z)},ht.useContext=function(k){return ae.current.useContext(k)},ht.useDebugValue=function(){},ht.useDeferredValue=function(k){return ae.current.useDeferredValue(k)},ht.useEffect=function(k,Z){return ae.current.useEffect(k,Z)},ht.useId=function(){return ae.current.useId()},ht.useImperativeHandle=function(k,Z,Te){return ae.current.useImperativeHandle(k,Z,Te)},ht.useInsertionEffect=function(k,Z){return ae.current.useInsertionEffect(k,Z)},ht.useLayoutEffect=function(k,Z){return ae.current.useLayoutEffect(k,Z)},ht.useMemo=function(k,Z){return ae.current.useMemo(k,Z)},ht.useReducer=function(k,Z,Te){return ae.current.useReducer(k,Z,Te)},ht.useRef=function(k){return ae.current.useRef(k)},ht.useState=function(k){return ae.current.useState(k)},ht.useSyncExternalStore=function(k,Z,Te){return ae.current.useSyncExternalStore(k,Z,Te)},ht.useTransition=function(){return ae.current.useTransition()},ht.version="18.3.1",ht}var t0;function Kp(){return t0||(t0=1,jh.exports=dM()),jh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var r0;function gM(){return r0||(r0=1,function(a){function e(z,ee){var ie=z.length;z.push(ee);e:for(;0<ie;){var k=ie-1>>>1,Z=z[k];if(0<r(Z,ee))z[k]=ee,z[ie]=Z,ie=k;else break e}}function t(z){return z.length===0?null:z[0]}function n(z){if(z.length===0)return null;var ee=z[0],ie=z.pop();if(ie!==ee){z[0]=ie;e:for(var k=0,Z=z.length,Te=Z>>>1;k<Te;){var K=2*(k+1)-1,ce=z[K],Se=K+1,ve=z[Se];if(0>r(ce,ie))Se<Z&&0>r(ve,ce)?(z[k]=ve,z[Se]=ie,k=Se):(z[k]=ce,z[K]=ie,k=K);else if(Se<Z&&0>r(ve,ie))z[k]=ve,z[Se]=ie,k=Se;else break e}}return ee}function r(z,ee){var ie=z.sortIndex-ee.sortIndex;return ie!==0?ie:z.id-ee.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;a.unstable_now=function(){return o.now()}}else{var l=Date,u=l.now();a.unstable_now=function(){return l.now()-u}}var f=[],h=[],p=1,m=null,g=3,v=!1,E=!1,M=!1,y=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function R(z){for(var ee=t(h);ee!==null;){if(ee.callback===null)n(h);else if(ee.startTime<=z)n(h),ee.sortIndex=ee.expirationTime,e(f,ee);else break;ee=t(h)}}function T(z){if(M=!1,R(z),!E)if(t(f)!==null)E=!0,J(D);else{var ee=t(h);ee!==null&&ae(T,ee.startTime-z)}}function D(z,ee){E=!1,M&&(M=!1,x(F),F=-1),v=!0;var ie=g;try{for(R(ee),m=t(f);m!==null&&(!(m.expirationTime>ee)||z&&!B());){var k=m.callback;if(typeof k=="function"){m.callback=null,g=m.priorityLevel;var Z=k(m.expirationTime<=ee);ee=a.unstable_now(),typeof Z=="function"?m.callback=Z:m===t(f)&&n(f),R(ee)}else n(f);m=t(f)}if(m!==null)var Te=!0;else{var K=t(h);K!==null&&ae(T,K.startTime-ee),Te=!1}return Te}finally{m=null,g=ie,v=!1}}var N=!1,I=null,F=-1,A=5,C=-1;function B(){return!(a.unstable_now()-C<A)}function $(){if(I!==null){var z=a.unstable_now();C=z;var ee=!0;try{ee=I(!0,z)}finally{ee?q():(N=!1,I=null)}}else N=!1}var q;if(typeof b=="function")q=function(){b($)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,se=ue.port2;ue.port1.onmessage=$,q=function(){se.postMessage(null)}}else q=function(){y($,0)};function J(z){I=z,N||(N=!0,q())}function ae(z,ee){F=y(function(){z(a.unstable_now())},ee)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(z){z.callback=null},a.unstable_continueExecution=function(){E||v||(E=!0,J(D))},a.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<z?Math.floor(1e3/z):5},a.unstable_getCurrentPriorityLevel=function(){return g},a.unstable_getFirstCallbackNode=function(){return t(f)},a.unstable_next=function(z){switch(g){case 1:case 2:case 3:var ee=3;break;default:ee=g}var ie=g;g=ee;try{return z()}finally{g=ie}},a.unstable_pauseExecution=function(){},a.unstable_requestPaint=function(){},a.unstable_runWithPriority=function(z,ee){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var ie=g;g=z;try{return ee()}finally{g=ie}},a.unstable_scheduleCallback=function(z,ee,ie){var k=a.unstable_now();switch(typeof ie=="object"&&ie!==null?(ie=ie.delay,ie=typeof ie=="number"&&0<ie?k+ie:k):ie=k,z){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=ie+Z,z={id:p++,callback:ee,priorityLevel:z,startTime:ie,expirationTime:Z,sortIndex:-1},ie>k?(z.sortIndex=ie,e(h,z),t(f)===null&&z===t(h)&&(M?(x(F),F=-1):M=!0,ae(T,ie-k))):(z.sortIndex=Z,e(f,z),E||v||(E=!0,J(D))),z},a.unstable_shouldYield=B,a.unstable_wrapCallback=function(z){var ee=g;return function(){var ie=g;g=ee;try{return z.apply(this,arguments)}finally{g=ie}}}}(Kh)),Kh}var s0;function _M(){return s0||(s0=1,qh.exports=gM()),qh.exports}/**
 * @license React
...
`)+`
`+x);const R=b+y+l,T=b+x+u,D=gv(r,r.VERTEX_SHADER,R),N=gv(r,r.FRAGMENT_SHADER,T);r.attachShader(M,D),r.attachShader(M,N),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function I(B){if(a.debug.checkShaderErrors){const $=r.getProgramInfoLog(M).trim(),q=r.getShaderInfoLog(D).trim(),ue=r.getShaderInfoLog(N).trim();let se=!0,J=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(se=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(r,M,D,N);else{const ae=vv(r,D,"vertex"),z=vv(r,N,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
*/var kv,Ms,va,Cm,uo,Bv,bm,nP=function(){return typeof window<"u"},zr={},ro=180/Math.PI,xa=Math.PI/180,oa=Math.atan2,zv=1e8,Pm=/([A-Z])/g,iP=/(left|right|width|margin|padding|x)/i,rP=/[\s,\(]\S/,ir={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Wp=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},sP=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},oP=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},aP=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},wy=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Ay=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},lP=function(e,t,n){return e.style[t]=n},uP=function(e,t,n){return e.style.setProperty(t,n)},cP=function(e,t,n){return e._gsap[t]=n},fP=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},hP=function(e,t,n,r,o){var l=e._gsap;l.scaleX=l.scaleY=n,l.renderTransform(o,l)},dP=function(e,t,n,r,o){var l=e._gsap;l[t]=n,l.renderTransform(o,l)},Kt="transform",oi=Kt+"Origin",pP=function a(e,t){var n=this,r=this.target,o=r.style,l=r._gsap;if(e in zr&&o){if(this.tfm=this.tfm||{},e!=="transform")e=ir[e]||e,~e.indexOf(",")?e.split(",").forEach(function(u){return n.tfm[u]=Dr(r,u)}):this.tfm[e]=l.x?l[e]:Dr(r,e),e===oi&&(this.tfm.zOrigin=l.zOrigin);else return ir.transform.split(",").forEach(function(u){return a.call(n,u,t)});if(this.props.indexOf(Kt)>=0)return;l.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(oi,t,"")),e=Kt}(o||t)&&this.props.push(e,t,o[e])},Ry=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},mP=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,o,l;for(o=0;o<e.length;o+=3)e[o+1]?t[e[o]]=e[o+2]:e[o+2]?n[e[o]]=e[o+2]:n.removeProperty(e[o].substr(0,2)==="--"?e[o]:e[o].replace(Pm,"-$1").toLowerCase());if(this.tfm){for(l in this.tfm)r[l]=this.tfm[l];r.svg&&(r.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),o=bm(),(!o||!o.isStart)&&!n[Kt]&&(Ry(n),r.zOrigin&&n[oi]&&(n[oi]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},Cy=function(e,t){var n={target:e,props:[],revert:mP,save:pP};return e._gsap||ai.core.getCache(e),t&&t.split(",").forEach(function(r){return n.save(r)}),n},by,Xp=function(e,t){var n=Ms.createElementNS?Ms.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Ms.createElement(e);return n&&n.style?n:Ms.createElement(e)},sr=function a(e,t,n){var r=getComputedStyle(e);return r[t]||r.getPropertyValue(t.replace(Pm,"-$1").toLowerCase())||r.getPropertyValue(t)||!n&&a(e,Ua(t)||t,1)||""},Vv="O,Moz,ms,Ms,Webkit".split(","),Ua=function(e,t,n){var r=t||uo,o=r.style,l=5;if(e in o&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);l--&&!(Vv[l]+e in o););return l<0?null:(l===3?"ms":l>=0?Vv[l]:"")+e},jp=function(){nP()&&window.document&&(kv=window,Ms=kv.document,va=Ms.documentElement,uo=Xp("div")||{style:{}},Xp("div"),Kt=Ua(Kt),oi=Kt+"Origin",uo.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",by=!!Ua("perspective"),bm=ai.core.reverting,Cm=1)},Bd=function a(e){var t=Xp("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,r=this.nextSibling,o=this.style.cssText,l;if(va.appendChild(t),t.appendChild(this),this.style.display="block",e)try{l=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=a}catch{}else this._gsapBBox&&(l=this._gsapBBox());return n&&(r?n.insertBefore(this,r):n.appendChild(this)),va.removeChild(t),this.style.cssText=o,l},Hv=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Py=function(e){var t;try{t=e.getBBox()}catch{t=Bd.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===Bd||(t=Bd.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Hv(e,["x","cx","x1"])||0,y:+Hv(e,["y","cy","y1"])||0,width:0,height:0}:t},Ly=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Py(e))},vo=function(e,t){if(t){var n=e.style,r;t in zr&&t!==oi&&(t=Kt),n.removeProperty?(r=t.substr(0,2),(r==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(r==="--"?t:t.replace(Pm,"-$1").toLowerCase())):n.removeAttribute(t)}},Es=function(e,t,n,r,o,l){var u=new si(e._pt,t,n,0,1,l?Ay:wy);return e._pt=u,u.b=r,u.e=o,e._props.push(n),u},Gv={deg:1,rad:1,turn:1},gP={grid:1,flex:1},Ps=function a(e,t,n,r){var o=parseFloat(n)||0,l=(n+"").trim().substr((o+"").length)||"px",u=uo.style,f=iP.test(t),h=e.tagName.toLowerCase()==="svg",p=(h?"client":"offset")+(f?"Width":"Height"),m=100,g=r==="px",v=r==="%",E,M,y,x;if(r===l||!o||Gv[r]||Gv[l])return o;if(l!=="px"&&!g&&(o=a(e,t,n,"px")),x=e.getCTM&&Ly(e),(v||l==="%")&&(zr[t]||~t.indexOf("adius")))return E=x?e.getBBox()[f?"width":"height"]:e[p],rn(v?o/E*m:o/100*E);if(u[f?"width":"height"]=m+(g?l:r),M=~t.indexOf("adius")||r==="em"&&e.appendChild&&!h?e:e.parentNode,x&&(M=(e.ownerSVGElement||{}).parentNode),(!M||M===Ms||!M.appendChild)&&(M=Ms.body),y=M._gsap,y&&v&&y.width&&f&&y.time===mi.time&&!y.uncache)return rn(o/y.width*m);if(v&&(t==="height"||t==="width")){var b=e.style[t];e.style[t]=m+r,E=e[p],b?e.style[t]=b:vo(e,t)}else(v||l==="%")&&!gP[sr(M,"display")]&&(u.position=sr(e,"position")),M===e&&(u.position="static"),M.appendChild(uo),E=uo[p],M.removeChild(uo),u.position="absolute";return f&&v&&(y=co(M),y.time=mi.time,y.width=M[p]),rn(g?E*o/m:E&&o?m/E*o:0)},Dr=function(e,t,n,r){var o;return Cm||jp(),t in ir&&t!=="transform"&&(t=ir[t],~t.indexOf(",")&&(t=t.split(",")[0])),zr[t]&&t!=="transform"?(o=Kl(e,r),o=t!=="transformOrigin"?o[t]:o.svg?o.origin:rf(sr(e,oi))+" "+o.zOrigin+"px"):(o=e.style[t],(!o||o==="auto"||r||~(o+"").indexOf("calc("))&&(o=nf[t]&&nf[t](e,t,n)||sr(e,t)||Yx(e,t)||(t==="opacity"?1:0))),n&&!~(o+"").trim().indexOf(" ")?Ps(e,t,o,n)+n:o},_P=function(e,t,n,r){if(!n||n==="none"){var o=Ua(t,e,1),l=o&&sr(e,o,1);l&&l!==n?(t=o,n=l):t==="borderColor"&&(n=sr(e,"borderTopColor"))}var u=new si(this._pt,e.style,t,0,1,My),f=0,h=0,p,m,g,v,E,M,y,x,b,R,T,D;if(u.b=n,u.e=r,n+="",r+="",r==="auto"&&(M=e.style[t],e.style[t]=r,r=sr(e,t)||r,M?e.style[t]=M:vo(e,t)),p=[n,r],hy(p),n=p[0],r=p[1],g=n.match(fa)||[],D=r.match(fa)||[],D.length){for(;m=fa.exec(r);)y=m[0],b=r.substring(f,m.index),E?E=(E+1)%5:(b.substr(-5)==="rgba("||b.substr(-5)==="hsla(")&&(E=1),y!==(M=g[h++]||"")&&(v=parseFloat(M)||0,T=M.substr((v+"").length),y.charAt(1)==="="&&(y=_a(v,y)+T),x=parseFloat(y),R=y.substr((x+"").length),f=fa.lastIndex-R.length,R||(R=R||vi.units[t]||T,f===r.length&&(r+=R,u.e+=R)),T!==R&&(v=Ps(e,t,M,R)||0),u._pt={_next:u._pt,p:b||h===1?b:",",s:v,c:x-v,m:E&&E<4||t==="zIndex"?Math.round:0});u.c=f<r.length?r.substring(f,r.length):""}else u.r=t==="display"&&r==="none"?Ay:wy;return Vx.test(r)&&(u.e=0),this._pt=u,u},Wv={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},vP=function(e){var t=e.split(" "),n=t[0],r=t[1]||"50%";return(n==="top"||n==="bottom"||r==="left"||r==="right")&&(e=n,n=r,r=e),t[0]=Wv[n]||n,t[1]=Wv[r]||r,t.join(" ")},xP=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,o=t.u,l=n._gsap,u,f,h;if(o==="all"||o===!0)r.cssText="",f=1;else for(o=o.split(","),h=o.length;--h>-1;)u=o[h],zr[u]&&(f=1,u=u==="transformOrigin"?oi:Kt),vo(n,u);f&&(vo(n,Kt),l&&(l.svg&&n.removeAttribute("transform"),Kl(n,1),l.uncache=1,Ry(r)))}},nf={clearProps:function(e,t,n,r,o){if(o.data!=="isFromStart"){var l=e._pt=new si(e._pt,t,n,0,0,xP);return l.u=r,l.pr=-10,l.tween=o,e._props.push(n),1}}},ql=[1,0,0,1,0,0],Iy={},Dy=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Xv=function(e){var t=sr(e,Kt);return Dy(t)?ql:t.substr(7).match(zx).map(rn)},Lm=function(e,t){var n=e._gsap||co(e),r=e.style,o=Xv(e),l,u,f,h;return n.svg&&e.getAttribute("transform")?(f=e.transform.baseVal.consolidate().matrix,o=[f.a,f.b,f.c,f.d,f.e,f.f],o.join(",")==="1,0,0,1,0,0"?ql:o):(o===ql&&!e.offsetParent&&e!==va&&!n.svg&&(f=r.display,r.display="block",l=e.parentNode,(!l||!e.offsetParent)&&(h=1,u=e.nextElementSibling,va.appendChild(e)),o=Xv(e),f?r.display=f:vo(e,"display"),h&&(u?l.insertBefore(e,u):l?l.appendChild(e):va.removeChild(e))),t&&o.length>6?[o[0],o[1],o[4],o[5],o[12],o[13]]:o)},Yp=function(e,t,n,r,o,l){var u=e._gsap,f=o||Lm(e,!0),h=u.xOrigin||0,p=u.yOrigin||0,m=u.xOffset||0,g=u.yOffset||0,v=f[0],E=f[1],M=f[2],y=f[3],x=f[4],b=f[5],R=t.split(" "),T=parseFloat(R[0])||0,D=parseFloat(R[1])||0,N,I,F,A;n?f!==ql&&(I=v*y-E*M)&&(F=T*(y/I)+D*(-M/I)+(M*b-y*x)/I,A=T*(-E/I)+D*(v/I)-(v*b-E*x)/I,T=F,D=A):(N=Py(e),T=N.x+(~R[0].indexOf("%")?T/100*N.width:T),D=N.y+(~(R[1]||R[0]).indexOf("%")?D/100*N.height:D)),r||r!==!1&&u.smooth?(x=T-h,b=D-p,u.xOffset=m+(x*v+b*M)-x,u.yOffset=g+(x*E+b*y)-b):u.xOffset=u.yOffset=0,u.xOrigin=T,u.yOrigin=D,u.smooth=!!r,u.origin=t,u.originIsAbsolute=!!n,e.style[oi]="0px 0px",l&&(Es(l,u,"xOrigin",h,T),Es(l,u,"yOrigin",p,D),Es(l,u,"xOffset",m,u.xOffset),Es(l,u,"yOffset",g,u.yOffset)),e.setAttribute("data-svg-origin",T+" "+D)},Kl=function(e,t){var n=e._gsap||new gy(e);if("x"in n&&!t&&!n.uncache)return n;var r=e.style,o=n.scaleX<0,l="px",u="deg",f=getComputedStyle(e),h=sr(e,oi)||"0",p,m,g,v,E,M,y,x,b,R,T,D,N,I,F,A,C,B,$,q,ue,se,J,ae,z,ee,ie,k,Z,Te,K,ce;return p=m=g=M=y=x=b=R=T=0,v=E=1,n.svg=!!(e.getCTM&&Ly(e)),f.translate&&((f.translate!=="none"||f.scale!=="none"||f.rotate!=="none")&&(r[Kt]=(f.translate!=="none"?"translate3d("+(f.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(f.rotate!=="none"?"rotate("+f.rotate+") ":"")+(f.scale!=="none"?"scale("+f.scale.split(" ").join(",")+") ":"")+(f[Kt]!=="none"?f[Kt]:"")),r.scale=r.rotate=r.translate="none"),I=Lm(e,n.svg),n.svg&&(n.uncache?(z=e.getBBox(),h=n.xOrigin-z.x+"px "+(n.yOrigin-z.y)+"px",ae=""):ae=!t&&e.getAttribute("data-svg-origin"),Yp(e,ae||h,!!ae||n.originIsAbsolute,n.smooth!==!1,I)),D=n.xOrigin||0,N=n.yOrigin||0,I!==ql&&(B=I[0],$=I[1],q=I[2],ue=I[3],p=se=I[4],m=J=I[5],I.length===6?(v=Math.sqrt(B*B+$*$),E=Math.sqrt(ue*ue+q*q),M=B||$?oa($,B)*ro:0,b=q||ue?oa(q,ue)*ro+M:0,b&&(E*=Math.abs(Math.cos(b*xa))),n.svg&&(p-=D-(D*B+N*q),m-=N-(D*$+N*ue))):(ce=I[6],Te=I[7],ie=I[8],k=I[9],Z=I[10],K=I[11],p=I[12],m=I[13],g=I[14],F=oa(ce,Z),y=F*ro,F&&(A=Math.cos(-F),C=Math.sin(-F),ae=se*A+ie*C,z=J*A+k*C,ee=ce*A+Z*C,ie=se*-C+ie*A,k=J*-C+k*A,Z=ce*-C+Z*A,K=Te*-C+K*A,se=ae,J=z,ce=ee),F=oa(-q,Z),x=F*ro,F&&(A=Math.cos(-F),C=Math.sin(-F),ae=B*A-ie*C,z=$*A-k*C,ee=q*A-Z*C,K=ue*C+K*A,B=ae,$=z,q=ee),F=oa($,B),M=F*ro,F&&(A=Math.cos(F),C=Math.sin(F),ae=B*A+$*C,z=se*A+J*C,$=$*A-B*C,J=J*A-se*C,B=ae,se=z),y&&Math.abs(y)+Math.abs(M)>359.9&&(y=M=0,x=180-x),v=rn(Math.sqrt(B*B+$*$+q*q)),E=rn(Math.sqrt(J*J+ce*ce)),F=oa(se,J),b=Math.abs(F)>2e-4?F*ro:0,T=K?1/(K<0?-K:K):0),n.svg&&(ae=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Dy(sr(e,Kt)),ae&&e.setAttribute("transform",ae))),Math.abs(b)>90&&Math.abs(b)<270&&(o?(v*=-1,b+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,b+=b<=0?180:-180)),t=t||n.uncache,n.x=p-((n.xPercent=p&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-p)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+l,n.y=m-((n.yPercent=m&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-m)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+l,n.z=g+l,n.scaleX=rn(v),n.scaleY=rn(E),n.rotation=rn(M)+u,n.rotationX=rn(y)+u,n.rotationY=rn(x)+u,n.skewX=b+u,n.skewY=R+u,n.transformPerspective=T+l,(n.zOrigin=parseFloat(h.split(" ")[2])||!t&&n.zOrigin||0)&&(r[oi]=rf(h)),n.xOffset=n.yOffset=0,n.force3D=vi.force3D,n.renderTransform=n.svg?SP:by?Ny:yP,n.uncache=0,n},rf=function(e){return(e=e.split(" "))[0]+" "+e[1]},zd=function(e,t,n){var r=Nn(t);return rn(parseFloat(t)+parseFloat(Ps(e,"x",n+"px",r)))+r},yP=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Ny(e,t)},to="0deg",Cl="0px",no=") ",Ny=function(e,t){var n=t||this,r=n.xPercent,o=n.yPercent,l=n.x,u=n.y,f=n.z,h=n.rotation,p=n.rotationY,m=n.rotationX,g=n.skewX,v=n.skewY,E=n.scaleX,M=n.scaleY,y=n.transformPerspective,x=n.force3D,b=n.target,R=n.zOrigin,T="",D=x==="auto"&&e&&e!==1||x===!0;if(R&&(m!==to||p!==to)){var N=parseFloat(p)*xa,I=Math.sin(N),F=Math.cos(N),A;N=parseFloat(m)*xa,A=Math.cos(N),l=zd(b,l,I*A*-R),u=zd(b,u,-Math.sin(N)*-R),f=zd(b,f,F*A*-R+R)}y!==Cl&&(T+="perspective("+y+no),(r||o)&&(T+="translate("+r+"%, "+o+"%) "),(D||l!==Cl||u!==Cl||f!==Cl)&&(T+=f!==Cl||D?"translate3d("+l+", "+u+", "+f+") ":"translate("+l+", "+u+no),h!==to&&(T+="rotate("+h+no),p!==to&&(T+="rotateY("+p+no),m!==to&&(T+="rotateX("+m+no),(g!==to||v!==to)&&(T+="skew("+g+", "+v+no),(E!==1||M!==1)&&(T+="scale("+E+", "+M+no),b.style[Kt]=T||"translate(0, 0)"},SP=function(e,t){var n=t||this,r=n.xPercent,o=n.yPercent,l=n.x,u=n.y,f=n.rotation,h=n.skewX,p=n.skewY,m=n.scaleX,g=n.scaleY,v=n.target,E=n.xOrigin,M=n.yOrigin,y=n.xOffset,x=n.yOffset,b=n.forceCSS,R=parseFloat(l),T=parseFloat(u),D,N,I,F,A;f=parseFloat(f),h=parseFloat(h),p=parseFloat(p),p&&(p=parseFloat(p),h+=p,f+=p),f||h?(f*=xa,h*=xa,D=Math.cos(f)*m,N=Math.sin(f)*m,I=Math.sin(f-h)*-g,F=Math.cos(f-h)*g,h&&(p*=xa,A=Math.tan(h-p),A=Math.sqrt(1+A*A),I*=A,F*=A,p&&(A=Math.tan(p),A=Math.sqrt(1+A*A),D*=A,N*=A)),D=rn(D),N=rn(N),I=rn(I),F=rn(F)):(D=m,F=g,N=I=0),(R&&!~(l+"").indexOf("px")||T&&!~(u+"").indexOf("px"))&&(R=Ps(v,"x",l,"px"),T=Ps(v,"y",u,"px")),(E||M||y||x)&&(R=rn(R+E-(E*D+M*I)+y),T=rn(T+M-(E*N+M*F)+x)),(r||o)&&(A=v.getBBox(),R=rn(R+r/100*A.width),T=rn(T+o/100*A.height)),A="matrix("+D+","+N+","+I+","+F+","+R+","+T+")",v.setAttribute("transform",A),b&&(v.style[Kt]=A)},MP=function(e,t,n,r,o){var l=360,u=yn(o),f=parseFloat(o)*(u&&~o.indexOf("rad")?ro:1),h=f-r,p=r+h+"deg",m,g;return u&&(m=o.split("_")[1],m==="short"&&(h%=l,h!==h%(l/2)&&(h+=h<0?l:-l)),m==="cw"&&h<0?h=(h+l*zv)%l-~~(h/l)*l:m==="ccw"&&h>0&&(h=(h-l*zv)%l-~~(h/l)*l)),e._pt=g=new si(e._pt,t,n,r,h,sP),g.e=p,g.u="deg",e._props.push(n),g},jv=function(e,t){for(var n in t)e[n]=t[n];return e},EP=function(e,t,n){var r=jv({},n._gsap),o="perspective,force3D,transformOrigin,svgOrigin",l=n.style,u,f,h,p,m,g,v,E;r.svg?(h=n.getAttribute("transform"),n.setAttribute("transform",""),l[Kt]=t,u=Kl(n,1),vo(n,Kt),n.setAttribute("transform",h)):(h=getComputedStyle(n)[Kt],l[Kt]=t,u=Kl(n,1),l[Kt]=h);for(f in zr)h=r[f],p=u[f],h!==p&&o.indexOf(f)<0&&(v=Nn(h),E=Nn(p),m=v!==E?Ps(n,f,h,E):parseFloat(h),g=parseFloat(p),e._pt=new si(e._pt,u,f,m,g-m,Wp),e._pt.u=E||0,e._props.push(f));jv(u,r)};ri("padding,margin,Width,Radius",function(a,e){var t="Top",n="Right",r="Bottom",o="Left",l=(e<3?[t,n,r,o]:[t+o,t+n,r+n,r+o]).map(function(u){return e<2?a+u:"border"+u+a});nf[e>1?"border"+a:a]=function(u,f,h,p,m){var g,v;if(arguments.length<4)return g=l.map(function(E){return Dr(u,E,h)}),v=g.join(" "),v.split(g[0]).length===5?g[0]:v;g=(p+"").split(" "),v={},l.forEach(function(E,M){return v[E]=g[M]=g[M]||g[(M-1)/2|0]}),u.init(f,v,m)}});var Uy={name:"css",register:jp,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,o){var l=this._props,u=e.style,f=n.vars.startAt,h,p,m,g,v,E,M,y,x,b,R,T,D,N,I,F;Cm||jp(),this.styles=this.styles||Cy(e),F=this.styles.props,this.tween=n;for(M in t)if(M!=="autoRound"&&(p=t[M],!(pi[M]&&_y(M,t,n,r,e,o)))){if(v=typeof p,E=nf[M],v==="function"&&(p=p.call(n,r,e,o),v=typeof p),v==="string"&&~p.indexOf("random(")&&(p=Xl(p)),E)E(this,e,M,p,n)&&(I=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(e).getPropertyValue(M)+"").trim(),p+="",Rs.lastIndex=0,Rs.test(h)||(y=Nn(h),x=Nn(p)),x?y!==x&&(h=Ps(e,M,h,x)+x):y&&(p+=y),this.add(u,"setProperty",h,p,r,o,0,0,M),l.push(M),F.push(M,0,u[M]);else if(v!=="undefined"){if(f&&M in f?(h=typeof f[M]=="function"?f[M].call(n,r,e,o):f[M],yn(h)&&~h.indexOf("random(")&&(h=Xl(h)),Nn(h+"")||h==="auto"||(h+=vi.units[M]||Nn(Dr(e,M))||""),(h+"").charAt(1)==="="&&(h=Dr(e,M))):h=Dr(e,M),g=parseFloat(h),b=v==="string"&&p.charAt(1)==="="&&p.substr(0,2),b&&(p=p.substr(2)),m=parseFloat(p),M in ir&&(M==="autoAlpha"&&(g===1&&Dr(e,"visibility")==="hidden"&&m&&(g=0),F.push("visibility",0,u.visibility),Es(this,u,"visibility",g?"inherit":"hidden",m?"inherit":"hidden",!m)),M!=="scale"&&M!=="transform"&&(M=ir[M],~M.indexOf(",")&&(M=M.split(",")[0]))),R=M in zr,R){if(this.styles.save(M),T||(D=e._gsap,D.renderTransform&&!t.parseTransform||Kl(e,t.parseTransform),N=t.smoothOrigin!==!1&&D.smooth,T=this._pt=new si(this._pt,u,Kt,0,1,D.renderTransform,D,0,-1),T.dep=1),M==="scale")this._pt=new si(this._pt,D,"scaleY",D.scaleY,(b?_a(D.scaleY,b+m):m)-D.scaleY||0,Wp),this._pt.u=0,l.push("scaleY",M),M+="X";else if(M==="transformOrigin"){F.push(oi,0,u[oi]),p=vP(p),D.svg?Yp(e,p,0,N,0,this):(x=parseFloat(p.split(" ")[2])||0,x!==D.zOrigin&&Es(this,D,"zOrigin",D.zOrigin,x),Es(this,u,M,rf(h),rf(p)));continue}else if(M==="svgOrigin"){Yp(e,p,1,N,0,this);continue}else if(M in Iy){MP(this,D,M,g,b?_a(g,b+p):p);continue}else if(M==="smoothOrigin"){Es(this,D,"smooth",D.smooth,p);continue}else if(M==="force3D"){D[M]=p;continue}else if(M==="transform"){EP(this,p,e);continue}}else M in u||(M=Ua(M)||M);if(R||(m||m===0)&&(g||g===0)&&!rP.test(p)&&M in u)y=(h+"").substr((g+"").length),m||(m=0),x=Nn(p)||(M in vi.units?vi.units[M]:y),y!==x&&(g=Ps(e,M,h,x)),this._pt=new si(this._pt,R?D:u,M,g,(b?_a(g,b+m):m)-g,!R&&(x==="px"||M==="zIndex")&&t.autoRound!==!1?aP:Wp),this._pt.u=x||0,y!==x&&x!=="%"&&(this._pt.b=h,this._pt.r=oP);else if(M in u)_P.call(this,e,M,h,b?b+p:p);else if(M in e)this.add(e,M,h||e[M],b?b+p:p,r,o);else if(M!=="parseTransform"){xm(M,p);continue}R||(M in u?F.push(M,0,u[M]):F.push(M,1,h||e[M])),l.push(M)}}I&&Ey(this)},render:function(e,t){if(t.tween._time||!bm())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Dr,aliases:ir,getSetter:function(e,t,n){var r=ir[t];return r&&r.indexOf(",")<0&&(t=r),t in zr&&t!==oi&&(e._gsap.x||Dr(e,"x"))?n&&Bv===n?t==="scale"?fP:cP:(Bv=n||{})&&(t==="scale"?hP:dP):e.style&&!gm(e.style[t])?lP:~t.indexOf("-")?uP:Am(e,t)},core:{_removeProperty:vo,_getMatrix:Lm}};ai.utils.checkPrefix=Ua;ai.core.getStyleSaver=Cy;(function(a,e,t,n){var r=ri(a+","+e+","+t,function(o){zr[o]=1});ri(e,function(o){vi.units[o]="deg",Iy[o]=1}),ir[r[13]]=a+","+e,ri(n,function(o){var l=o.split(":");ir[l[1]]=r[l[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ri("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(a){vi.units[a]="px"});ai.registerPlugin(Uy);var qp=ai.registerPlugin(Uy)||ai;qp.core.Tween;class TP extends vn{constructor(e,t={}){super(e),this.isWater=!0;const n=this,r=t.textureWidth!==void 0?t.textureWidth:512,o=t.textureHeight!==void 0?t.textureHeight:512,l=t.clipBias!==void 0?t.clipBias:0,u=t.alpha!==void 0?t.alpha:1,f=t.time!==void 0?t.time:0,h=t.waterNormals!==void 0?t.waterNormals:null,p=t.sunDirection!==void 0?t.sunDirection:new j(.70707,.70707,0),m=new nt(t.sunColor!==void 0?t.sunColor:16777215),g=new nt(t.waterColor!==void 0?t.waterColor:8355711),v=t.eye!==void 0?t.eye:new j(0,0,0),E=t.distortionScale!==void 0?t.distortionScale:20,M=t.side!==void 0?t.side:or,y=t.fog!==void 0?t.fog:!1,x=new _s,b=new j,R=new j,T=new j,D=new ot,N=new j(0,0,-1),I=new wt,F=new j,A=new j,C=new wt,B=new ot,$=new Dn,q=new Cs(r,o),ue={name:"MirrorShader",uniforms:qc.merge([Ae.fog,Ae.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new ot},sunColor:{value:new nt(8355711)},sunDirection:{value:new j(.70707,.70707,0)},eye:{value:new j},waterColor:{value:new nt(5592405)}}]),vertexShader:`
				...
				void main() {
					...
					#include <colorspace_fragment>
					#include <fog_fragment>	
				}`},se=new lr({name:ue.name,uniforms:qc.clone(ue.uniforms),vertexShader:ue.vertexShader,fragmentShader:ue.fragmentShader,lights:!0,side:M,fog:y});se.uniforms.mirrorSampler.value=q.texture,se.uniforms.textureMatrix.value=B,se.uniforms.alpha.value=u,se.uniforms.time.value=f,se.uniforms.normalSampler.value=h,se.uniforms.sunColor.value=m,se.uniforms.waterColor.value=g,se.uniforms.sunDirection.value=p,se.uniforms.distortionScale.value=E,se.uniforms.eye.value=v,n.material=se,n.onBeforeRender=function(J,ae,z){if(R.setFromMatrixPosition(n.matrixWorld),T.setFromMatrixPosition(z.matrixWorld),D.extractRotation(n.matrixWorld),b.set(0,0,1),b.applyMatrix4(D),F.subVectors(R,T),F.dot(b)>0)return;F.reflect(b).negate(),F.add(R),D.extractRotation(z.matrixWorld),N.set(0,0,-1),N.applyMatrix4(D),N.add(T),A.subVectors(R,N),A.reflect(b).negate(),A.add(R),$.position.copy(F),$.up.set(0,1,0),$.up.applyMatrix4(D),$.up.reflect(b),$.lookAt(A),$.far=z.far,$.updateMatrixWorld(),$.projectionMatrix.copy(z.projectionMatrix),B.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),B.multiply($.projectionMatrix),B.multiply($.matrixWorldInverse),x.setFromNormalAndCoplanarPoint(b,R),x.applyMatrix4($.matrixWorldInverse),I.set(x.normal.x,x.normal.y,x.normal.z,x.constant);const ee=$.projectionMatrix;C.x=(Math.sign(I.x)+ee.elements[8])/ee.elements[0],C.y=(Math.sign(I.y)+ee.elements[9])/ee.elements[5],C.z=-1,C.w=(1+ee.elements[10])/ee.elements[14],I.multiplyScalar(2/I.dot(C)),ee.elements[2]=I.x,ee.elements[6]=I.y,ee.elements[10]=I.z+1-l,ee.elements[14]=I.w,v.setFromMatrixPosition(z.matrixWorld);const ie=J.getRenderTarget(),k=J.xr.enabled,Z=J.shadowMap.autoUpdate;n.visible=!1,J.xr.enabled=!1,J.shadowMap.autoUpdate=!1,J.setRenderTarget(q),J.state.buffers.depth.setMask(!0),J.autoClear===!1&&J.clear(),J.render(ae,$),n.visible=!0,J.xr.enabled=k,J.shadowMap.autoUpdate=Z,J.setRenderTarget(ie);const Te=z.viewport;Te!==void 0&&J.state.viewport(Te)}}}function wP(){const a="/test-site/",[e,t]=gs.useState(!1),n=gs.useRef(!1),r=gs.useRef({x:0,y:0}),o=gs.useRef({horizontal:0,vertical:0}),l=gs.useRef({x:3.5,y:1,z:-10}),u=new j(.25,.55,0),f=gs.useRef(null);return gs.useEffect(()=>{(()=>{window.innerWidth<=768?l.current={x:1.5,y:1,z:-9}:l.current={x:3.5,y:1,z:-10}})();const p=document.getElementById("canvas"),m={width:window.innerWidth,height:window.innerHeight},g=new tT,v=new Dn(25,m.width/m.height,.1,1e4);v.position.set(l.current.x-25,l.current.y+2,l.current.z),v.lookAt(u),g.add(v),qp.to(v.position,{x:l.current.x,y:l.current.y,duration:3,ease:"circ.out",onUpdate:()=>{v.lookAt(u)}});const E=Math.sqrt(l.current.x**2+l.current.y**2+l.current.z**2);o.current.horizontal=Math.atan2(l.current.x,l.current.z),o.current.vertical=Math.asin(l.current.y/E);const M=new CC({canvas:p,antialias:!0});M.shadowMap.enabled=!0,M.shadowMap.type=qv,M.setSize(m.width,m.height);const y=new LT(16777215,1);g.add(y);const x=new bp(16777215,5);x.position.set(-100,20,1e3),x.castShadow=!0,x.shadow.mapSize.width=4096,x.shadow.mapSize.height=4096,x.shadow.camera.near=.5,x.shadow.camera.far=1500,x.shadow.camera.left=-50,x.shadow.camera.right=50,x.shadow.camera.top=50,x.shadow.camera.bottom=-50,g.add(x);const b=new bp(16777215,.6);b.position.set(0,300,-100),b.castShadow=!0,b.shadow.mapSize.width=512,b.shadow.mapSize.height=512,g.add(b);const R=new Ra(500,500),T=new af({color:11184810}),D=new vn(R,T);D.rotation.x=-Math.PI/2,D.position.y=0,D.position.z=-243,D.receiveShadow=!0,g.add(D);const N=new bC;N.load("${basePath}models/testmodel0101_v2.gltf",ee=>{const ie=ee.scene,k=ee.animations;if(ie.traverse(Z=>{Z instanceof vn&&(Z.castShadow=!0,Z.receiveShadow=!0)}),g.add(ie),t(!0),k&&k.length>0){const Z=new ev(ie);k.forEach(ce=>{Z.clipAction(ce).play()});const Te=new Q0,K=()=>{requestAnimationFrame(K);const ce=Te.getDelta();Z.update(ce),M.render(g,v)};K()}}),N.load("${basePath}models/testmodel_child_.gltf",ee=>{const ie=ee.scene,k=ee.animations;if(ie.position.set(0,0,-.75),ie.traverse(Z=>{Z instanceof vn&&(Z.castShadow=!0,Z.receiveShadow=!0)}),g.add(ie),k&&k.length>0){const Z=new ev(ie);k.forEach(ce=>{Z.clipAction(ce).play()});const Te=new Q0,K=()=>{requestAnimationFrame(K);const ce=Te.getDelta();Z.update(ce),M.render(g,v)};K()}});const I=new cf;I.scale.setScalar(5e4);const F=I.material.uniforms;F.turbidity.value=.5,F.rayleigh.value=.95,F.mieCoefficient.value=.005,F.mieDirectionalG.value=.8,F.sunPosition.value.set(-10,0,100),g.add(I);const A=new Ra(1e3,1e3),C=new bx().load("${basePath}textures/eslint.config.jpg",ee=>{ee.wrapS=ee.wrapT=mo}),B=new TP(A,{textureWidth:512,textureHeight:512,waterNormals:C,sunDirection:new j(-1,-1,-1),sunColor:16777215,waterColor:7695,distortionScale:3.7,fog:g.fog!==void 0});B.rotation.x=-Math.PI/2,g.add(B),f.current=B,B.position.y=-4;const $=new j;$.set(-10,15,100).normalize(),B.material.uniforms.sunDirection.value.copy($);const q=()=>{requestAnimationFrame(q),B.material.uniforms.time.value+=1/1e3,M.render(g,v)};q();const ue=()=>{m.width=window.innerWidth,m.height=window.innerHeight,v.aspect=m.width/m.height,v.updateProjectionMatrix(),M.setSize(m.width,m.height)},se=ee=>{n.current=!0,r.current={x:ee.clientX,y:ee.clientY}},J=ee=>{if(n.current){const ie=ee.clientX-r.current.x,k=ee.clientY-r.current.y;r.current={x:ee.clientX,y:ee.clientY};const Z=.005;o.current.horizontal+=ie*Z,o.current.vertical-=k*Z,o.current.vertical=Math.max(-Math.PI/2,Math.min(Math.PI/2,o.current.vertical));const Te=E*Math.cos(o.current.vertical)*Math.sin(o.current.horizontal),K=Math.max(1,E*Math.sin(o.current.vertical)),ce=E*Math.cos(o.current.vertical)*Math.cos(o.current.horizontal);v.position.set(Te,K,ce),v.lookAt(u)}},ae=()=>{n.current&&(n.current=!1,qp.to(o.current,{horizontal:Math.atan2(l.current.x,l.current.z),vertical:Math.asin(l.current.y/E),duration:1,ease:"power2.out",onUpdate:()=>{const ee=E*Math.cos(o.current.vertical)*Math.sin(o.current.horizontal),ie=Math.max(1,E*Math.sin(o.current.vertical)),k=E*Math.cos(o.current.vertical)*Math.cos(o.current.horizontal);v.position.set(ee,ie,k),v.lookAt(u)}}))};window.addEventListener("resize",ue),p.addEventListener("mousedown",se),window.addEventListener("mousemove",J),window.addEventListener("mouseup",ae);const z=()=>{requestAnimationFrame(z),M.render(g,v)};return z(),()=>{window.removeEventListener("resize",ue),p.removeEventListener("mousedown",se),window.removeEventListener("mousemove",J),window.removeEventListener("mouseup",ae)}},[a]),Jt.jsxs(Jt.Fragment,{children:[Jt.jsx("div",{className:"noise"}),!e&&Jt.jsx("div",{className:"loading",children:Jt.jsxs("div",{className:"loading-wrapper",children:[Jt.jsx("img",{className:"loading-img",src:"${basePath}images/loading.gif",alt:"Loading"}),Jt.jsx("p",{className:"loading-text",children:"Loading..."})]})}),Jt.jsx("canvas",{className:`canvas ${e?"loaded":""}`,id:"canvas",style:{display:e?"block":"none",width:"100vw",height:"100vh",touchAction:"none"}}),Jt.jsx("div",{className:"container",children:Jt.jsxs("div",{className:"inner",children:[Jt.jsx("div",{className:"img2025",children:Jt.jsx("img",{src:"${basePath}images/2025.svg",alt:"二〇二五"})}),Jt.jsx("div",{className:"text",children:Jt.jsxs("p",{children:["あけましておめでとうございます。",Jt.jsx("br",{}),"昨年はいろいろとお世話になり、",Jt.jsx("wbr",{}),"ありがとうございました。",Jt.jsx("br",{}),"本年もどうぞよろしくお願いいたします。"]})}),Jt.jsx("div",{className:"copy-text",children:Jt.jsx("img",{src:"${basePath}images/text_2.svg",alt:"日の目を見る",width:"174",height:"680"})})]})}),Jt.jsx("div",{className:"fadein"})]})}SM.createRoot(document.getElementById("root")).render(Jt.jsx(gs.StrictMode,{children:Jt.jsx(wP,{})}));
